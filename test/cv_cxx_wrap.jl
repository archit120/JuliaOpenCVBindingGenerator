...
#function operator[](cobj::FileStorage, nodename::NONCONVERT)
#	return cpp_to_julia(jlopencv_cv_cv_FileStorage_cv_FileStorage_operator[](julia_to_cpp(cobj),julia_to_cpp(nodename)))
#end
...
retrieve(cobj::VideoCapture; image::InputArray = (InputArray()), flag::Int32 = Int32(0)) = retrieve(cobj, image, flag)
...
read(cobj::VideoCapture; image::InputArray = (InputArray())) = read(cobj, image)
...
copyMakeBorder(src::InputArray, top::Int32, bottom::Int32, left::Int32, right::Int32, borderType::Int32; dst::InputArray = (InputArray()), value::Scalar = (cpp_to_julia(ScalarOP()))) = copyMakeBorder(src, top, bottom, left, right, borderType, dst, value)
...
add(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat()), dtype::Int32 = Int32(-1)) = add(src1, src2, dst, mask, dtype)
...
subtract(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat()), dtype::Int32 = Int32(-1)) = subtract(src1, src2, dst, mask, dtype)
...
multiply(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), scale::Float64 = Float64(1), dtype::Int32 = Int32(-1)) = multiply(src1, src2, dst, scale, dtype)
...
divide(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), scale::Float64 = Float64(1), dtype::Int32 = Int32(-1)) = divide(src1, src2, dst, scale, dtype)
...
divide(scale::Float64, src2::InputArray; dst::InputArray = (InputArray()), dtype::Int32 = Int32(-1)) = divide(scale, src2, dst, dtype)
...
scaleAdd(src1::InputArray, alpha::Float64, src2::InputArray; dst::InputArray = (InputArray())) = scaleAdd(src1, alpha, src2, dst)
...
addWeighted(src1::InputArray, alpha::Float64, src2::InputArray, beta::Float64, gamma::Float64; dst::InputArray = (InputArray()), dtype::Int32 = Int32(-1)) = addWeighted(src1, alpha, src2, beta, gamma, dst, dtype)
...
convertScaleAbs(src::InputArray; dst::InputArray = (InputArray()), alpha::Float64 = Float64(1), beta::Float64 = Float64(0)) = convertScaleAbs(src, dst, alpha, beta)
...
convertFp16(src::InputArray; dst::InputArray = (InputArray())) = convertFp16(src, dst)
...
LUT(src::InputArray, lut::InputArray; dst::InputArray = (InputArray())) = LUT(src, lut, dst)
...
findNonZero(src::InputArray; idx::InputArray = (InputArray())) = findNonZero(src, idx)
...
meanStdDev(src::InputArray; mean::InputArray = (InputArray()), stddev::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = meanStdDev(src, mean, stddev, mask)
...
batchDistance(src1::InputArray, src2::InputArray, dtype::Int32; dist::InputArray = (InputArray()), nidx::InputArray = (InputArray()), normType::Int32 = Int32(cv_NORM_L2), K::Int32 = Int32(0), mask::InputArray = (CxxMat()), update::Int32 = Int32(0), crosscheck::Bool = (false)) = batchDistance(src1, src2, dtype, dist, nidx, normType, K, mask, update, crosscheck)
...
reduce(src::InputArray, dim::Int32, rtype::Int32; dst::InputArray = (InputArray()), dtype::Int32 = Int32(-1)) = reduce(src, dim, rtype, dst, dtype)
...
merge(mv::Array{InputArray, 1}; dst::InputArray = (InputArray())) = merge(mv, dst)

function split(m::InputArray, mv::Array{InputArray, 1})
	return cpp_to_julia(jlopencv_cv_cv_split(julia_to_cpp(m),julia_to_cpp(mv)))
end
split(m::InputArray; mv::Array{InputArray, 1} = (InputArray())) = split(m, mv)
...
extractChannel(src::InputArray, coi::Int32; dst::InputArray = (InputArray())) = extractChannel(src, coi, dst)
...
flip(src::InputArray, flipCode::Int32; dst::InputArray = (InputArray())) = flip(src, flipCode, dst)
...
rotate(src::InputArray, rotateCode::Int32; dst::InputArray = (InputArray())) = rotate(src, rotateCode, dst)
...
repeat(src::InputArray, ny::Int32, nx::Int32; dst::InputArray = (InputArray())) = repeat(src, ny, nx, dst)
...
hconcat(src::Array{InputArray, 1}; dst::InputArray = (InputArray())) = hconcat(src, dst)
...
vconcat(src::Array{InputArray, 1}; dst::InputArray = (InputArray())) = vconcat(src, dst)
...
bitwise_and(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = bitwise_and(src1, src2, dst, mask)
...
bitwise_or(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = bitwise_or(src1, src2, dst, mask)
...
bitwise_xor(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = bitwise_xor(src1, src2, dst, mask)
...
bitwise_not(src::InputArray; dst::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = bitwise_not(src, dst, mask)
...
absdiff(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray())) = absdiff(src1, src2, dst)
...
copyTo(src::InputArray, mask::InputArray; dst::InputArray = (InputArray())) = copyTo(src, mask, dst)
...
inRange(src::InputArray, lowerb::InputArray, upperb::InputArray; dst::InputArray = (InputArray())) = inRange(src, lowerb, upperb, dst)
...
compare(src1::InputArray, src2::InputArray, cmpop::Int32; dst::InputArray = (InputArray())) = compare(src1, src2, cmpop, dst)
...
min(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray())) = min(src1, src2, dst)
...
max(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray())) = max(src1, src2, dst)

function sqrt(src::InputArray, dst::InputArray)
	return cpp_to_julia(jlopencv_cv_cv_sqrt(julia_to_cpp(src),julia_to_cpp(dst)))
end
sqrt(src::InputArray; dst::InputArray = (InputArray())) = sqrt(src, dst)
...
polarToCart(magnitude::InputArray, angle::InputArray; x::InputArray = (InputArray()), y::InputArray = (InputArray()), angleInDegrees::Bool = (false)) = polarToCart(magnitude, angle, x, y, angleInDegrees)
...
cartToPolar(x::InputArray, y::InputArray; magnitude::InputArray = (InputArray()), angle::InputArray = (InputArray()), angleInDegrees::Bool = (false)) = cartToPolar(x, y, magnitude, angle, angleInDegrees)
...
phase(x::InputArray, y::InputArray; angle::InputArray = (InputArray()), angleInDegrees::Bool = (false)) = phase(x, y, angle, angleInDegrees)
...
magnitude(x::InputArray, y::InputArray; magnitude::InputArray = (InputArray())) = magnitude(x, y, magnitude)
...
gemm(src1::InputArray, src2::InputArray, alpha::Float64, src3::InputArray, beta::Float64; dst::InputArray = (InputArray()), flags::Int32 = Int32(0)) = gemm(src1, src2, alpha, src3, beta, dst, flags)
...
mulTransposed(src::InputArray, aTa::Bool; dst::InputArray = (InputArray()), delta::InputArray = (CxxMat()), scale::Float64 = Float64(1), dtype::Int32 = Int32(-1)) = mulTransposed(src, aTa, dst, delta, scale, dtype)
...
transpose(src::InputArray; dst::InputArray = (InputArray())) = transpose(src, dst)
...
transform(src::InputArray, m::InputArray; dst::InputArray = (InputArray())) = transform(src, m, dst)
...
perspectiveTransform(src::InputArray, m::InputArray; dst::InputArray = (InputArray())) = perspectiveTransform(src, m, dst)
...
invert(src::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(cv_DECOMP_LU)) = invert(src, dst, flags)
...
solve(src1::InputArray, src2::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(cv_DECOMP_LU)) = solve(src1, src2, dst, flags)
...
sort(src::InputArray, flags::Int32; dst::InputArray = (InputArray())) = sort(src, flags, dst)
...
sortIdx(src::InputArray, flags::Int32; dst::InputArray = (InputArray())) = sortIdx(src, flags, dst)
...
solveCubic(coeffs::InputArray; roots::InputArray = (InputArray())) = solveCubic(coeffs, roots)
...
solvePoly(coeffs::InputArray; roots::InputArray = (InputArray()), maxIters::Int32 = Int32(300)) = solvePoly(coeffs, roots, maxIters)
...
eigen(src::InputArray; eigenvalues::InputArray = (InputArray()), eigenvectors::InputArray = (CxxMat())) = eigen(src, eigenvalues, eigenvectors)
...
eigenNonSymmetric(src::InputArray; eigenvalues::InputArray = (InputArray()), eigenvectors::InputArray = (InputArray())) = eigenNonSymmetric(src, eigenvalues, eigenvectors)
...
calcCovarMatrix(samples::InputArray, mean::InputArray, flags::Int32; covar::InputArray = (InputArray()), ctype::Int32 = Int32(CV_64F)) = calcCovarMatrix(samples, mean, flags, covar, ctype)
...
PCACompute(data::InputArray, mean::InputArray; eigenvectors::InputArray = (InputArray()), maxComponents::Int32 = Int32(0)) = PCACompute(data, mean, eigenvectors, maxComponents)
...
PCACompute2(data::InputArray, mean::InputArray; eigenvectors::InputArray = (InputArray()), eigenvalues::InputArray = (InputArray()), maxComponents::Int32 = Int32(0)) = PCACompute2(data, mean, eigenvectors, eigenvalues, maxComponents)
...
PCACompute(data::InputArray, mean::InputArray, retainedVariance::Float64; eigenvectors::InputArray = (InputArray())) = PCACompute(data, mean, retainedVariance, eigenvectors)
...
PCACompute2(data::InputArray, mean::InputArray, retainedVariance::Float64; eigenvectors::InputArray = (InputArray()), eigenvalues::InputArray = (InputArray())) = PCACompute2(data, mean, retainedVariance, eigenvectors, eigenvalues)
...
PCAProject(data::InputArray, mean::InputArray, eigenvectors::InputArray; result::InputArray = (InputArray())) = PCAProject(data, mean, eigenvectors, result)
...
PCABackProject(data::InputArray, mean::InputArray, eigenvectors::InputArray; result::InputArray = (InputArray())) = PCABackProject(data, mean, eigenvectors, result)
...
SVDecomp(src::InputArray; w::InputArray = (InputArray()), u::InputArray = (InputArray()), vt::InputArray = (InputArray()), flags::Int32 = Int32(0)) = SVDecomp(src, w, u, vt, flags)
...
SVBackSubst(w::InputArray, u::InputArray, vt::InputArray, rhs::InputArray; dst::InputArray = (InputArray())) = SVBackSubst(w, u, vt, rhs, dst)
...
dft(src::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(0), nonzeroRows::Int32 = Int32(0)) = dft(src, dst, flags, nonzeroRows)
...
idft(src::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(0), nonzeroRows::Int32 = Int32(0)) = idft(src, dst, flags, nonzeroRows)
...
dct(src::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(0)) = dct(src, dst, flags)
...
idct(src::InputArray; dst::InputArray = (InputArray()), flags::Int32 = Int32(0)) = idct(src, dst, flags)
...
mulSpectrums(a::InputArray, b::InputArray, flags::Int32; c::InputArray = (InputArray()), conjB::Bool = (false)) = mulSpectrums(a, b, flags, c, conjB)
...
solveLP(Func::InputArray, Constr::InputArray; z::InputArray = (InputArray())) = solveLP(Func, Constr, z)
...
getDerivKernels(dx::Int32, dy::Int32, ksize::Int32; kx::InputArray = (InputArray()), ky::InputArray = (InputArray()), normalize::Bool = (false), ktype::Int32 = Int32(CV_32F)) = getDerivKernels(dx, dy, ksize, kx, ky, normalize, ktype)
...
medianBlur(src::InputArray, ksize::Int32; dst::InputArray = (InputArray())) = medianBlur(src, ksize, dst)
...
GaussianBlur(src::InputArray, ksize::Size{Int32}, sigmaX::Float64; dst::InputArray = (InputArray()), sigmaY::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = GaussianBlur(src, ksize, sigmaX, dst, sigmaY, borderType)
...
bilateralFilter(src::InputArray, d::Int32, sigmaColor::Float64, sigmaSpace::Float64; dst::InputArray = (InputArray()), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = bilateralFilter(src, d, sigmaColor, sigmaSpace, dst, borderType)
...
boxFilter(src::InputArray, ddepth::Int32, ksize::Size{Int32}; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), normalize::Bool = (true), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = boxFilter(src, ddepth, ksize, dst, anchor, normalize, borderType)
...
sqrBoxFilter(src::InputArray, ddepth::Int32, ksize::Size{Int32}; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSGTXP())), normalize::Bool = (true), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = sqrBoxFilter(src, ddepth, ksize, dst, anchor, normalize, borderType)
...
blur(src::InputArray, ksize::Size{Int32}; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = blur(src, ksize, dst, anchor, borderType)
...
filter2D(src::InputArray, ddepth::Int32, kernel::InputArray; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), delta::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = filter2D(src, ddepth, kernel, dst, anchor, delta, borderType)
...
sepFilter2D(src::InputArray, ddepth::Int32, kernelX::InputArray, kernelY::InputArray; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), delta::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = sepFilter2D(src, ddepth, kernelX, kernelY, dst, anchor, delta, borderType)
...
Sobel(src::InputArray, ddepth::Int32, dx::Int32, dy::Int32; dst::InputArray = (InputArray()), ksize::Int32 = Int32(3), scale::Float64 = Float64(1), delta::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = Sobel(src, ddepth, dx, dy, dst, ksize, scale, delta, borderType)
...
spatialGradient(src::InputArray; dx::InputArray = (InputArray()), dy::InputArray = (InputArray()), ksize::Int32 = Int32(3), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = spatialGradient(src, dx, dy, ksize, borderType)
...
Scharr(src::InputArray, ddepth::Int32, dx::Int32, dy::Int32; dst::InputArray = (InputArray()), scale::Float64 = Float64(1), delta::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = Scharr(src, ddepth, dx, dy, dst, scale, delta, borderType)
...
Laplacian(src::InputArray, ddepth::Int32; dst::InputArray = (InputArray()), ksize::Int32 = Int32(1), scale::Float64 = Float64(1), delta::Float64 = Float64(0), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = Laplacian(src, ddepth, dst, ksize, scale, delta, borderType)
...
Canny(image::InputArray, threshold1::Float64, threshold2::Float64; edges::InputArray = (InputArray()), apertureSize::Int32 = Int32(3), L2gradient::Bool = (false)) = Canny(image, threshold1, threshold2, edges, apertureSize, L2gradient)
...
Canny(dx::InputArray, dy::InputArray, threshold1::Float64, threshold2::Float64; edges::InputArray = (InputArray()), L2gradient::Bool = (false)) = Canny(dx, dy, threshold1, threshold2, edges, L2gradient)
...
cornerMinEigenVal(src::InputArray, blockSize::Int32; dst::InputArray = (InputArray()), ksize::Int32 = Int32(3), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = cornerMinEigenVal(src, blockSize, dst, ksize, borderType)
...
cornerHarris(src::InputArray, blockSize::Int32, ksize::Int32, k::Float64; dst::InputArray = (InputArray()), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = cornerHarris(src, blockSize, ksize, k, dst, borderType)
...
cornerEigenValsAndVecs(src::InputArray, blockSize::Int32, ksize::Int32; dst::InputArray = (InputArray()), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = cornerEigenValsAndVecs(src, blockSize, ksize, dst, borderType)
...
preCornerDetect(src::InputArray, ksize::Int32; dst::InputArray = (InputArray()), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = preCornerDetect(src, ksize, dst, borderType)
...
goodFeaturesToTrack(image::InputArray, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64; corners::InputArray = (InputArray()), mask::InputArray = (CxxMat()), blockSize::Int32 = Int32(3), useHarrisDetector::Bool = (false), k::Float64 = Float64(0.04)) = goodFeaturesToTrack(image, maxCorners, qualityLevel, minDistance, corners, mask, blockSize, useHarrisDetector, k)
...
goodFeaturesToTrack(image::InputArray, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, mask::InputArray, blockSize::Int32, gradientSize::Int32; corners::InputArray = (InputArray()), useHarrisDetector::Bool = (false), k::Float64 = Float64(0.04)) = goodFeaturesToTrack(image, maxCorners, qualityLevel, minDistance, mask, blockSize, gradientSize, corners, useHarrisDetector, k)
...
HoughLines(image::InputArray, rho::Float64, theta::Float64, threshold::Int32; lines::InputArray = (InputArray()), srn::Float64 = Float64(0), stn::Float64 = Float64(0), min_theta::Float64 = Float64(0), max_theta::Float64 = Float64(pi)) = HoughLines(image, rho, theta, threshold, lines, srn, stn, min_theta, max_theta)
...
HoughLinesP(image::InputArray, rho::Float64, theta::Float64, threshold::Int32; lines::InputArray = (InputArray()), minLineLength::Float64 = Float64(0), maxLineGap::Float64 = Float64(0)) = HoughLinesP(image, rho, theta, threshold, lines, minLineLength, maxLineGap)
...
HoughCircles(image::InputArray, method::Int32, dp::Float64, minDist::Float64; circles::InputArray = (InputArray()), param1::Float64 = Float64(100), param2::Float64 = Float64(100), minRadius::Int32 = Int32(0), maxRadius::Int32 = Int32(0)) = HoughCircles(image, method, dp, minDist, circles, param1, param2, minRadius, maxRadius)
...
erode(src::InputArray, kernel::InputArray; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), iterations::Int32 = Int32(1), borderType::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(morphologyDefaultBorderValueOP()))) = erode(src, kernel, dst, anchor, iterations, borderType, borderValue)
...
dilate(src::InputArray, kernel::InputArray; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), iterations::Int32 = Int32(1), borderType::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(morphologyDefaultBorderValueOP()))) = dilate(src, kernel, dst, anchor, iterations, borderType, borderValue)
...
morphologyEx(src::InputArray, op::Int32, kernel::InputArray; dst::InputArray = (InputArray()), anchor::Point{Int32} = (cpp_to_julia(PointOTXSTXP())), iterations::Int32 = Int32(1), borderType::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(morphologyDefaultBorderValueOP()))) = morphologyEx(src, op, kernel, dst, anchor, iterations, borderType, borderValue)
...
resize(src::InputArray, dsize::Size{Int32}; dst::InputArray = (InputArray()), fx::Float64 = Float64(0), fy::Float64 = Float64(0), interpolation::Int32 = Int32(cv_INTER_LINEAR)) = resize(src, dsize, dst, fx, fy, interpolation)
...
warpAffine(src::InputArray, M::InputArray, dsize::Size{Int32}; dst::InputArray = (InputArray()), flags::Int32 = Int32(cv_INTER_LINEAR), borderMode::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(ScalarOP()))) = warpAffine(src, M, dsize, dst, flags, borderMode, borderValue)
...
warpPerspective(src::InputArray, M::InputArray, dsize::Size{Int32}; dst::InputArray = (InputArray()), flags::Int32 = Int32(cv_INTER_LINEAR), borderMode::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(ScalarOP()))) = warpPerspective(src, M, dsize, dst, flags, borderMode, borderValue)
...
remap(src::InputArray, map1::InputArray, map2::InputArray, interpolation::Int32; dst::InputArray = (InputArray()), borderMode::Int32 = Int32(cv_BORDER_CONSTANT), borderValue::Scalar = (cpp_to_julia(ScalarOP()))) = remap(src, map1, map2, interpolation, dst, borderMode, borderValue)
...
convertMaps(map1::InputArray, map2::InputArray, dstmap1type::Int32; dstmap1::InputArray = (InputArray()), dstmap2::InputArray = (InputArray()), nninterpolation::Bool = (false)) = convertMaps(map1, map2, dstmap1type, dstmap1, dstmap2, nninterpolation)
...
invertAffineTransform(M::InputArray; iM::InputArray = (InputArray())) = invertAffineTransform(M, iM)
...
getRectSubPix(image::InputArray, patchSize::Size{Int32}, center::Point{Float32}; patch::InputArray = (InputArray()), patchType::Int32 = Int32(-1)) = getRectSubPix(image, patchSize, center, patch, patchType)
...
logPolar(src::InputArray, center::Point{Float32}, M::Float64, flags::Int32; dst::InputArray = (InputArray())) = logPolar(src, center, M, flags, dst)
...
linearPolar(src::InputArray, center::Point{Float32}, maxRadius::Float64, flags::Int32; dst::InputArray = (InputArray())) = linearPolar(src, center, maxRadius, flags, dst)
...
warpPolar(src::InputArray, dsize::Size{Int32}, center::Point{Float32}, maxRadius::Float64, flags::Int32; dst::InputArray = (InputArray())) = warpPolar(src, dsize, center, maxRadius, flags, dst)
...
integral(src::InputArray; sum::InputArray = (InputArray()), sdepth::Int32 = Int32(-1)) = integral(src, sum, sdepth)
...
integral2(src::InputArray; sum::InputArray = (InputArray()), sqsum::InputArray = (InputArray()), sdepth::Int32 = Int32(-1), sqdepth::Int32 = Int32(-1)) = integral2(src, sum, sqsum, sdepth, sqdepth)
...
integral3(src::InputArray; sum::InputArray = (InputArray()), sqsum::InputArray = (InputArray()), tilted::InputArray = (InputArray()), sdepth::Int32 = Int32(-1), sqdepth::Int32 = Int32(-1)) = integral3(src, sum, sqsum, tilted, sdepth, sqdepth)
...
createHanningWindow(winSize::Size{Int32}, type::Int32; dst::InputArray = (InputArray())) = createHanningWindow(winSize, type, dst)
...
threshold(src::InputArray, thresh::Float64, maxval::Float64, type::Int32; dst::InputArray = (InputArray())) = threshold(src, thresh, maxval, type, dst)
...
adaptiveThreshold(src::InputArray, maxValue::Float64, adaptiveMethod::Int32, thresholdType::Int32, blockSize::Int32, C::Float64; dst::InputArray = (InputArray())) = adaptiveThreshold(src, maxValue, adaptiveMethod, thresholdType, blockSize, C, dst)
...
pyrDown(src::InputArray; dst::InputArray = (InputArray()), dstsize::Size{Int32} = (cpp_to_julia(SizeOP())), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = pyrDown(src, dst, dstsize, borderType)
...
pyrUp(src::InputArray; dst::InputArray = (InputArray()), dstsize::Size{Int32} = (cpp_to_julia(SizeOP())), borderType::Int32 = Int32(cv_BORDER_DEFAULT)) = pyrUp(src, dst, dstsize, borderType)
...
calcHist(images::Array{InputArray, 1}, channels::Array{Int32, 1}, mask::InputArray, histSize::Array{Int32, 1}, ranges::Array{Float32, 1}; hist::InputArray = (InputArray()), accumulate::Bool = (false)) = calcHist(images, channels, mask, histSize, ranges, hist, accumulate)
...
calcBackProject(images::Array{InputArray, 1}, channels::Array{Int32, 1}, hist::InputArray, ranges::Array{Float32, 1}, scale::Float64; dst::InputArray = (InputArray())) = calcBackProject(images, channels, hist, ranges, scale, dst)
...
equalizeHist(src::InputArray; dst::InputArray = (InputArray())) = equalizeHist(src, dst)
...
pyrMeanShiftFiltering(src::InputArray, sp::Float64, sr::Float64; dst::InputArray = (InputArray()), maxLevel::Int32 = Int32(1), termcrit::TermCriteria = (cpp_to_julia(TermCriteriaOTermCriteriaggMAXRITERRTermCriteriaggEPSSbSXP()))) = pyrMeanShiftFiltering(src, sp, sr, dst, maxLevel, termcrit)
...
distanceTransformWithLabels(src::InputArray, distanceType::Int32, maskSize::Int32; dst::InputArray = (InputArray()), labels::InputArray = (InputArray()), labelType::Int32 = Int32(cv_DIST_LABEL_CCOMP)) = distanceTransformWithLabels(src, distanceType, maskSize, dst, labels, labelType)
...
distanceTransform(src::InputArray, distanceType::Int32, maskSize::Int32; dst::InputArray = (InputArray()), dstType::Int32 = Int32(CV_32F)) = distanceTransform(src, distanceType, maskSize, dst, dstType)
...
cvtColor(src::InputArray, code::Int32; dst::InputArray = (InputArray()), dstCn::Int32 = Int32(0)) = cvtColor(src, code, dst, dstCn)
...
cvtColorTwoPlane(src1::InputArray, src2::InputArray, code::Int32; dst::InputArray = (InputArray())) = cvtColorTwoPlane(src1, src2, code, dst)
...
demosaicing(src::InputArray, code::Int32; dst::InputArray = (InputArray()), dstCn::Int32 = Int32(0)) = demosaicing(src, code, dst, dstCn)
...
HuMoments(m::Moments; hu::InputArray = (InputArray())) = HuMoments(m, hu)
...
matchTemplate(image::InputArray, templ::InputArray, method::Int32; result::InputArray = (InputArray()), mask::InputArray = (CxxMat())) = matchTemplate(image, templ, method, result, mask)
...
connectedComponentsWithAlgorithm(image::InputArray, connectivity::Int32, ltype::Int32, ccltype::Int32; labels::InputArray = (InputArray())) = connectedComponentsWithAlgorithm(image, connectivity, ltype, ccltype, labels)
...
connectedComponents(image::InputArray; labels::InputArray = (InputArray()), connectivity::Int32 = Int32(8), ltype::Int32 = Int32(CV_32S)) = connectedComponents(image, labels, connectivity, ltype)
...
connectedComponentsWithStatsWithAlgorithm(image::InputArray, connectivity::Int32, ltype::Int32, ccltype::Int32; labels::InputArray = (InputArray()), stats::InputArray = (InputArray()), centroids::InputArray = (InputArray())) = connectedComponentsWithStatsWithAlgorithm(image, connectivity, ltype, ccltype, labels, stats, centroids)
...
connectedComponentsWithStats(image::InputArray; labels::InputArray = (InputArray()), stats::InputArray = (InputArray()), centroids::InputArray = (InputArray()), connectivity::Int32 = Int32(8), ltype::Int32 = Int32(CV_32S)) = connectedComponentsWithStats(image, labels, stats, centroids, connectivity, ltype)
...
findContours(image::InputArray, mode::Int32, method::Int32; contours::Array{InputArray, 1} = (InputArray()), hierarchy::InputArray = (InputArray()), offset::Point{Int32} = (cpp_to_julia(PointOP()))) = findContours(image, mode, method, contours, hierarchy, offset)
...
approxPolyDP(curve::InputArray, epsilon::Float64, closed::Bool; approxCurve::InputArray = (InputArray())) = approxPolyDP(curve, epsilon, closed, approxCurve)
...
boxPoints(box::RotatedRect; points::InputArray = (InputArray())) = boxPoints(box, points)
...
minEnclosingTriangle(points::InputArray; triangle::InputArray = (InputArray())) = minEnclosingTriangle(points, triangle)
...
convexHull(points::InputArray; hull::InputArray = (InputArray()), clockwise::Bool = (false), returnPoints::Bool = (true)) = convexHull(points, hull, clockwise, returnPoints)
...
convexityDefects(contour::InputArray, convexhull::InputArray; convexityDefects::InputArray = (InputArray())) = convexityDefects(contour, convexhull, convexityDefects)
...
intersectConvexConvex(_p1::InputArray, _p2::InputArray; _p12::InputArray = (InputArray()), handleNested::Bool = (true)) = intersectConvexConvex(_p1, _p2, _p12, handleNested)
...
fitLine(points::InputArray, distType::Int32, param::Float64, reps::Float64, aeps::Float64; line::InputArray = (InputArray())) = fitLine(points, distType, param, reps, aeps, line)
...
rotatedRectangleIntersection(rect1::RotatedRect, rect2::RotatedRect; intersectingRegion::InputArray = (InputArray())) = rotatedRectangleIntersection(rect1, rect2, intersectingRegion)
...
applyColorMap(src::InputArray, colormap::Int32; dst::InputArray = (InputArray())) = applyColorMap(src, colormap, dst)
...
applyColorMap(src::InputArray, userColor::InputArray; dst::InputArray = (InputArray())) = applyColorMap(src, userColor, dst)
...
imreadmulti(filename::String; mats::Array{InputArray, 1} = (InputArray()), flags::Int32 = Int32(cv_IMREAD_ANYCOLOR)) = imreadmulti(filename, mats, flags)
