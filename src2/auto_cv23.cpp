...
;
    ...
    mod.method("jlopencv_cv_Algorithm_getDefaultName",  [](Algorithm& cobj) { auto retval = cobj.cv::Algorithm::getDefaultName();  return retval;});mod
...
.method("jlopencv_KeyPoint_get_class_id", [](const cv::KeyPoint &cobj) {return cobj.class_id;});
    ...
    mod.method("jlopencv_cv_KeyPoint_overlap",  [](KeyPoint& kp1, KeyPoint& kp2) { auto retval = cv::KeyPoint::overlap(kp1, kp2); return retval;});mod
...
.method("jlopencv_DMatch_get_distance", [](const cv::DMatch &cobj) {return cobj.distance;});mod
...
;
    ...
    mod.method("jlopencv_cv_GeneralizedHough_getMaxBufferSize",  [](cv::Ptr<GeneralizedHough>& cobj) { auto retval = cobj->cv::GeneralizedHough::getMaxBufferSize();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_GeneralizedHoughBallard_getVotesThreshold",  [](cv::Ptr<GeneralizedHoughBallard>& cobj) { auto retval = cobj->cv::GeneralizedHoughBallard::getVotesThreshold();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_GeneralizedHoughGuil_getPosThresh",  [](cv::Ptr<GeneralizedHoughGuil>& cobj) { auto retval = cobj->cv::GeneralizedHoughGuil::getPosThresh();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_CLAHE_collectGarbage",  [](cv::Ptr<CLAHE>& cobj) { cobj->cv::CLAHE::collectGarbage();  ;});mod
...
;
    ...
    mod.method("jlopencv_cv_Subdiv2D_edgeDst",  [](Subdiv2D& cobj, int& edge) {Point2f dstpt; auto retval = cobj.cv::Subdiv2D::edgeDst(edge, &dstpt);  return make_tuple<int,Point2f>(move(retval),move(dstpt));});mod
...
;
    ...
    mod.method("jlopencv_cv_LineSegmentDetector_compareSegments",  [](cv::Ptr<LineSegmentDetector>& cobj, Size& size, UMat& lines1, UMat& lines2, UMat& _image) { auto retval = cobj->cv::LineSegmentDetector::compareSegments(size, lines1, lines2, _image);  return make_tuple<int,UMat>(move(retval),move(_image));});mod
...
.method("jlopencv_CirclesGridFinderParameters_get_maxRectifiedDistance", [](const cv::CirclesGridFinderParameters &cobj) {return cobj.maxRectifiedDistance;});mod
...
;
    ...
    mod.method("jlopencv_cv_StereoMatcher_setDisp12MaxDiff",  [](cv::Ptr<StereoMatcher>& cobj, int& disp12MaxDiff) { cobj->cv::StereoMatcher::setDisp12MaxDiff(disp12MaxDiff);  ;});mod
...
;
    ...
    mod.method("jlopencv_cv_StereoBM_create",  [](int& numDisparities, int& blockSize) { auto retval = cv::StereoBM::create(numDisparities, blockSize); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_StereoSGBM_create",  [](int& minDisparity, int& numDisparities, int& blockSize, int& P1, int& P2, int& disp12MaxDiff, int& preFilterCap, int& uniquenessRatio, int& speckleWindowSize, int& speckleRange, int& mode) { auto retval = cv::StereoSGBM::create(minDisparity, numDisparities, blockSize, P1, P2, disp12MaxDiff, preFilterCap, uniquenessRatio, speckleWindowSize, speckleRange, mode); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_Feature2D_getDefaultName",  [](cv::Ptr<Feature2D>& cobj) { auto retval = cobj->cv::Feature2D::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_BRISK_getOctaves",  [](cv::Ptr<BRISK>& cobj) { auto retval = cobj->cv::BRISK::getOctaves();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ORB_getDefaultName",  [](cv::Ptr<ORB>& cobj) { auto retval = cobj->cv::ORB::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_MSER_getDefaultName",  [](cv::Ptr<MSER>& cobj) { auto retval = cobj->cv::MSER::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_FastFeatureDetector_getDefaultName",  [](cv::Ptr<FastFeatureDetector>& cobj) { auto retval = cobj->cv::FastFeatureDetector::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_AgastFeatureDetector_getDefaultName",  [](cv::Ptr<AgastFeatureDetector>& cobj) { auto retval = cobj->cv::AgastFeatureDetector::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_GFTTDetector_getDefaultName",  [](cv::Ptr<GFTTDetector>& cobj) { auto retval = cobj->cv::GFTTDetector::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_SimpleBlobDetector_getDefaultName",  [](cv::Ptr<SimpleBlobDetector>& cobj) { auto retval = cobj->cv::SimpleBlobDetector::getDefaultName();  return retval;});mod
...
.method("jlopencv_SimpleBlobDetector_Params_get_maxConvexity", [](const cv::SimpleBlobDetector::Params &cobj) {return cobj.maxConvexity;});mod
...
;
    ...
    mod.method("jlopencv_cv_KAZE_getDefaultName",  [](cv::Ptr<KAZE>& cobj) { auto retval = cobj->cv::KAZE::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_AKAZE_getDefaultName",  [](cv::Ptr<AKAZE>& cobj) { auto retval = cobj->cv::AKAZE::getDefaultName();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_DescriptorMatcher_create",  [](DescriptorMatcher_MatcherType& matcherType) { auto retval = cv::DescriptorMatcher::create(matcherType); return retval;});mod

;
    mod.method("jlopencv_cv_BFMatcher_create",  [](int& normType, bool& crossCheck) { auto retval = cv::BFMatcher::create(normType, crossCheck); return retval;});mod

;
    mod.method("jlopencv_cv_FlannBasedMatcher_create",  []() { auto retval = cv::FlannBasedMatcher::create(); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_BOWTrainer_cluster",  [](BOWTrainer& cobj, Mat& descriptors) { auto retval = cobj.cv::BOWTrainer::cluster(descriptors);  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_BOWKMeansTrainer_cluster",  [](BOWKMeansTrainer& cobj, Mat& descriptors) { auto retval = cobj.cv::BOWKMeansTrainer::cluster(descriptors);  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_BOWImgDescriptorExtractor_descriptorType",  [](BOWImgDescriptorExtractor& cobj) { auto retval = cobj.cv::BOWImgDescriptorExtractor::descriptorType();  return retval;});mod
...
.method("jlopencv_KalmanFilter_get_errorCovPost", [](const cv::KalmanFilter &cobj) {return cobj.errorCovPost;});
    ...
    mod.method("jlopencv_cv_KalmanFilter_correct",  [](KalmanFilter& cobj, Mat& measurement) { auto retval = cobj.cv::KalmanFilter::correct(measurement);  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_DenseOpticalFlow_collectGarbage",  [](cv::Ptr<DenseOpticalFlow>& cobj) { cobj->cv::DenseOpticalFlow::collectGarbage();  ;});mod
...
;
    ...
    mod.method("jlopencv_cv_SparseOpticalFlow_calc",  [](cv::Ptr<SparseOpticalFlow>& cobj, UMat& prevImg, UMat& nextImg, UMat& prevPts, UMat& nextPts, UMat& status, UMat& err) { cobj->cv::SparseOpticalFlow::calc(prevImg, nextImg, prevPts, nextPts, status, err);  return make_tuple<UMat,UMat,UMat>(move(nextPts),move(status),move(err));});mod
...
;
    ...
    mod.method("jlopencv_cv_FarnebackOpticalFlow_create",  [](int& numLevels, double& pyrScale, bool& fastPyramids, int& winSize, int& numIters, int& polyN, double& polySigma, int& flags) { auto retval = cv::FarnebackOpticalFlow::create(numLevels, pyrScale, fastPyramids, winSize, numIters, polyN, polySigma, flags); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_VariationalRefinement_create",  []() { auto retval = cv::VariationalRefinement::create(); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_DISOpticalFlow_create",  [](int& preset) { auto retval = cv::DISOpticalFlow::create(preset); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_SparsePyrLKOpticalFlow_create",  [](Size& winSize, int& maxLevel, TermCriteria& crit, int& flags, double& minEigThreshold) { auto retval = cv::SparsePyrLKOpticalFlow::create(winSize, maxLevel, crit, flags, minEigThreshold); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_BackgroundSubtractor_getBackgroundImage",  [](cv::Ptr<BackgroundSubtractor>& cobj, UMat& backgroundImage) { cobj->cv::BackgroundSubtractor::getBackgroundImage(backgroundImage);  return backgroundImage;});mod
...
;
    ...
    mod.method("jlopencv_cv_BackgroundSubtractorMOG2_apply",  [](cv::Ptr<BackgroundSubtractorMOG2>& cobj, UMat& image, UMat& fgmask, double& learningRate) { cobj->cv::BackgroundSubtractorMOG2::apply(image, fgmask, learningRate);  return fgmask;});mod
...
;
    ...
    mod.method("jlopencv_cv_BackgroundSubtractorKNN_setShadowThreshold",  [](cv::Ptr<BackgroundSubtractorKNN>& cobj, double& threshold) { cobj->cv::BackgroundSubtractorKNN::setShadowThreshold(threshold);  ;});mod
...
;
    ...
    mod.method("jlopencv_cv_CascadeClassifier_convert",  [](string& oldcascade, string& newcascade) { auto retval = cv::CascadeClassifier::convert(oldcascade, newcascade); return retval;});mod
...
.method("jlopencv_HOGDescriptor_get_signedGradient", [](const cv::HOGDescriptor &cobj) {return cobj.signedGradient;});
    ...
    mod.method("jlopencv_cv_HOGDescriptor_getDaimlerPeopleDetector",  []() { auto retval = cv::HOGDescriptor::getDaimlerPeopleDetector(); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_QRCodeDetector_detectAndDecodeMulti",  [](QRCodeDetector& cobj, UMat& img, UMat& points) {vector<string> decoded_info;vector<UMat> straight_qrcode; auto retval = cobj.cv::QRCodeDetector::detectAndDecodeMulti(img, decoded_info, points, straight_qrcode);  return make_tuple<bool,vector<string>,UMat,vector<UMat>>(move(retval),move(decoded_info),move(points),move(straight_qrcode));});mod
...
;
    ...
    mod.method("jlopencv_cv_VideoCapture_getExceptionMode",  [](VideoCapture& cobj) { auto retval = cobj.cv::VideoCapture::getExceptionMode();  return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_displayStatusBar",  [](string& winname, string& text, int& delayms) { cv::displayStatusBar(winname, text, delayms); ;});    mod.set_const("ACCESS_FAST", cv::ACCESS_FAST);
...
mod.add_type<cv::ocl::Device>("ocl_Device");
    ...
    mod.add_bits<cv::ocl::OclVectorStrategy>("OclVectorStrategy", jlcxx::julia_type("CppEnum"));mod
...
mod.add_type<cv::ml::SVMSGD>("ml_SVMSGD", jlcxx::julia_base_type<cv::ml::StatModel>());
    ...
    mod.add_bits<cv::ml::SVMSGD::MarginType>("SVMSGD_MarginType", jlcxx::julia_type("CppEnum"));   mod.add_type<Vec2d>("Vec2d");
...
.method("jlopencv_ml_ParamGrid_get_logStep", [](const cv::ml::ParamGrid &cobj) {return cobj.logStep;});
    mod.method("jlopencv_cv_ml_ParamGrid_create",  [](double& minVal, double& maxVal, double& logstep) { auto retval = cv::ml::ParamGrid::create(minVal, maxVal, logstep); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_TrainData_create",  [](UMat& samples, int& layout, UMat& responses, UMat& varIdx, UMat& sampleIdx, UMat& sampleWeights, UMat& varType) { auto retval = cv::ml::TrainData::create(samples, layout, responses, varIdx, sampleIdx, sampleWeights, varType); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_StatModel_predict",  [](cv::Ptr<StatModel>& cobj, UMat& samples, UMat& results, int& flags) { auto retval = cobj->cv::ml::StatModel::predict(samples, results, flags);  return make_tuple<float,UMat>(move(retval),move(results));});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_NormalBayesClassifier_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::NormalBayesClassifier::load(filepath, nodeName); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_KNearest_load",  [](string& filepath) { auto retval = cv::ml::KNearest::load(filepath); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_SVM_load",  [](string& filepath) { auto retval = cv::ml::SVM::load(filepath); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_EM_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::EM::load(filepath, nodeName); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_DTrees_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::DTrees::load(filepath, nodeName); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_RTrees_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::RTrees::load(filepath, nodeName); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_Boost_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::Boost::load(filepath, nodeName); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_ANN_MLP_load",  [](string& filepath) { auto retval = cv::ml::ANN_MLP::load(filepath); return retval;});mod
...
;
    ...
    mod.method("jlopencv_cv_ml_LogisticRegression_load",  [](string& filepath, string& nodeName) { auto retval = cv::ml::LogisticRegression::load(filepath, nodeName); return retval;});mod
