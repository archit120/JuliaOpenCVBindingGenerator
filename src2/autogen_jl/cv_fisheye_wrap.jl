...
projectPoints(objectPoints::Image, rvec::Image, tvec::Image, K::Image, D::Image; imagePoints::Image = Mat(), alpha::Float64 = 0, jacobian::Image = MatOP) = projectPoints(objectPoints, rvec, tvec, K, D, imagePoints, alpha, jacobian)

function projectPoints(objectPoints::UMat, rvec::UMat, tvec::UMat, K::UMat, D::UMat, imagePoints::UMat, alpha::Float64, jacobian::UMat)
	return cpp_to_julia(jlopencv_cv_fisheye_cv_fisheye_projectPoints(julia_to_cpp(objectPoints),julia_to_cpp(rvec),julia_to_cpp(tvec),julia_to_cpp(K),julia_to_cpp(D),julia_to_cpp(imagePoints),julia_to_cpp(alpha),julia_to_cpp(jacobian)))
end
projectPoints(objectPoints::UMat, rvec::UMat, tvec::UMat, K::UMat, D::UMat; imagePoints::UMat = UMat(), alpha::Float64 = 0, jacobian::UMat = UMatOP) = projectPoints(objectPoints, rvec, tvec, K, D, imagePoints, alpha, jacobian)
...
estimateNewCameraMatrixForUndistortRectify(K::Image, D::Image, image_size::Size, R::Image; P::Image = Mat(), balance::Float64 = 0.0, new_size::Size = SizeOP, fov_scale::Float64 = 1.0) = estimateNewCameraMatrixForUndistortRectify(K, D, image_size, R, P, balance, new_size, fov_scale)
...
estimateNewCameraMatrixForUndistortRectify(K::UMat, D::UMat, image_size::Size, R::UMat; P::UMat = UMat(), balance::Float64 = 0.0, new_size::Size = SizeOP, fov_scale::Float64 = 1.0) = estimateNewCameraMatrixForUndistortRectify(K, D, image_size, R, P, balance, new_size, fov_scale)
...
calibrate(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, image_size::Size, K::Image, D::Image; rvecs::Array{Image, 1} = Array{Image, 1}(), tvecs::Array{Image, 1} = Array{Image, 1}(), flags::Int32 = 0, criteria::TermCriteria = TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP) = calibrate(objectPoints, imagePoints, image_size, K, D, rvecs, tvecs, flags, criteria)
...
calibrate(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, image_size::Size, K::UMat, D::UMat; rvecs::Array{UMat, 1} = Array{UMat, 1}(), tvecs::Array{UMat, 1} = Array{UMat, 1}(), flags::Int32 = 0, criteria::TermCriteria = TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP) = calibrate(objectPoints, imagePoints, image_size, K, D, rvecs, tvecs, flags, criteria)
...
stereoRectify(K1::Image, D1::Image, K2::Image, D2::Image, imageSize::Size, R::Image, tvec::Image, flags::Int32; R1::Image = Mat(), R2::Image = Mat(), P1::Image = Mat(), P2::Image = Mat(), Q::Image = Mat(), newImageSize::Size = SizeOP, balance::Float64 = 0.0, fov_scale::Float64 = 1.0) = stereoRectify(K1, D1, K2, D2, imageSize, R, tvec, flags, R1, R2, P1, P2, Q, newImageSize, balance, fov_scale)
...
stereoRectify(K1::UMat, D1::UMat, K2::UMat, D2::UMat, imageSize::Size, R::UMat, tvec::UMat, flags::Int32; R1::UMat = UMat(), R2::UMat = UMat(), P1::UMat = UMat(), P2::UMat = UMat(), Q::UMat = UMat(), newImageSize::Size = SizeOP, balance::Float64 = 0.0, fov_scale::Float64 = 1.0) = stereoRectify(K1, D1, K2, D2, imageSize, R, tvec, flags, R1, R2, P1, P2, Q, newImageSize, balance, fov_scale)
...
stereoCalibrate(objectPoints::Array{Image, 1}, imagePoints1::Array{Image, 1}, imagePoints2::Array{Image, 1}, K1::Image, D1::Image, K2::Image, D2::Image, imageSize::Size; R::Image = Mat(), T::Image = Mat(), flags::Int32 = fisheye::CALIB_FIX_INTRINSIC, criteria::TermCriteria = TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP) = stereoCalibrate(objectPoints, imagePoints1, imagePoints2, K1, D1, K2, D2, imageSize, R, T, flags, criteria)
...
stereoCalibrate(objectPoints::Array{UMat, 1}, imagePoints1::Array{UMat, 1}, imagePoints2::Array{UMat, 1}, K1::UMat, D1::UMat, K2::UMat, D2::UMat, imageSize::Size; R::UMat = UMat(), T::UMat = UMat(), flags::Int32 = fisheye::CALIB_FIX_INTRINSIC, criteria::TermCriteria = TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP) = stereoCalibrate(objectPoints, imagePoints1, imagePoints2, K1, D1, K2, D2, imageSize, R, T, flags, criteria)
