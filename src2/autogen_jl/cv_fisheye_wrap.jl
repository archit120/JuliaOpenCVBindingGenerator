...
projectPoints(objectPoints::Image, rvec::Image, tvec::Image, K::Image, D::Image; imagePoints::Image = _Mat(), alpha::Float64 = 0, jacobian::Image = Mat()) = projectPoints(objectPoints, rvec, tvec, K, D, imagePoints, alpha, jacobian)
...
distortPoints(undistorted::Image, K::Image, D::Image; distorted::Image = _Mat(), alpha::Float64 = 0) = distortPoints(undistorted, K, D, distorted, alpha)
...
undistortPoints(distorted::Image, K::Image, D::Image; undistorted::Image = _Mat(), R::Image = Mat(), P::Image = Mat()) = undistortPoints(distorted, K, D, undistorted, R, P)
...
initUndistortRectifyMap(K::Image, D::Image, R::Image, P::Image, size::Size, m1type::Int32; map1::Image = _Mat(), map2::Image = _Mat()) = initUndistortRectifyMap(K, D, R, P, size, m1type, map1, map2)
...
undistortImage(distorted::Image, K::Image, D::Image; undistorted::Image = _Mat(), Knew::Image = Mat(), new_size::Size = Size()) = undistortImage(distorted, K, D, undistorted, Knew, new_size)
...
estimateNewCameraMatrixForUndistortRectify(K::Image, D::Image, image_size::Size, R::Image; P::Image = _Mat(), balance::Float64 = 0.0, new_size::Size = Size(), fov_scale::Float64 = 1.0) = estimateNewCameraMatrixForUndistortRectify(K, D, image_size, R, P, balance, new_size, fov_scale)
...
stereoRectify(K1::Image, D1::Image, K2::Image, D2::Image, imageSize::Size, R::Image, tvec::Image, flags::Int32; R1::Image = _Mat(), R2::Image = _Mat(), P1::Image = _Mat(), P2::Image = _Mat(), Q::Image = _Mat(), newImageSize::Size = Size(), balance::Float64 = 0.0, fov_scale::Float64 = 1.0) = stereoRectify(K1, D1, K2, D2, imageSize, R, tvec, flags, R1, R2, P1, P2, Q, newImageSize, balance, fov_scale)
...
stereoCalibrate(objectPoints::Array{Image, 1}, imagePoints1::Array{Image, 1}, imagePoints2::Array{Image, 1}, K1::Image, D1::Image, K2::Image, D2::Image, imageSize::Size; R::Image = _Mat(), T::Image = _Mat(), flags::Int32 = fisheye::CALIB_FIX_INTRINSIC, criteria::TermCriteria = TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, DBL_EPSILON)) = stereoCalibrate(objectPoints, imagePoints1, imagePoints2, K1, D1, K2, D2, imageSize, R, T, flags, criteria)
