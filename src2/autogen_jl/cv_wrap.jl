...
function clear(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_clear(julia_to_cpp(cobj, Any)))
end
clear(cobj::Any; ) = clear(cobj)

function write(cobj::Any, fs::Ptr{FileStorage}, name::String)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_write(julia_to_cpp(cobj, Any),julia_to_cpp(fs, Ptr{FileStorage}),julia_to_cpp(name, String)))
end
write(cobj::Any, fs::Ptr{FileStorage}; name::String = String()) = write(cobj, fs, name)

function read(cobj::Any, fn::FileNode)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_read(julia_to_cpp(cobj, Any),julia_to_cpp(fn, FileNode)))
end
read(cobj::Any, fn::FileNode; ) = read(cobj, fn)

function empty(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_empty(julia_to_cpp(cobj, Any)))
end
empty(cobj::Any; ) = empty(cobj)

function save(cobj::Any, filename::String)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_save(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String)))
end
save(cobj::Any, filename::String; ) = save(cobj, filename)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Algorithm_cv_Algorithm_getDefaultName(julia_to_cpp(cobj, Any)))
end
...
function setTemplate(cobj::Any, templ::Image, templCenter::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setTemplate(julia_to_cpp(cobj, Any),julia_to_cpp(templ, Image),julia_to_cpp(templCenter, Point{Int32})))
end
...
function setTemplate(cobj::Any, templ::UMat, templCenter::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setTemplate(julia_to_cpp(cobj, Any),julia_to_cpp(templ, UMat),julia_to_cpp(templCenter, Point{Int32})))
end
...
function setTemplate(cobj::Any, edges::Image, dx::Image, dy::Image, templCenter::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setTemplate(julia_to_cpp(cobj, Any),julia_to_cpp(edges, Image),julia_to_cpp(dx, Image),julia_to_cpp(dy, Image),julia_to_cpp(templCenter, Point{Int32})))
end
...
function setTemplate(cobj::Any, edges::UMat, dx::UMat, dy::UMat, templCenter::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setTemplate(julia_to_cpp(cobj, Any),julia_to_cpp(edges, UMat),julia_to_cpp(dx, UMat),julia_to_cpp(dy, UMat),julia_to_cpp(templCenter, Point{Int32})))
end
...
function detect(cobj::Any, image::Image, positions::Image, votes::Image)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_detect(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(positions, Image),julia_to_cpp(votes, Image)))
end
...
function detect(cobj::Any, image::UMat, positions::UMat, votes::UMat)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_detect(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(positions, UMat),julia_to_cpp(votes, UMat)))
end
...
function detect(cobj::Any, edges::Image, dx::Image, dy::Image, positions::Image, votes::Image)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_detect(julia_to_cpp(cobj, Any),julia_to_cpp(edges, Image),julia_to_cpp(dx, Image),julia_to_cpp(dy, Image),julia_to_cpp(positions, Image),julia_to_cpp(votes, Image)))
end
...
function detect(cobj::Any, edges::UMat, dx::UMat, dy::UMat, positions::UMat, votes::UMat)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_detect(julia_to_cpp(cobj, Any),julia_to_cpp(edges, UMat),julia_to_cpp(dx, UMat),julia_to_cpp(dy, UMat),julia_to_cpp(positions, UMat),julia_to_cpp(votes, UMat)))
end
...
function setCannyLowThresh(cobj::Any, cannyLowThresh::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setCannyLowThresh(julia_to_cpp(cobj, Any),julia_to_cpp(cannyLowThresh, Int32)))
end
setCannyLowThresh(cobj::Any, cannyLowThresh::Int32; ) = setCannyLowThresh(cobj, cannyLowThresh)

function getCannyLowThresh(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_getCannyLowThresh(julia_to_cpp(cobj, Any)))
end
getCannyLowThresh(cobj::Any; ) = getCannyLowThresh(cobj)

function setCannyHighThresh(cobj::Any, cannyHighThresh::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setCannyHighThresh(julia_to_cpp(cobj, Any),julia_to_cpp(cannyHighThresh, Int32)))
end
...
function getCannyHighThresh(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_getCannyHighThresh(julia_to_cpp(cobj, Any)))
end
getCannyHighThresh(cobj::Any; ) = getCannyHighThresh(cobj)

function setMinDist(cobj::Any, minDist::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setMinDist(julia_to_cpp(cobj, Any),julia_to_cpp(minDist, Float64)))
end
setMinDist(cobj::Any, minDist::Float64; ) = setMinDist(cobj, minDist)

function getMinDist(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_getMinDist(julia_to_cpp(cobj, Any)))
end
getMinDist(cobj::Any; ) = getMinDist(cobj)

function setDp(cobj::Any, dp::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setDp(julia_to_cpp(cobj, Any),julia_to_cpp(dp, Float64)))
end
setDp(cobj::Any, dp::Float64; ) = setDp(cobj, dp)

function getDp(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_getDp(julia_to_cpp(cobj, Any)))
end
getDp(cobj::Any; ) = getDp(cobj)

function setMaxBufferSize(cobj::Any, maxBufferSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_setMaxBufferSize(julia_to_cpp(cobj, Any),julia_to_cpp(maxBufferSize, Int32)))
end
setMaxBufferSize(cobj::Any, maxBufferSize::Int32; ) = setMaxBufferSize(cobj, maxBufferSize)

function getMaxBufferSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHough_cv_GeneralizedHough_getMaxBufferSize(julia_to_cpp(cobj, Any)))
end
...
function setLevels(cobj::Any, levels::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughBallard_cv_GeneralizedHoughBallard_setLevels(julia_to_cpp(cobj, Any),julia_to_cpp(levels, Int32)))
end
setLevels(cobj::Any, levels::Int32; ) = setLevels(cobj, levels)

function getLevels(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughBallard_cv_GeneralizedHoughBallard_getLevels(julia_to_cpp(cobj, Any)))
end
getLevels(cobj::Any; ) = getLevels(cobj)

function setVotesThreshold(cobj::Any, votesThreshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughBallard_cv_GeneralizedHoughBallard_setVotesThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(votesThreshold, Int32)))
end
setVotesThreshold(cobj::Any, votesThreshold::Int32; ) = setVotesThreshold(cobj, votesThreshold)

function getVotesThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughBallard_cv_GeneralizedHoughBallard_getVotesThreshold(julia_to_cpp(cobj, Any)))
end
...
function setXi(cobj::Any, xi::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setXi(julia_to_cpp(cobj, Any),julia_to_cpp(xi, Float64)))
end
setXi(cobj::Any, xi::Float64; ) = setXi(cobj, xi)

function getXi(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getXi(julia_to_cpp(cobj, Any)))
end
getXi(cobj::Any; ) = getXi(cobj)

function setLevels(cobj::Any, levels::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setLevels(julia_to_cpp(cobj, Any),julia_to_cpp(levels, Int32)))
end
setLevels(cobj::Any, levels::Int32; ) = setLevels(cobj, levels)

function getLevels(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getLevels(julia_to_cpp(cobj, Any)))
end
getLevels(cobj::Any; ) = getLevels(cobj)

function setAngleEpsilon(cobj::Any, angleEpsilon::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setAngleEpsilon(julia_to_cpp(cobj, Any),julia_to_cpp(angleEpsilon, Float64)))
end
setAngleEpsilon(cobj::Any, angleEpsilon::Float64; ) = setAngleEpsilon(cobj, angleEpsilon)

function getAngleEpsilon(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getAngleEpsilon(julia_to_cpp(cobj, Any)))
end
getAngleEpsilon(cobj::Any; ) = getAngleEpsilon(cobj)

function setMinAngle(cobj::Any, minAngle::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setMinAngle(julia_to_cpp(cobj, Any),julia_to_cpp(minAngle, Float64)))
end
setMinAngle(cobj::Any, minAngle::Float64; ) = setMinAngle(cobj, minAngle)

function getMinAngle(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getMinAngle(julia_to_cpp(cobj, Any)))
end
getMinAngle(cobj::Any; ) = getMinAngle(cobj)

function setMaxAngle(cobj::Any, maxAngle::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setMaxAngle(julia_to_cpp(cobj, Any),julia_to_cpp(maxAngle, Float64)))
end
setMaxAngle(cobj::Any, maxAngle::Float64; ) = setMaxAngle(cobj, maxAngle)

function getMaxAngle(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getMaxAngle(julia_to_cpp(cobj, Any)))
end
getMaxAngle(cobj::Any; ) = getMaxAngle(cobj)

function setAngleStep(cobj::Any, angleStep::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setAngleStep(julia_to_cpp(cobj, Any),julia_to_cpp(angleStep, Float64)))
end
setAngleStep(cobj::Any, angleStep::Float64; ) = setAngleStep(cobj, angleStep)

function getAngleStep(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getAngleStep(julia_to_cpp(cobj, Any)))
end
getAngleStep(cobj::Any; ) = getAngleStep(cobj)

function setAngleThresh(cobj::Any, angleThresh::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setAngleThresh(julia_to_cpp(cobj, Any),julia_to_cpp(angleThresh, Int32)))
end
setAngleThresh(cobj::Any, angleThresh::Int32; ) = setAngleThresh(cobj, angleThresh)

function getAngleThresh(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getAngleThresh(julia_to_cpp(cobj, Any)))
end
getAngleThresh(cobj::Any; ) = getAngleThresh(cobj)

function setMinScale(cobj::Any, minScale::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setMinScale(julia_to_cpp(cobj, Any),julia_to_cpp(minScale, Float64)))
end
setMinScale(cobj::Any, minScale::Float64; ) = setMinScale(cobj, minScale)

function getMinScale(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getMinScale(julia_to_cpp(cobj, Any)))
end
getMinScale(cobj::Any; ) = getMinScale(cobj)

function setMaxScale(cobj::Any, maxScale::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setMaxScale(julia_to_cpp(cobj, Any),julia_to_cpp(maxScale, Float64)))
end
setMaxScale(cobj::Any, maxScale::Float64; ) = setMaxScale(cobj, maxScale)

function getMaxScale(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getMaxScale(julia_to_cpp(cobj, Any)))
end
getMaxScale(cobj::Any; ) = getMaxScale(cobj)

function setScaleStep(cobj::Any, scaleStep::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setScaleStep(julia_to_cpp(cobj, Any),julia_to_cpp(scaleStep, Float64)))
end
setScaleStep(cobj::Any, scaleStep::Float64; ) = setScaleStep(cobj, scaleStep)

function getScaleStep(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getScaleStep(julia_to_cpp(cobj, Any)))
end
getScaleStep(cobj::Any; ) = getScaleStep(cobj)

function setScaleThresh(cobj::Any, scaleThresh::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setScaleThresh(julia_to_cpp(cobj, Any),julia_to_cpp(scaleThresh, Int32)))
end
setScaleThresh(cobj::Any, scaleThresh::Int32; ) = setScaleThresh(cobj, scaleThresh)

function getScaleThresh(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getScaleThresh(julia_to_cpp(cobj, Any)))
end
getScaleThresh(cobj::Any; ) = getScaleThresh(cobj)

function setPosThresh(cobj::Any, posThresh::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_setPosThresh(julia_to_cpp(cobj, Any),julia_to_cpp(posThresh, Int32)))
end
setPosThresh(cobj::Any, posThresh::Int32; ) = setPosThresh(cobj, posThresh)

function getPosThresh(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GeneralizedHoughGuil_cv_GeneralizedHoughGuil_getPosThresh(julia_to_cpp(cobj, Any)))
end
...
function apply(cobj::Any, src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_apply(julia_to_cpp(cobj, Any),julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
apply(cobj::Any, src::Image; dst::Image = Mat()) = apply(cobj, src, dst)

function apply(cobj::Any, src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_apply(julia_to_cpp(cobj, Any),julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
apply(cobj::Any, src::UMat; dst::UMat = UMat()) = apply(cobj, src, dst)

function setClipLimit(cobj::Any, clipLimit::Float64)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_setClipLimit(julia_to_cpp(cobj, Any),julia_to_cpp(clipLimit, Float64)))
end
setClipLimit(cobj::Any, clipLimit::Float64; ) = setClipLimit(cobj, clipLimit)

function getClipLimit(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_getClipLimit(julia_to_cpp(cobj, Any)))
end
getClipLimit(cobj::Any; ) = getClipLimit(cobj)

function setTilesGridSize(cobj::Any, tileGridSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_setTilesGridSize(julia_to_cpp(cobj, Any),julia_to_cpp(tileGridSize, Size)))
end
setTilesGridSize(cobj::Any, tileGridSize::Size; ) = setTilesGridSize(cobj, tileGridSize)

function getTilesGridSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_getTilesGridSize(julia_to_cpp(cobj, Any)))
end
getTilesGridSize(cobj::Any; ) = getTilesGridSize(cobj)

function collectGarbage(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CLAHE_cv_CLAHE_collectGarbage(julia_to_cpp(cobj, Any)))
end
...
function initDelaunay(cobj::Any, rect::Rect)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_initDelaunay(julia_to_cpp(cobj, Any),julia_to_cpp(rect, Rect)))
end
initDelaunay(cobj::Any, rect::Rect; ) = initDelaunay(cobj, rect)

function insert(cobj::Any, pt::Point{Float32})
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_insert(julia_to_cpp(cobj, Any),julia_to_cpp(pt, Point{Float32})))
end
insert(cobj::Any, pt::Point{Float32}; ) = insert(cobj, pt)

function insert(cobj::Any, ptvec::Array{Point{Float32}, 1})
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_insert(julia_to_cpp(cobj, Any),julia_to_cpp(ptvec, Array{Point{Float32}, 1})))
end
insert(cobj::Any, ptvec::Array{Point{Float32}, 1}; ) = insert(cobj, ptvec)

function locate(cobj::Any, pt::Point{Float32})
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_locate(julia_to_cpp(cobj, Any),julia_to_cpp(pt, Point{Float32})))
end
locate(cobj::Any, pt::Point{Float32}; ) = locate(cobj, pt)

function findNearest(cobj::Any, pt::Point{Float32})
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_findNearest(julia_to_cpp(cobj, Any),julia_to_cpp(pt, Point{Float32})))
end
findNearest(cobj::Any, pt::Point{Float32}; ) = findNearest(cobj, pt)

function getEdgeList(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getEdgeList(julia_to_cpp(cobj, Any)))
end
getEdgeList(cobj::Any; ) = getEdgeList(cobj)

function getLeadingEdgeList(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getLeadingEdgeList(julia_to_cpp(cobj, Any)))
end
getLeadingEdgeList(cobj::Any; ) = getLeadingEdgeList(cobj)

function getTriangleList(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getTriangleList(julia_to_cpp(cobj, Any)))
end
getTriangleList(cobj::Any; ) = getTriangleList(cobj)

function getVoronoiFacetList(cobj::Any, idx::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getVoronoiFacetList(julia_to_cpp(cobj, Any),julia_to_cpp(idx, Array{Int32, 1})))
end
getVoronoiFacetList(cobj::Any, idx::Array{Int32, 1}; ) = getVoronoiFacetList(cobj, idx)

function getVertex(cobj::Any, vertex::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getVertex(julia_to_cpp(cobj, Any),julia_to_cpp(vertex, Int32)))
end
getVertex(cobj::Any, vertex::Int32; ) = getVertex(cobj, vertex)

function getEdge(cobj::Any, edge::Int32, nextEdgeType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_getEdge(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32),julia_to_cpp(nextEdgeType, Int32)))
end
getEdge(cobj::Any, edge::Int32, nextEdgeType::Int32; ) = getEdge(cobj, edge, nextEdgeType)

function nextEdge(cobj::Any, edge::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_nextEdge(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32)))
end
nextEdge(cobj::Any, edge::Int32; ) = nextEdge(cobj, edge)

function rotateEdge(cobj::Any, edge::Int32, rotate::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_rotateEdge(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32),julia_to_cpp(rotate, Int32)))
end
rotateEdge(cobj::Any, edge::Int32, rotate::Int32; ) = rotateEdge(cobj, edge, rotate)

function symEdge(cobj::Any, edge::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_symEdge(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32)))
end
symEdge(cobj::Any, edge::Int32; ) = symEdge(cobj, edge)

function edgeOrg(cobj::Any, edge::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_edgeOrg(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32)))
end
edgeOrg(cobj::Any, edge::Int32; ) = edgeOrg(cobj, edge)

function edgeDst(cobj::Any, edge::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Subdiv2D_cv_Subdiv2D_edgeDst(julia_to_cpp(cobj, Any),julia_to_cpp(edge, Int32)))
end
...
function detect(cobj::Any, _image::Image, _lines::Image, width::Image, prec::Image, nfa::Image)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_detect(julia_to_cpp(cobj, Any),julia_to_cpp(_image, Image),julia_to_cpp(_lines, Image),julia_to_cpp(width, Image),julia_to_cpp(prec, Image),julia_to_cpp(nfa, Image)))
end
...
function detect(cobj::Any, _image::UMat, _lines::UMat, width::UMat, prec::UMat, nfa::UMat)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_detect(julia_to_cpp(cobj, Any),julia_to_cpp(_image, UMat),julia_to_cpp(_lines, UMat),julia_to_cpp(width, UMat),julia_to_cpp(prec, UMat),julia_to_cpp(nfa, UMat)))
end
...
function drawSegments(cobj::Any, _image::Image, lines::Image)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_drawSegments(julia_to_cpp(cobj, Any),julia_to_cpp(_image, Image),julia_to_cpp(lines, Image)))
end
...
function drawSegments(cobj::Any, _image::UMat, lines::UMat)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_drawSegments(julia_to_cpp(cobj, Any),julia_to_cpp(_image, UMat),julia_to_cpp(lines, UMat)))
end
...
function compareSegments(cobj::Any, size::Size, lines1::Image, lines2::Image, _image::Image)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_compareSegments(julia_to_cpp(cobj, Any),julia_to_cpp(size, Size),julia_to_cpp(lines1, Image),julia_to_cpp(lines2, Image),julia_to_cpp(_image, Image)))
end
...
function compareSegments(cobj::Any, size::Size, lines1::UMat, lines2::UMat, _image::UMat)
	return cpp_to_julia(jlopencv_cv_cv_LineSegmentDetector_cv_LineSegmentDetector_compareSegments(julia_to_cpp(cobj, Any),julia_to_cpp(size, Size),julia_to_cpp(lines1, UMat),julia_to_cpp(lines2, UMat),julia_to_cpp(_image, UMat)))
end
...
function compute(cobj::Any, left::Image, right::Image, disparity::Image)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_compute(julia_to_cpp(cobj, Any),julia_to_cpp(left, Image),julia_to_cpp(right, Image),julia_to_cpp(disparity, Image)))
end
...
function compute(cobj::Any, left::UMat, right::UMat, disparity::UMat)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_compute(julia_to_cpp(cobj, Any),julia_to_cpp(left, UMat),julia_to_cpp(right, UMat),julia_to_cpp(disparity, UMat)))
end
...
function getMinDisparity(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getMinDisparity(julia_to_cpp(cobj, Any)))
end
getMinDisparity(cobj::Any; ) = getMinDisparity(cobj)

function setMinDisparity(cobj::Any, minDisparity::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setMinDisparity(julia_to_cpp(cobj, Any),julia_to_cpp(minDisparity, Int32)))
end
setMinDisparity(cobj::Any, minDisparity::Int32; ) = setMinDisparity(cobj, minDisparity)

function getNumDisparities(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getNumDisparities(julia_to_cpp(cobj, Any)))
end
getNumDisparities(cobj::Any; ) = getNumDisparities(cobj)

function setNumDisparities(cobj::Any, numDisparities::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setNumDisparities(julia_to_cpp(cobj, Any),julia_to_cpp(numDisparities, Int32)))
end
setNumDisparities(cobj::Any, numDisparities::Int32; ) = setNumDisparities(cobj, numDisparities)

function getBlockSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getBlockSize(julia_to_cpp(cobj, Any)))
end
getBlockSize(cobj::Any; ) = getBlockSize(cobj)

function setBlockSize(cobj::Any, blockSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setBlockSize(julia_to_cpp(cobj, Any),julia_to_cpp(blockSize, Int32)))
end
setBlockSize(cobj::Any, blockSize::Int32; ) = setBlockSize(cobj, blockSize)

function getSpeckleWindowSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getSpeckleWindowSize(julia_to_cpp(cobj, Any)))
end
getSpeckleWindowSize(cobj::Any; ) = getSpeckleWindowSize(cobj)

function setSpeckleWindowSize(cobj::Any, speckleWindowSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setSpeckleWindowSize(julia_to_cpp(cobj, Any),julia_to_cpp(speckleWindowSize, Int32)))
end
...
function getSpeckleRange(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getSpeckleRange(julia_to_cpp(cobj, Any)))
end
getSpeckleRange(cobj::Any; ) = getSpeckleRange(cobj)

function setSpeckleRange(cobj::Any, speckleRange::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setSpeckleRange(julia_to_cpp(cobj, Any),julia_to_cpp(speckleRange, Int32)))
end
setSpeckleRange(cobj::Any, speckleRange::Int32; ) = setSpeckleRange(cobj, speckleRange)

function getDisp12MaxDiff(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_getDisp12MaxDiff(julia_to_cpp(cobj, Any)))
end
getDisp12MaxDiff(cobj::Any; ) = getDisp12MaxDiff(cobj)

function setDisp12MaxDiff(cobj::Any, disp12MaxDiff::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoMatcher_cv_StereoMatcher_setDisp12MaxDiff(julia_to_cpp(cobj, Any),julia_to_cpp(disp12MaxDiff, Int32)))
end
...
function getPreFilterType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getPreFilterType(julia_to_cpp(cobj, Any)))
end
getPreFilterType(cobj::Any; ) = getPreFilterType(cobj)

function setPreFilterType(cobj::Any, preFilterType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setPreFilterType(julia_to_cpp(cobj, Any),julia_to_cpp(preFilterType, Int32)))
end
setPreFilterType(cobj::Any, preFilterType::Int32; ) = setPreFilterType(cobj, preFilterType)

function getPreFilterSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getPreFilterSize(julia_to_cpp(cobj, Any)))
end
getPreFilterSize(cobj::Any; ) = getPreFilterSize(cobj)

function setPreFilterSize(cobj::Any, preFilterSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setPreFilterSize(julia_to_cpp(cobj, Any),julia_to_cpp(preFilterSize, Int32)))
end
setPreFilterSize(cobj::Any, preFilterSize::Int32; ) = setPreFilterSize(cobj, preFilterSize)

function getPreFilterCap(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getPreFilterCap(julia_to_cpp(cobj, Any)))
end
getPreFilterCap(cobj::Any; ) = getPreFilterCap(cobj)

function setPreFilterCap(cobj::Any, preFilterCap::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setPreFilterCap(julia_to_cpp(cobj, Any),julia_to_cpp(preFilterCap, Int32)))
end
setPreFilterCap(cobj::Any, preFilterCap::Int32; ) = setPreFilterCap(cobj, preFilterCap)

function getTextureThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getTextureThreshold(julia_to_cpp(cobj, Any)))
end
getTextureThreshold(cobj::Any; ) = getTextureThreshold(cobj)

function setTextureThreshold(cobj::Any, textureThreshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setTextureThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(textureThreshold, Int32)))
end
...
function getUniquenessRatio(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getUniquenessRatio(julia_to_cpp(cobj, Any)))
end
getUniquenessRatio(cobj::Any; ) = getUniquenessRatio(cobj)

function setUniquenessRatio(cobj::Any, uniquenessRatio::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setUniquenessRatio(julia_to_cpp(cobj, Any),julia_to_cpp(uniquenessRatio, Int32)))
end
...
function getSmallerBlockSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getSmallerBlockSize(julia_to_cpp(cobj, Any)))
end
getSmallerBlockSize(cobj::Any; ) = getSmallerBlockSize(cobj)

function setSmallerBlockSize(cobj::Any, blockSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setSmallerBlockSize(julia_to_cpp(cobj, Any),julia_to_cpp(blockSize, Int32)))
end
setSmallerBlockSize(cobj::Any, blockSize::Int32; ) = setSmallerBlockSize(cobj, blockSize)

function getROI1(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getROI1(julia_to_cpp(cobj, Any)))
end
getROI1(cobj::Any; ) = getROI1(cobj)

function setROI1(cobj::Any, roi1::Rect)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setROI1(julia_to_cpp(cobj, Any),julia_to_cpp(roi1, Rect)))
end
setROI1(cobj::Any, roi1::Rect; ) = setROI1(cobj, roi1)

function getROI2(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_getROI2(julia_to_cpp(cobj, Any)))
end
getROI2(cobj::Any; ) = getROI2(cobj)

function setROI2(cobj::Any, roi2::Rect)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_cv_StereoBM_setROI2(julia_to_cpp(cobj, Any),julia_to_cpp(roi2, Rect)))
end
...
function getPreFilterCap(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_getPreFilterCap(julia_to_cpp(cobj, Any)))
end
getPreFilterCap(cobj::Any; ) = getPreFilterCap(cobj)

function setPreFilterCap(cobj::Any, preFilterCap::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_setPreFilterCap(julia_to_cpp(cobj, Any),julia_to_cpp(preFilterCap, Int32)))
end
setPreFilterCap(cobj::Any, preFilterCap::Int32; ) = setPreFilterCap(cobj, preFilterCap)

function getUniquenessRatio(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_getUniquenessRatio(julia_to_cpp(cobj, Any)))
end
getUniquenessRatio(cobj::Any; ) = getUniquenessRatio(cobj)

function setUniquenessRatio(cobj::Any, uniquenessRatio::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_setUniquenessRatio(julia_to_cpp(cobj, Any),julia_to_cpp(uniquenessRatio, Int32)))
end
setUniquenessRatio(cobj::Any, uniquenessRatio::Int32; ) = setUniquenessRatio(cobj, uniquenessRatio)

function getP1(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_getP1(julia_to_cpp(cobj, Any)))
end
getP1(cobj::Any; ) = getP1(cobj)

function setP1(cobj::Any, P1::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_setP1(julia_to_cpp(cobj, Any),julia_to_cpp(P1, Int32)))
end
setP1(cobj::Any, P1::Int32; ) = setP1(cobj, P1)

function getP2(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_getP2(julia_to_cpp(cobj, Any)))
end
getP2(cobj::Any; ) = getP2(cobj)

function setP2(cobj::Any, P2::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_setP2(julia_to_cpp(cobj, Any),julia_to_cpp(P2, Int32)))
end
setP2(cobj::Any, P2::Int32; ) = setP2(cobj, P2)

function getMode(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_getMode(julia_to_cpp(cobj, Any)))
end
getMode(cobj::Any; ) = getMode(cobj)

function setMode(cobj::Any, mode::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_cv_StereoSGBM_setMode(julia_to_cpp(cobj, Any),julia_to_cpp(mode, Int32)))
end
...
function detect(cobj::Any, image::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detect(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(mask, Image)))
end
detect(cobj::Any, image::Image; mask::Image = Mat()) = detect(cobj, image, mask)

function detect(cobj::Any, image::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detect(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(mask, UMat)))
end
...
function detect(cobj::Any, images::Array{Image, 1}, masks::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detect(julia_to_cpp(cobj, Any),julia_to_cpp(images, Array{Image, 1}),julia_to_cpp(masks, Array{Image, 1})))
end
...
function detect(cobj::Any, images::Array{UMat, 1}, masks::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detect(julia_to_cpp(cobj, Any),julia_to_cpp(images, Array{UMat, 1}),julia_to_cpp(masks, Array{UMat, 1})))
end
...
function compute(cobj::Any, image::Image, keypoints::Array{KeyPoint, 1}, descriptors::Image)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_compute(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(descriptors, Image)))
end
compute(cobj::Any, image::Image, keypoints::Array{KeyPoint, 1}; descriptors::Image = Mat()) = compute(cobj, image, keypoints, descriptors)

function compute(cobj::Any, image::UMat, keypoints::Array{KeyPoint, 1}, descriptors::UMat)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_compute(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(descriptors, UMat)))
end
...
function compute(cobj::Any, images::Array{Image, 1}, keypoints::Array{Array{KeyPoint, 1}, 1}, descriptors::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_compute(julia_to_cpp(cobj, Any),julia_to_cpp(images, Array{Image, 1}),julia_to_cpp(keypoints, Array{Array{KeyPoint, 1}, 1}),julia_to_cpp(descriptors, Array{Image, 1})))
end
...
function compute(cobj::Any, images::Array{UMat, 1}, keypoints::Array{Array{KeyPoint, 1}, 1}, descriptors::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_compute(julia_to_cpp(cobj, Any),julia_to_cpp(images, Array{UMat, 1}),julia_to_cpp(keypoints, Array{Array{KeyPoint, 1}, 1}),julia_to_cpp(descriptors, Array{UMat, 1})))
end
...
function detectAndCompute(cobj::Any, image::Image, mask::Image, descriptors::Image, useProvidedKeypoints::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detectAndCompute(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(mask, Image),julia_to_cpp(descriptors, Image),julia_to_cpp(useProvidedKeypoints, Bool)))
end
...
function detectAndCompute(cobj::Any, image::UMat, mask::UMat, descriptors::UMat, useProvidedKeypoints::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_detectAndCompute(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(descriptors, UMat),julia_to_cpp(useProvidedKeypoints, Bool)))
end
...
function descriptorSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_descriptorSize(julia_to_cpp(cobj, Any)))
end
descriptorSize(cobj::Any; ) = descriptorSize(cobj)

function descriptorType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_descriptorType(julia_to_cpp(cobj, Any)))
end
descriptorType(cobj::Any; ) = descriptorType(cobj)

function defaultNorm(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_defaultNorm(julia_to_cpp(cobj, Any)))
end
defaultNorm(cobj::Any; ) = defaultNorm(cobj)

function write(cobj::Any, fileName::String)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_write(julia_to_cpp(cobj, Any),julia_to_cpp(fileName, String)))
end
write(cobj::Any, fileName::String; ) = write(cobj, fileName)

function write(cobj::Any, fs::Ptr{FileStorage}, name::String)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_write(julia_to_cpp(cobj, Any),julia_to_cpp(fs, Ptr{FileStorage}),julia_to_cpp(name, String)))
end
write(cobj::Any, fs::Ptr{FileStorage}; name::String = String()) = write(cobj, fs, name)

function read(cobj::Any, fileName::String)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_read(julia_to_cpp(cobj, Any),julia_to_cpp(fileName, String)))
end
read(cobj::Any, fileName::String; ) = read(cobj, fileName)

function read(cobj::Any, arg1::FileNode)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_read(julia_to_cpp(cobj, Any),julia_to_cpp(arg1, FileNode)))
end
read(cobj::Any, arg1::FileNode; ) = read(cobj, arg1)

function empty(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_empty(julia_to_cpp(cobj, Any)))
end
empty(cobj::Any; ) = empty(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_Feature2D_cv_Feature2D_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_cv_BRISK_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)

function setThreshold(cobj::Any, threshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_cv_BRISK_setThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Int32)))
end
setThreshold(cobj::Any, threshold::Int32; ) = setThreshold(cobj, threshold)

function getThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_cv_BRISK_getThreshold(julia_to_cpp(cobj, Any)))
end
getThreshold(cobj::Any; ) = getThreshold(cobj)

function setOctaves(cobj::Any, octaves::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_cv_BRISK_setOctaves(julia_to_cpp(cobj, Any),julia_to_cpp(octaves, Int32)))
end
setOctaves(cobj::Any, octaves::Int32; ) = setOctaves(cobj, octaves)

function getOctaves(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_cv_BRISK_getOctaves(julia_to_cpp(cobj, Any)))
end
...
function setMaxFeatures(cobj::Any, maxFeatures::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setMaxFeatures(julia_to_cpp(cobj, Any),julia_to_cpp(maxFeatures, Int32)))
end
setMaxFeatures(cobj::Any, maxFeatures::Int32; ) = setMaxFeatures(cobj, maxFeatures)

function getMaxFeatures(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getMaxFeatures(julia_to_cpp(cobj, Any)))
end
getMaxFeatures(cobj::Any; ) = getMaxFeatures(cobj)

function setScaleFactor(cobj::Any, scaleFactor::Float64)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setScaleFactor(julia_to_cpp(cobj, Any),julia_to_cpp(scaleFactor, Float64)))
end
setScaleFactor(cobj::Any, scaleFactor::Float64; ) = setScaleFactor(cobj, scaleFactor)

function getScaleFactor(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getScaleFactor(julia_to_cpp(cobj, Any)))
end
getScaleFactor(cobj::Any; ) = getScaleFactor(cobj)

function setNLevels(cobj::Any, nlevels::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setNLevels(julia_to_cpp(cobj, Any),julia_to_cpp(nlevels, Int32)))
end
setNLevels(cobj::Any, nlevels::Int32; ) = setNLevels(cobj, nlevels)

function getNLevels(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getNLevels(julia_to_cpp(cobj, Any)))
end
getNLevels(cobj::Any; ) = getNLevels(cobj)

function setEdgeThreshold(cobj::Any, edgeThreshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setEdgeThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(edgeThreshold, Int32)))
end
setEdgeThreshold(cobj::Any, edgeThreshold::Int32; ) = setEdgeThreshold(cobj, edgeThreshold)

function getEdgeThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getEdgeThreshold(julia_to_cpp(cobj, Any)))
end
getEdgeThreshold(cobj::Any; ) = getEdgeThreshold(cobj)

function setFirstLevel(cobj::Any, firstLevel::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setFirstLevel(julia_to_cpp(cobj, Any),julia_to_cpp(firstLevel, Int32)))
end
setFirstLevel(cobj::Any, firstLevel::Int32; ) = setFirstLevel(cobj, firstLevel)

function getFirstLevel(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getFirstLevel(julia_to_cpp(cobj, Any)))
end
getFirstLevel(cobj::Any; ) = getFirstLevel(cobj)

function setWTA_K(cobj::Any, wta_k::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setWTA_K(julia_to_cpp(cobj, Any),julia_to_cpp(wta_k, Int32)))
end
setWTA_K(cobj::Any, wta_k::Int32; ) = setWTA_K(cobj, wta_k)

function getWTA_K(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getWTA_K(julia_to_cpp(cobj, Any)))
end
getWTA_K(cobj::Any; ) = getWTA_K(cobj)

function setScoreType(cobj::Any, scoreType::ORB_ScoreType)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setScoreType(julia_to_cpp(cobj, Any),julia_to_cpp(scoreType, ORB_ScoreType)))
end
setScoreType(cobj::Any, scoreType::ORB_ScoreType; ) = setScoreType(cobj, scoreType)

function getScoreType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getScoreType(julia_to_cpp(cobj, Any)))
end
getScoreType(cobj::Any; ) = getScoreType(cobj)

function setPatchSize(cobj::Any, patchSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setPatchSize(julia_to_cpp(cobj, Any),julia_to_cpp(patchSize, Int32)))
end
setPatchSize(cobj::Any, patchSize::Int32; ) = setPatchSize(cobj, patchSize)

function getPatchSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getPatchSize(julia_to_cpp(cobj, Any)))
end
getPatchSize(cobj::Any; ) = getPatchSize(cobj)

function setFastThreshold(cobj::Any, fastThreshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_setFastThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(fastThreshold, Int32)))
end
setFastThreshold(cobj::Any, fastThreshold::Int32; ) = setFastThreshold(cobj, fastThreshold)

function getFastThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getFastThreshold(julia_to_cpp(cobj, Any)))
end
getFastThreshold(cobj::Any; ) = getFastThreshold(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_ORB_cv_ORB_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function detectRegions(cobj::Any, image::Image)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_detectRegions(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image)))
end
detectRegions(cobj::Any, image::Image; ) = detectRegions(cobj, image)

function detectRegions(cobj::Any, image::UMat)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_detectRegions(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat)))
end
detectRegions(cobj::Any, image::UMat; ) = detectRegions(cobj, image)

function setDelta(cobj::Any, delta::Int32)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_setDelta(julia_to_cpp(cobj, Any),julia_to_cpp(delta, Int32)))
end
setDelta(cobj::Any, delta::Int32; ) = setDelta(cobj, delta)

function getDelta(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_getDelta(julia_to_cpp(cobj, Any)))
end
getDelta(cobj::Any; ) = getDelta(cobj)

function setMinArea(cobj::Any, minArea::Int32)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_setMinArea(julia_to_cpp(cobj, Any),julia_to_cpp(minArea, Int32)))
end
setMinArea(cobj::Any, minArea::Int32; ) = setMinArea(cobj, minArea)

function getMinArea(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_getMinArea(julia_to_cpp(cobj, Any)))
end
getMinArea(cobj::Any; ) = getMinArea(cobj)

function setMaxArea(cobj::Any, maxArea::Int32)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_setMaxArea(julia_to_cpp(cobj, Any),julia_to_cpp(maxArea, Int32)))
end
setMaxArea(cobj::Any, maxArea::Int32; ) = setMaxArea(cobj, maxArea)

function getMaxArea(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_getMaxArea(julia_to_cpp(cobj, Any)))
end
getMaxArea(cobj::Any; ) = getMaxArea(cobj)

function setPass2Only(cobj::Any, f::Bool)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_setPass2Only(julia_to_cpp(cobj, Any),julia_to_cpp(f, Bool)))
end
setPass2Only(cobj::Any, f::Bool; ) = setPass2Only(cobj, f)

function getPass2Only(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_getPass2Only(julia_to_cpp(cobj, Any)))
end
getPass2Only(cobj::Any; ) = getPass2Only(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_MSER_cv_MSER_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function setThreshold(cobj::Any, threshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_setThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Int32)))
end
setThreshold(cobj::Any, threshold::Int32; ) = setThreshold(cobj, threshold)

function getThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_getThreshold(julia_to_cpp(cobj, Any)))
end
getThreshold(cobj::Any; ) = getThreshold(cobj)

function setNonmaxSuppression(cobj::Any, f::Bool)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_setNonmaxSuppression(julia_to_cpp(cobj, Any),julia_to_cpp(f, Bool)))
end
setNonmaxSuppression(cobj::Any, f::Bool; ) = setNonmaxSuppression(cobj, f)

function getNonmaxSuppression(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_getNonmaxSuppression(julia_to_cpp(cobj, Any)))
end
getNonmaxSuppression(cobj::Any; ) = getNonmaxSuppression(cobj)

function setType(cobj::Any, type::FastFeatureDetector_DetectorType)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_setType(julia_to_cpp(cobj, Any),julia_to_cpp(type, FastFeatureDetector_DetectorType)))
end
setType(cobj::Any, type::FastFeatureDetector_DetectorType; ) = setType(cobj, type)

function getType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_getType(julia_to_cpp(cobj, Any)))
end
getType(cobj::Any; ) = getType(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_cv_FastFeatureDetector_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function setThreshold(cobj::Any, threshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_setThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Int32)))
end
setThreshold(cobj::Any, threshold::Int32; ) = setThreshold(cobj, threshold)

function getThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_getThreshold(julia_to_cpp(cobj, Any)))
end
getThreshold(cobj::Any; ) = getThreshold(cobj)

function setNonmaxSuppression(cobj::Any, f::Bool)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_setNonmaxSuppression(julia_to_cpp(cobj, Any),julia_to_cpp(f, Bool)))
end
setNonmaxSuppression(cobj::Any, f::Bool; ) = setNonmaxSuppression(cobj, f)

function getNonmaxSuppression(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_getNonmaxSuppression(julia_to_cpp(cobj, Any)))
end
getNonmaxSuppression(cobj::Any; ) = getNonmaxSuppression(cobj)

function setType(cobj::Any, type::AgastFeatureDetector_DetectorType)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_setType(julia_to_cpp(cobj, Any),julia_to_cpp(type, AgastFeatureDetector_DetectorType)))
end
setType(cobj::Any, type::AgastFeatureDetector_DetectorType; ) = setType(cobj, type)

function getType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_getType(julia_to_cpp(cobj, Any)))
end
getType(cobj::Any; ) = getType(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_cv_AgastFeatureDetector_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function setMaxFeatures(cobj::Any, maxFeatures::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setMaxFeatures(julia_to_cpp(cobj, Any),julia_to_cpp(maxFeatures, Int32)))
end
setMaxFeatures(cobj::Any, maxFeatures::Int32; ) = setMaxFeatures(cobj, maxFeatures)

function getMaxFeatures(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getMaxFeatures(julia_to_cpp(cobj, Any)))
end
getMaxFeatures(cobj::Any; ) = getMaxFeatures(cobj)

function setQualityLevel(cobj::Any, qlevel::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setQualityLevel(julia_to_cpp(cobj, Any),julia_to_cpp(qlevel, Float64)))
end
setQualityLevel(cobj::Any, qlevel::Float64; ) = setQualityLevel(cobj, qlevel)

function getQualityLevel(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getQualityLevel(julia_to_cpp(cobj, Any)))
end
getQualityLevel(cobj::Any; ) = getQualityLevel(cobj)

function setMinDistance(cobj::Any, minDistance::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setMinDistance(julia_to_cpp(cobj, Any),julia_to_cpp(minDistance, Float64)))
end
setMinDistance(cobj::Any, minDistance::Float64; ) = setMinDistance(cobj, minDistance)

function getMinDistance(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getMinDistance(julia_to_cpp(cobj, Any)))
end
getMinDistance(cobj::Any; ) = getMinDistance(cobj)

function setBlockSize(cobj::Any, blockSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setBlockSize(julia_to_cpp(cobj, Any),julia_to_cpp(blockSize, Int32)))
end
setBlockSize(cobj::Any, blockSize::Int32; ) = setBlockSize(cobj, blockSize)

function getBlockSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getBlockSize(julia_to_cpp(cobj, Any)))
end
getBlockSize(cobj::Any; ) = getBlockSize(cobj)

function setHarrisDetector(cobj::Any, val::Bool)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setHarrisDetector(julia_to_cpp(cobj, Any),julia_to_cpp(val, Bool)))
end
setHarrisDetector(cobj::Any, val::Bool; ) = setHarrisDetector(cobj, val)

function getHarrisDetector(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getHarrisDetector(julia_to_cpp(cobj, Any)))
end
getHarrisDetector(cobj::Any; ) = getHarrisDetector(cobj)

function setK(cobj::Any, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_setK(julia_to_cpp(cobj, Any),julia_to_cpp(k, Float64)))
end
setK(cobj::Any, k::Float64; ) = setK(cobj, k)

function getK(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getK(julia_to_cpp(cobj, Any)))
end
getK(cobj::Any; ) = getK(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_cv_GFTTDetector_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SimpleBlobDetector_cv_SimpleBlobDetector_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function setExtended(cobj::Any, extended::Bool)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setExtended(julia_to_cpp(cobj, Any),julia_to_cpp(extended, Bool)))
end
setExtended(cobj::Any, extended::Bool; ) = setExtended(cobj, extended)

function getExtended(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getExtended(julia_to_cpp(cobj, Any)))
end
getExtended(cobj::Any; ) = getExtended(cobj)

function setUpright(cobj::Any, upright::Bool)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setUpright(julia_to_cpp(cobj, Any),julia_to_cpp(upright, Bool)))
end
setUpright(cobj::Any, upright::Bool; ) = setUpright(cobj, upright)

function getUpright(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getUpright(julia_to_cpp(cobj, Any)))
end
getUpright(cobj::Any; ) = getUpright(cobj)

function setThreshold(cobj::Any, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Float64)))
end
setThreshold(cobj::Any, threshold::Float64; ) = setThreshold(cobj, threshold)

function getThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getThreshold(julia_to_cpp(cobj, Any)))
end
getThreshold(cobj::Any; ) = getThreshold(cobj)

function setNOctaves(cobj::Any, octaves::Int32)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setNOctaves(julia_to_cpp(cobj, Any),julia_to_cpp(octaves, Int32)))
end
setNOctaves(cobj::Any, octaves::Int32; ) = setNOctaves(cobj, octaves)

function getNOctaves(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getNOctaves(julia_to_cpp(cobj, Any)))
end
getNOctaves(cobj::Any; ) = getNOctaves(cobj)

function setNOctaveLayers(cobj::Any, octaveLayers::Int32)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setNOctaveLayers(julia_to_cpp(cobj, Any),julia_to_cpp(octaveLayers, Int32)))
end
setNOctaveLayers(cobj::Any, octaveLayers::Int32; ) = setNOctaveLayers(cobj, octaveLayers)

function getNOctaveLayers(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getNOctaveLayers(julia_to_cpp(cobj, Any)))
end
getNOctaveLayers(cobj::Any; ) = getNOctaveLayers(cobj)

function setDiffusivity(cobj::Any, diff::KAZE_DiffusivityType)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_setDiffusivity(julia_to_cpp(cobj, Any),julia_to_cpp(diff, KAZE_DiffusivityType)))
end
setDiffusivity(cobj::Any, diff::KAZE_DiffusivityType; ) = setDiffusivity(cobj, diff)

function getDiffusivity(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getDiffusivity(julia_to_cpp(cobj, Any)))
end
getDiffusivity(cobj::Any; ) = getDiffusivity(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_cv_KAZE_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function setDescriptorType(cobj::Any, dtype::AKAZE_DescriptorType)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setDescriptorType(julia_to_cpp(cobj, Any),julia_to_cpp(dtype, AKAZE_DescriptorType)))
end
setDescriptorType(cobj::Any, dtype::AKAZE_DescriptorType; ) = setDescriptorType(cobj, dtype)

function getDescriptorType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getDescriptorType(julia_to_cpp(cobj, Any)))
end
getDescriptorType(cobj::Any; ) = getDescriptorType(cobj)

function setDescriptorSize(cobj::Any, dsize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setDescriptorSize(julia_to_cpp(cobj, Any),julia_to_cpp(dsize, Int32)))
end
setDescriptorSize(cobj::Any, dsize::Int32; ) = setDescriptorSize(cobj, dsize)

function getDescriptorSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getDescriptorSize(julia_to_cpp(cobj, Any)))
end
getDescriptorSize(cobj::Any; ) = getDescriptorSize(cobj)

function setDescriptorChannels(cobj::Any, dch::Int32)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setDescriptorChannels(julia_to_cpp(cobj, Any),julia_to_cpp(dch, Int32)))
end
setDescriptorChannels(cobj::Any, dch::Int32; ) = setDescriptorChannels(cobj, dch)

function getDescriptorChannels(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getDescriptorChannels(julia_to_cpp(cobj, Any)))
end
getDescriptorChannels(cobj::Any; ) = getDescriptorChannels(cobj)

function setThreshold(cobj::Any, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Float64)))
end
setThreshold(cobj::Any, threshold::Float64; ) = setThreshold(cobj, threshold)

function getThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getThreshold(julia_to_cpp(cobj, Any)))
end
getThreshold(cobj::Any; ) = getThreshold(cobj)

function setNOctaves(cobj::Any, octaves::Int32)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setNOctaves(julia_to_cpp(cobj, Any),julia_to_cpp(octaves, Int32)))
end
setNOctaves(cobj::Any, octaves::Int32; ) = setNOctaves(cobj, octaves)

function getNOctaves(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getNOctaves(julia_to_cpp(cobj, Any)))
end
getNOctaves(cobj::Any; ) = getNOctaves(cobj)

function setNOctaveLayers(cobj::Any, octaveLayers::Int32)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setNOctaveLayers(julia_to_cpp(cobj, Any),julia_to_cpp(octaveLayers, Int32)))
end
setNOctaveLayers(cobj::Any, octaveLayers::Int32; ) = setNOctaveLayers(cobj, octaveLayers)

function getNOctaveLayers(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getNOctaveLayers(julia_to_cpp(cobj, Any)))
end
getNOctaveLayers(cobj::Any; ) = getNOctaveLayers(cobj)

function setDiffusivity(cobj::Any, diff::KAZE_DiffusivityType)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_setDiffusivity(julia_to_cpp(cobj, Any),julia_to_cpp(diff, KAZE_DiffusivityType)))
end
setDiffusivity(cobj::Any, diff::KAZE_DiffusivityType; ) = setDiffusivity(cobj, diff)

function getDiffusivity(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getDiffusivity(julia_to_cpp(cobj, Any)))
end
getDiffusivity(cobj::Any; ) = getDiffusivity(cobj)

function getDefaultName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_cv_AKAZE_getDefaultName(julia_to_cpp(cobj, Any)))
end
getDefaultName(cobj::Any; ) = getDefaultName(cobj)
...
function add(cobj::Any, descriptors::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_add(julia_to_cpp(cobj, Any),julia_to_cpp(descriptors, Array{Image, 1})))
end
add(cobj::Any, descriptors::Array{Image, 1}; ) = add(cobj, descriptors)

function add(cobj::Any, descriptors::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_add(julia_to_cpp(cobj, Any),julia_to_cpp(descriptors, Array{UMat, 1})))
end
add(cobj::Any, descriptors::Array{UMat, 1}; ) = add(cobj, descriptors)

function getTrainDescriptors(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_getTrainDescriptors(julia_to_cpp(cobj, Any)))
end
getTrainDescriptors(cobj::Any; ) = getTrainDescriptors(cobj)

function clear(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_clear(julia_to_cpp(cobj, Any)))
end
clear(cobj::Any; ) = clear(cobj)

function empty(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_empty(julia_to_cpp(cobj, Any)))
end
empty(cobj::Any; ) = empty(cobj)

function isMaskSupported(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_isMaskSupported(julia_to_cpp(cobj, Any)))
end
isMaskSupported(cobj::Any; ) = isMaskSupported(cobj)

function train(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_train(julia_to_cpp(cobj, Any)))
end
train(cobj::Any; ) = train(cobj)

function match(cobj::Any, queryDescriptors::Image, trainDescriptors::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_match(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(trainDescriptors, Image),julia_to_cpp(mask, Image)))
end
...
function match(cobj::Any, queryDescriptors::UMat, trainDescriptors::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_match(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(trainDescriptors, UMat),julia_to_cpp(mask, UMat)))
end
...
function match(cobj::Any, queryDescriptors::Image, masks::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_match(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(masks, Array{Image, 1})))
end
...
function match(cobj::Any, queryDescriptors::UMat, masks::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_match(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(masks, Array{UMat, 1})))
end
...
function knnMatch(cobj::Any, queryDescriptors::Image, trainDescriptors::Image, k::Int32, mask::Image, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_knnMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(trainDescriptors, Image),julia_to_cpp(k, Int32),julia_to_cpp(mask, Image),julia_to_cpp(compactResult, Bool)))
end
...
function knnMatch(cobj::Any, queryDescriptors::UMat, trainDescriptors::UMat, k::Int32, mask::UMat, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_knnMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(trainDescriptors, UMat),julia_to_cpp(k, Int32),julia_to_cpp(mask, UMat),julia_to_cpp(compactResult, Bool)))
end
...
function knnMatch(cobj::Any, queryDescriptors::Image, k::Int32, masks::Array{Image, 1}, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_knnMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(k, Int32),julia_to_cpp(masks, Array{Image, 1}),julia_to_cpp(compactResult, Bool)))
end
...
function knnMatch(cobj::Any, queryDescriptors::UMat, k::Int32, masks::Array{UMat, 1}, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_knnMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(k, Int32),julia_to_cpp(masks, Array{UMat, 1}),julia_to_cpp(compactResult, Bool)))
end
...
function radiusMatch(cobj::Any, queryDescriptors::Image, trainDescriptors::Image, maxDistance::Float32, mask::Image, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_radiusMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(trainDescriptors, Image),julia_to_cpp(maxDistance, Float32),julia_to_cpp(mask, Image),julia_to_cpp(compactResult, Bool)))
end
...
function radiusMatch(cobj::Any, queryDescriptors::UMat, trainDescriptors::UMat, maxDistance::Float32, mask::UMat, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_radiusMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(trainDescriptors, UMat),julia_to_cpp(maxDistance, Float32),julia_to_cpp(mask, UMat),julia_to_cpp(compactResult, Bool)))
end
...
function radiusMatch(cobj::Any, queryDescriptors::Image, maxDistance::Float32, masks::Array{Image, 1}, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_radiusMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, Image),julia_to_cpp(maxDistance, Float32),julia_to_cpp(masks, Array{Image, 1}),julia_to_cpp(compactResult, Bool)))
end
...
function radiusMatch(cobj::Any, queryDescriptors::UMat, maxDistance::Float32, masks::Array{UMat, 1}, compactResult::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_radiusMatch(julia_to_cpp(cobj, Any),julia_to_cpp(queryDescriptors, UMat),julia_to_cpp(maxDistance, Float32),julia_to_cpp(masks, Array{UMat, 1}),julia_to_cpp(compactResult, Bool)))
end
...
function write(cobj::Any, fileName::String)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_write(julia_to_cpp(cobj, Any),julia_to_cpp(fileName, String)))
end
write(cobj::Any, fileName::String; ) = write(cobj, fileName)

function write(cobj::Any, fs::Ptr{FileStorage}, name::String)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_write(julia_to_cpp(cobj, Any),julia_to_cpp(fs, Ptr{FileStorage}),julia_to_cpp(name, String)))
end
write(cobj::Any, fs::Ptr{FileStorage}; name::String = String()) = write(cobj, fs, name)

function read(cobj::Any, fileName::String)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_read(julia_to_cpp(cobj, Any),julia_to_cpp(fileName, String)))
end
read(cobj::Any, fileName::String; ) = read(cobj, fileName)

function read(cobj::Any, arg1::FileNode)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_read(julia_to_cpp(cobj, Any),julia_to_cpp(arg1, FileNode)))
end
read(cobj::Any, arg1::FileNode; ) = read(cobj, arg1)

function clone(cobj::Any, emptyTrainData::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_cv_DescriptorMatcher_clone(julia_to_cpp(cobj, Any),julia_to_cpp(emptyTrainData, Bool)))
end
...
function add(cobj::Any, descriptors::Image)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_add(julia_to_cpp(cobj, Any),julia_to_cpp(descriptors, Image)))
end
...
function getDescriptors(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_getDescriptors(julia_to_cpp(cobj, Any)))
end
getDescriptors(cobj::Any; ) = getDescriptors(cobj)

function descriptorsCount(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_descriptorsCount(julia_to_cpp(cobj, Any)))
end
descriptorsCount(cobj::Any; ) = descriptorsCount(cobj)

function clear(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_clear(julia_to_cpp(cobj, Any)))
end
clear(cobj::Any; ) = clear(cobj)

function cluster(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_cluster(julia_to_cpp(cobj, Any)))
end
cluster(cobj::Any; ) = cluster(cobj)

function cluster(cobj::Any, descriptors::Image)
	return cpp_to_julia(jlopencv_cv_cv_BOWTrainer_cv_BOWTrainer_cluster(julia_to_cpp(cobj, Any),julia_to_cpp(descriptors, Image)))
end
...
function cluster(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWKMeansTrainer_cv_BOWKMeansTrainer_cluster(julia_to_cpp(cobj, Any)))
end
cluster(cobj::Any; ) = cluster(cobj)

function cluster(cobj::Any, descriptors::Image)
	return cpp_to_julia(jlopencv_cv_cv_BOWKMeansTrainer_cv_BOWKMeansTrainer_cluster(julia_to_cpp(cobj, Any),julia_to_cpp(descriptors, Image)))
end
cluster(cobj::Any, descriptors::Image; ) = cluster(cobj, descriptors)
...
function setVocabulary(cobj::Any, vocabulary::Image)
	return cpp_to_julia(jlopencv_cv_cv_BOWImgDescriptorExtractor_cv_BOWImgDescriptorExtractor_setVocabulary(julia_to_cpp(cobj, Any),julia_to_cpp(vocabulary, Image)))
end
...
function getVocabulary(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWImgDescriptorExtractor_cv_BOWImgDescriptorExtractor_getVocabulary(julia_to_cpp(cobj, Any)))
end
...
function compute2(cobj::Any, image::Image, keypoints::Array{KeyPoint, 1}, imgDescriptor::Image)
	return cpp_to_julia(jlopencv_cv_cv_BOWImgDescriptorExtractor_cv_BOWImgDescriptorExtractor_compute2(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(imgDescriptor, Image)))
end
compute2(cobj::Any, image::Image, keypoints::Array{KeyPoint, 1}; imgDescriptor::Image = Mat()) = compute2(cobj, image, keypoints, imgDescriptor)
...
function descriptorSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWImgDescriptorExtractor_cv_BOWImgDescriptorExtractor_descriptorSize(julia_to_cpp(cobj, Any)))
end
descriptorSize(cobj::Any; ) = descriptorSize(cobj)

function descriptorType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BOWImgDescriptorExtractor_cv_BOWImgDescriptorExtractor_descriptorType(julia_to_cpp(cobj, Any)))
end
descriptorType(cobj::Any; ) = descriptorType(cobj)
...
function predict(cobj::Any, control::Image)
	return cpp_to_julia(jlopencv_cv_cv_KalmanFilter_cv_KalmanFilter_predict(julia_to_cpp(cobj, Any),julia_to_cpp(control, Image)))
end
...
function correct(cobj::Any, measurement::Image)
	return cpp_to_julia(jlopencv_cv_cv_KalmanFilter_cv_KalmanFilter_correct(julia_to_cpp(cobj, Any),julia_to_cpp(measurement, Image)))
end
...
function calc(cobj::Any, I0::Image, I1::Image, flow::Image)
	return cpp_to_julia(jlopencv_cv_cv_DenseOpticalFlow_cv_DenseOpticalFlow_calc(julia_to_cpp(cobj, Any),julia_to_cpp(I0, Image),julia_to_cpp(I1, Image),julia_to_cpp(flow, Image)))
end
calc(cobj::Any, I0::Image, I1::Image, flow::Image; ) = calc(cobj, I0, I1, flow)

function calc(cobj::Any, I0::UMat, I1::UMat, flow::UMat)
	return cpp_to_julia(jlopencv_cv_cv_DenseOpticalFlow_cv_DenseOpticalFlow_calc(julia_to_cpp(cobj, Any),julia_to_cpp(I0, UMat),julia_to_cpp(I1, UMat),julia_to_cpp(flow, UMat)))
end
calc(cobj::Any, I0::UMat, I1::UMat, flow::UMat; ) = calc(cobj, I0, I1, flow)

function collectGarbage(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DenseOpticalFlow_cv_DenseOpticalFlow_collectGarbage(julia_to_cpp(cobj, Any)))
end
collectGarbage(cobj::Any; ) = collectGarbage(cobj)
...
function calc(cobj::Any, prevImg::Image, nextImg::Image, prevPts::Image, nextPts::Image, status::Image, err::Image)
	return cpp_to_julia(jlopencv_cv_cv_SparseOpticalFlow_cv_SparseOpticalFlow_calc(julia_to_cpp(cobj, Any),julia_to_cpp(prevImg, Image),julia_to_cpp(nextImg, Image),julia_to_cpp(prevPts, Image),julia_to_cpp(nextPts, Image),julia_to_cpp(status, Image),julia_to_cpp(err, Image)))
end
...
function calc(cobj::Any, prevImg::UMat, nextImg::UMat, prevPts::UMat, nextPts::UMat, status::UMat, err::UMat)
	return cpp_to_julia(jlopencv_cv_cv_SparseOpticalFlow_cv_SparseOpticalFlow_calc(julia_to_cpp(cobj, Any),julia_to_cpp(prevImg, UMat),julia_to_cpp(nextImg, UMat),julia_to_cpp(prevPts, UMat),julia_to_cpp(nextPts, UMat),julia_to_cpp(status, UMat),julia_to_cpp(err, UMat)))
end
...
function getNumLevels(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getNumLevels(julia_to_cpp(cobj, Any)))
end
getNumLevels(cobj::Any; ) = getNumLevels(cobj)

function setNumLevels(cobj::Any, numLevels::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setNumLevels(julia_to_cpp(cobj, Any),julia_to_cpp(numLevels, Int32)))
end
setNumLevels(cobj::Any, numLevels::Int32; ) = setNumLevels(cobj, numLevels)

function getPyrScale(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getPyrScale(julia_to_cpp(cobj, Any)))
end
getPyrScale(cobj::Any; ) = getPyrScale(cobj)

function setPyrScale(cobj::Any, pyrScale::Float64)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setPyrScale(julia_to_cpp(cobj, Any),julia_to_cpp(pyrScale, Float64)))
end
setPyrScale(cobj::Any, pyrScale::Float64; ) = setPyrScale(cobj, pyrScale)

function getFastPyramids(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getFastPyramids(julia_to_cpp(cobj, Any)))
end
getFastPyramids(cobj::Any; ) = getFastPyramids(cobj)

function setFastPyramids(cobj::Any, fastPyramids::Bool)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setFastPyramids(julia_to_cpp(cobj, Any),julia_to_cpp(fastPyramids, Bool)))
end
setFastPyramids(cobj::Any, fastPyramids::Bool; ) = setFastPyramids(cobj, fastPyramids)

function getWinSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getWinSize(julia_to_cpp(cobj, Any)))
end
getWinSize(cobj::Any; ) = getWinSize(cobj)

function setWinSize(cobj::Any, winSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setWinSize(julia_to_cpp(cobj, Any),julia_to_cpp(winSize, Int32)))
end
setWinSize(cobj::Any, winSize::Int32; ) = setWinSize(cobj, winSize)

function getNumIters(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getNumIters(julia_to_cpp(cobj, Any)))
end
getNumIters(cobj::Any; ) = getNumIters(cobj)

function setNumIters(cobj::Any, numIters::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setNumIters(julia_to_cpp(cobj, Any),julia_to_cpp(numIters, Int32)))
end
setNumIters(cobj::Any, numIters::Int32; ) = setNumIters(cobj, numIters)

function getPolyN(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getPolyN(julia_to_cpp(cobj, Any)))
end
getPolyN(cobj::Any; ) = getPolyN(cobj)

function setPolyN(cobj::Any, polyN::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setPolyN(julia_to_cpp(cobj, Any),julia_to_cpp(polyN, Int32)))
end
setPolyN(cobj::Any, polyN::Int32; ) = setPolyN(cobj, polyN)

function getPolySigma(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getPolySigma(julia_to_cpp(cobj, Any)))
end
getPolySigma(cobj::Any; ) = getPolySigma(cobj)

function setPolySigma(cobj::Any, polySigma::Float64)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setPolySigma(julia_to_cpp(cobj, Any),julia_to_cpp(polySigma, Float64)))
end
setPolySigma(cobj::Any, polySigma::Float64; ) = setPolySigma(cobj, polySigma)

function getFlags(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_getFlags(julia_to_cpp(cobj, Any)))
end
getFlags(cobj::Any; ) = getFlags(cobj)

function setFlags(cobj::Any, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_cv_FarnebackOpticalFlow_setFlags(julia_to_cpp(cobj, Any),julia_to_cpp(flags, Int32)))
end
...
function calcUV(cobj::Any, I0::Image, I1::Image, flow_u::Image, flow_v::Image)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_calcUV(julia_to_cpp(cobj, Any),julia_to_cpp(I0, Image),julia_to_cpp(I1, Image),julia_to_cpp(flow_u, Image),julia_to_cpp(flow_v, Image)))
end
...
function calcUV(cobj::Any, I0::UMat, I1::UMat, flow_u::UMat, flow_v::UMat)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_calcUV(julia_to_cpp(cobj, Any),julia_to_cpp(I0, UMat),julia_to_cpp(I1, UMat),julia_to_cpp(flow_u, UMat),julia_to_cpp(flow_v, UMat)))
end
...
function getFixedPointIterations(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getFixedPointIterations(julia_to_cpp(cobj, Any)))
end
getFixedPointIterations(cobj::Any; ) = getFixedPointIterations(cobj)

function setFixedPointIterations(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setFixedPointIterations(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
setFixedPointIterations(cobj::Any, val::Int32; ) = setFixedPointIterations(cobj, val)

function getSorIterations(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getSorIterations(julia_to_cpp(cobj, Any)))
end
getSorIterations(cobj::Any; ) = getSorIterations(cobj)

function setSorIterations(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setSorIterations(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
setSorIterations(cobj::Any, val::Int32; ) = setSorIterations(cobj, val)

function getOmega(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getOmega(julia_to_cpp(cobj, Any)))
end
getOmega(cobj::Any; ) = getOmega(cobj)

function setOmega(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setOmega(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
setOmega(cobj::Any, val::Float32; ) = setOmega(cobj, val)

function getAlpha(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getAlpha(julia_to_cpp(cobj, Any)))
end
getAlpha(cobj::Any; ) = getAlpha(cobj)

function setAlpha(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setAlpha(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
setAlpha(cobj::Any, val::Float32; ) = setAlpha(cobj, val)

function getDelta(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getDelta(julia_to_cpp(cobj, Any)))
end
getDelta(cobj::Any; ) = getDelta(cobj)

function setDelta(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setDelta(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
setDelta(cobj::Any, val::Float32; ) = setDelta(cobj, val)

function getGamma(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_getGamma(julia_to_cpp(cobj, Any)))
end
getGamma(cobj::Any; ) = getGamma(cobj)

function setGamma(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_VariationalRefinement_cv_VariationalRefinement_setGamma(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
...
function getFinestScale(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getFinestScale(julia_to_cpp(cobj, Any)))
end
getFinestScale(cobj::Any; ) = getFinestScale(cobj)

function setFinestScale(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setFinestScale(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
setFinestScale(cobj::Any, val::Int32; ) = setFinestScale(cobj, val)

function getPatchSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getPatchSize(julia_to_cpp(cobj, Any)))
end
getPatchSize(cobj::Any; ) = getPatchSize(cobj)

function setPatchSize(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setPatchSize(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
setPatchSize(cobj::Any, val::Int32; ) = setPatchSize(cobj, val)

function getPatchStride(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getPatchStride(julia_to_cpp(cobj, Any)))
end
getPatchStride(cobj::Any; ) = getPatchStride(cobj)

function setPatchStride(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setPatchStride(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
setPatchStride(cobj::Any, val::Int32; ) = setPatchStride(cobj, val)

function getGradientDescentIterations(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getGradientDescentIterations(julia_to_cpp(cobj, Any)))
end
...
function setGradientDescentIterations(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setGradientDescentIterations(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
...
function getVariationalRefinementIterations(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getVariationalRefinementIterations(julia_to_cpp(cobj, Any)))
end
...
function setVariationalRefinementIterations(cobj::Any, val::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setVariationalRefinementIterations(julia_to_cpp(cobj, Any),julia_to_cpp(val, Int32)))
end
...
function getVariationalRefinementAlpha(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getVariationalRefinementAlpha(julia_to_cpp(cobj, Any)))
end
...
function setVariationalRefinementAlpha(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setVariationalRefinementAlpha(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
...
function getVariationalRefinementDelta(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getVariationalRefinementDelta(julia_to_cpp(cobj, Any)))
end
...
function setVariationalRefinementDelta(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setVariationalRefinementDelta(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
...
function getVariationalRefinementGamma(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getVariationalRefinementGamma(julia_to_cpp(cobj, Any)))
end
...
function setVariationalRefinementGamma(cobj::Any, val::Float32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setVariationalRefinementGamma(julia_to_cpp(cobj, Any),julia_to_cpp(val, Float32)))
end
...
function getUseMeanNormalization(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getUseMeanNormalization(julia_to_cpp(cobj, Any)))
end
getUseMeanNormalization(cobj::Any; ) = getUseMeanNormalization(cobj)

function setUseMeanNormalization(cobj::Any, val::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setUseMeanNormalization(julia_to_cpp(cobj, Any),julia_to_cpp(val, Bool)))
end
setUseMeanNormalization(cobj::Any, val::Bool; ) = setUseMeanNormalization(cobj, val)

function getUseSpatialPropagation(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_getUseSpatialPropagation(julia_to_cpp(cobj, Any)))
end
getUseSpatialPropagation(cobj::Any; ) = getUseSpatialPropagation(cobj)

function setUseSpatialPropagation(cobj::Any, val::Bool)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_cv_DISOpticalFlow_setUseSpatialPropagation(julia_to_cpp(cobj, Any),julia_to_cpp(val, Bool)))
end
...
function getWinSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_getWinSize(julia_to_cpp(cobj, Any)))
end
getWinSize(cobj::Any; ) = getWinSize(cobj)

function setWinSize(cobj::Any, winSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_setWinSize(julia_to_cpp(cobj, Any),julia_to_cpp(winSize, Size)))
end
setWinSize(cobj::Any, winSize::Size; ) = setWinSize(cobj, winSize)

function getMaxLevel(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_getMaxLevel(julia_to_cpp(cobj, Any)))
end
getMaxLevel(cobj::Any; ) = getMaxLevel(cobj)

function setMaxLevel(cobj::Any, maxLevel::Int32)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_setMaxLevel(julia_to_cpp(cobj, Any),julia_to_cpp(maxLevel, Int32)))
end
setMaxLevel(cobj::Any, maxLevel::Int32; ) = setMaxLevel(cobj, maxLevel)

function getTermCriteria(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_getTermCriteria(julia_to_cpp(cobj, Any)))
end
getTermCriteria(cobj::Any; ) = getTermCriteria(cobj)

function setTermCriteria(cobj::Any, crit::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_setTermCriteria(julia_to_cpp(cobj, Any),julia_to_cpp(crit, TermCriteria)))
end
setTermCriteria(cobj::Any, crit::TermCriteria; ) = setTermCriteria(cobj, crit)

function getFlags(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_getFlags(julia_to_cpp(cobj, Any)))
end
getFlags(cobj::Any; ) = getFlags(cobj)

function setFlags(cobj::Any, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_setFlags(julia_to_cpp(cobj, Any),julia_to_cpp(flags, Int32)))
end
setFlags(cobj::Any, flags::Int32; ) = setFlags(cobj, flags)

function getMinEigThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_getMinEigThreshold(julia_to_cpp(cobj, Any)))
end
getMinEigThreshold(cobj::Any; ) = getMinEigThreshold(cobj)

function setMinEigThreshold(cobj::Any, minEigThreshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_cv_SparsePyrLKOpticalFlow_setMinEigThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(minEigThreshold, Float64)))
end
...
function apply(cobj::Any, image::Image, fgmask::Image, learningRate::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractor_cv_BackgroundSubtractor_apply(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(fgmask, Image),julia_to_cpp(learningRate, Float64)))
end
...
function apply(cobj::Any, image::UMat, fgmask::UMat, learningRate::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractor_cv_BackgroundSubtractor_apply(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(fgmask, UMat),julia_to_cpp(learningRate, Float64)))
end
...
function getBackgroundImage(cobj::Any, backgroundImage::Image)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractor_cv_BackgroundSubtractor_getBackgroundImage(julia_to_cpp(cobj, Any),julia_to_cpp(backgroundImage, Image)))
end
...
function getBackgroundImage(cobj::Any, backgroundImage::UMat)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractor_cv_BackgroundSubtractor_getBackgroundImage(julia_to_cpp(cobj, Any),julia_to_cpp(backgroundImage, UMat)))
end
...
function getHistory(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getHistory(julia_to_cpp(cobj, Any)))
end
getHistory(cobj::Any; ) = getHistory(cobj)

function setHistory(cobj::Any, history::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setHistory(julia_to_cpp(cobj, Any),julia_to_cpp(history, Int32)))
end
setHistory(cobj::Any, history::Int32; ) = setHistory(cobj, history)

function getNMixtures(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getNMixtures(julia_to_cpp(cobj, Any)))
end
getNMixtures(cobj::Any; ) = getNMixtures(cobj)

function setNMixtures(cobj::Any, nmixtures::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setNMixtures(julia_to_cpp(cobj, Any),julia_to_cpp(nmixtures, Int32)))
end
setNMixtures(cobj::Any, nmixtures::Int32; ) = setNMixtures(cobj, nmixtures)

function getBackgroundRatio(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getBackgroundRatio(julia_to_cpp(cobj, Any)))
end
getBackgroundRatio(cobj::Any; ) = getBackgroundRatio(cobj)

function setBackgroundRatio(cobj::Any, ratio::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setBackgroundRatio(julia_to_cpp(cobj, Any),julia_to_cpp(ratio, Float64)))
end
setBackgroundRatio(cobj::Any, ratio::Float64; ) = setBackgroundRatio(cobj, ratio)

function getVarThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getVarThreshold(julia_to_cpp(cobj, Any)))
end
getVarThreshold(cobj::Any; ) = getVarThreshold(cobj)

function setVarThreshold(cobj::Any, varThreshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setVarThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(varThreshold, Float64)))
end
setVarThreshold(cobj::Any, varThreshold::Float64; ) = setVarThreshold(cobj, varThreshold)

function getVarThresholdGen(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getVarThresholdGen(julia_to_cpp(cobj, Any)))
end
getVarThresholdGen(cobj::Any; ) = getVarThresholdGen(cobj)

function setVarThresholdGen(cobj::Any, varThresholdGen::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setVarThresholdGen(julia_to_cpp(cobj, Any),julia_to_cpp(varThresholdGen, Float64)))
end
setVarThresholdGen(cobj::Any, varThresholdGen::Float64; ) = setVarThresholdGen(cobj, varThresholdGen)

function getVarInit(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getVarInit(julia_to_cpp(cobj, Any)))
end
getVarInit(cobj::Any; ) = getVarInit(cobj)

function setVarInit(cobj::Any, varInit::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setVarInit(julia_to_cpp(cobj, Any),julia_to_cpp(varInit, Float64)))
end
setVarInit(cobj::Any, varInit::Float64; ) = setVarInit(cobj, varInit)

function getVarMin(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getVarMin(julia_to_cpp(cobj, Any)))
end
getVarMin(cobj::Any; ) = getVarMin(cobj)

function setVarMin(cobj::Any, varMin::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setVarMin(julia_to_cpp(cobj, Any),julia_to_cpp(varMin, Float64)))
end
setVarMin(cobj::Any, varMin::Float64; ) = setVarMin(cobj, varMin)

function getVarMax(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getVarMax(julia_to_cpp(cobj, Any)))
end
getVarMax(cobj::Any; ) = getVarMax(cobj)

function setVarMax(cobj::Any, varMax::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setVarMax(julia_to_cpp(cobj, Any),julia_to_cpp(varMax, Float64)))
end
setVarMax(cobj::Any, varMax::Float64; ) = setVarMax(cobj, varMax)

function getComplexityReductionThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getComplexityReductionThreshold(julia_to_cpp(cobj, Any)))
end
...
function setComplexityReductionThreshold(cobj::Any, ct::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setComplexityReductionThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(ct, Float64)))
end
...
function getDetectShadows(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getDetectShadows(julia_to_cpp(cobj, Any)))
end
getDetectShadows(cobj::Any; ) = getDetectShadows(cobj)

function setDetectShadows(cobj::Any, detectShadows::Bool)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setDetectShadows(julia_to_cpp(cobj, Any),julia_to_cpp(detectShadows, Bool)))
end
setDetectShadows(cobj::Any, detectShadows::Bool; ) = setDetectShadows(cobj, detectShadows)

function getShadowValue(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getShadowValue(julia_to_cpp(cobj, Any)))
end
getShadowValue(cobj::Any; ) = getShadowValue(cobj)

function setShadowValue(cobj::Any, value::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setShadowValue(julia_to_cpp(cobj, Any),julia_to_cpp(value, Int32)))
end
setShadowValue(cobj::Any, value::Int32; ) = setShadowValue(cobj, value)

function getShadowThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_getShadowThreshold(julia_to_cpp(cobj, Any)))
end
getShadowThreshold(cobj::Any; ) = getShadowThreshold(cobj)

function setShadowThreshold(cobj::Any, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_setShadowThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Float64)))
end
setShadowThreshold(cobj::Any, threshold::Float64; ) = setShadowThreshold(cobj, threshold)

function apply(cobj::Any, image::Image, fgmask::Image, learningRate::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_apply(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(fgmask, Image),julia_to_cpp(learningRate, Float64)))
end
apply(cobj::Any, image::Image; fgmask::Image = Mat(), learningRate::Float64 = -1) = apply(cobj, image, fgmask, learningRate)

function apply(cobj::Any, image::UMat, fgmask::UMat, learningRate::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorMOG2_cv_BackgroundSubtractorMOG2_apply(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(fgmask, UMat),julia_to_cpp(learningRate, Float64)))
end
apply(cobj::Any, image::UMat; fgmask::UMat = UMat(), learningRate::Float64 = -1) = apply(cobj, image, fgmask, learningRate)
...
function getHistory(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getHistory(julia_to_cpp(cobj, Any)))
end
getHistory(cobj::Any; ) = getHistory(cobj)

function setHistory(cobj::Any, history::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setHistory(julia_to_cpp(cobj, Any),julia_to_cpp(history, Int32)))
end
setHistory(cobj::Any, history::Int32; ) = setHistory(cobj, history)

function getNSamples(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getNSamples(julia_to_cpp(cobj, Any)))
end
getNSamples(cobj::Any; ) = getNSamples(cobj)

function setNSamples(cobj::Any, _nN::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setNSamples(julia_to_cpp(cobj, Any),julia_to_cpp(_nN, Int32)))
end
setNSamples(cobj::Any, _nN::Int32; ) = setNSamples(cobj, _nN)

function getDist2Threshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getDist2Threshold(julia_to_cpp(cobj, Any)))
end
getDist2Threshold(cobj::Any; ) = getDist2Threshold(cobj)

function setDist2Threshold(cobj::Any, _dist2Threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setDist2Threshold(julia_to_cpp(cobj, Any),julia_to_cpp(_dist2Threshold, Float64)))
end
setDist2Threshold(cobj::Any, _dist2Threshold::Float64; ) = setDist2Threshold(cobj, _dist2Threshold)

function getkNNSamples(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getkNNSamples(julia_to_cpp(cobj, Any)))
end
getkNNSamples(cobj::Any; ) = getkNNSamples(cobj)

function setkNNSamples(cobj::Any, _nkNN::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setkNNSamples(julia_to_cpp(cobj, Any),julia_to_cpp(_nkNN, Int32)))
end
setkNNSamples(cobj::Any, _nkNN::Int32; ) = setkNNSamples(cobj, _nkNN)

function getDetectShadows(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getDetectShadows(julia_to_cpp(cobj, Any)))
end
getDetectShadows(cobj::Any; ) = getDetectShadows(cobj)

function setDetectShadows(cobj::Any, detectShadows::Bool)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setDetectShadows(julia_to_cpp(cobj, Any),julia_to_cpp(detectShadows, Bool)))
end
setDetectShadows(cobj::Any, detectShadows::Bool; ) = setDetectShadows(cobj, detectShadows)

function getShadowValue(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getShadowValue(julia_to_cpp(cobj, Any)))
end
getShadowValue(cobj::Any; ) = getShadowValue(cobj)

function setShadowValue(cobj::Any, value::Int32)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setShadowValue(julia_to_cpp(cobj, Any),julia_to_cpp(value, Int32)))
end
setShadowValue(cobj::Any, value::Int32; ) = setShadowValue(cobj, value)

function getShadowThreshold(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_getShadowThreshold(julia_to_cpp(cobj, Any)))
end
getShadowThreshold(cobj::Any; ) = getShadowThreshold(cobj)

function setShadowThreshold(cobj::Any, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_BackgroundSubtractorKNN_cv_BackgroundSubtractorKNN_setShadowThreshold(julia_to_cpp(cobj, Any),julia_to_cpp(threshold, Float64)))
end
setShadowThreshold(cobj::Any, threshold::Float64; ) = setShadowThreshold(cobj, threshold)
...
function empty(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_empty(julia_to_cpp(cobj, Any)))
end
empty(cobj::Any; ) = empty(cobj)

function load(cobj::Any, filename::String)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_load(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String)))
end
load(cobj::Any, filename::String; ) = load(cobj, filename)

function read(cobj::Any, node::FileNode)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_read(julia_to_cpp(cobj, Any),julia_to_cpp(node, FileNode)))
end
...
function detectMultiScale(cobj::Any, image::Image, scaleFactor::Float64, minNeighbors::Int32, flags::Int32, minSize::Size, maxSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(scaleFactor, Float64),julia_to_cpp(minNeighbors, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(minSize, Size),julia_to_cpp(maxSize, Size)))
end
...
function detectMultiScale(cobj::Any, image::UMat, scaleFactor::Float64, minNeighbors::Int32, flags::Int32, minSize::Size, maxSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(scaleFactor, Float64),julia_to_cpp(minNeighbors, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(minSize, Size),julia_to_cpp(maxSize, Size)))
end
...
function detectMultiScale(cobj::Any, image::Image, scaleFactor::Float64, minNeighbors::Int32, flags::Int32, minSize::Size, maxSize::Size, outputRejectLevels::Bool)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(scaleFactor, Float64),julia_to_cpp(minNeighbors, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(minSize, Size),julia_to_cpp(maxSize, Size),julia_to_cpp(outputRejectLevels, Bool)))
end
...
function detectMultiScale(cobj::Any, image::UMat, scaleFactor::Float64, minNeighbors::Int32, flags::Int32, minSize::Size, maxSize::Size, outputRejectLevels::Bool)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(scaleFactor, Float64),julia_to_cpp(minNeighbors, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(minSize, Size),julia_to_cpp(maxSize, Size),julia_to_cpp(outputRejectLevels, Bool)))
end
...
function isOldFormatCascade(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_isOldFormatCascade(julia_to_cpp(cobj, Any)))
end
isOldFormatCascade(cobj::Any; ) = isOldFormatCascade(cobj)

function getOriginalWindowSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_getOriginalWindowSize(julia_to_cpp(cobj, Any)))
end
getOriginalWindowSize(cobj::Any; ) = getOriginalWindowSize(cobj)

function getFeatureType(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_cv_CascadeClassifier_getFeatureType(julia_to_cpp(cobj, Any)))
end
...
function getDescriptorSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_getDescriptorSize(julia_to_cpp(cobj, Any)))
end
getDescriptorSize(cobj::Any; ) = getDescriptorSize(cobj)

function checkDetectorSize(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_checkDetectorSize(julia_to_cpp(cobj, Any)))
end
checkDetectorSize(cobj::Any; ) = checkDetectorSize(cobj)

function getWinSigma(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_getWinSigma(julia_to_cpp(cobj, Any)))
end
getWinSigma(cobj::Any; ) = getWinSigma(cobj)

function setSVMDetector(cobj::Any, svmdetector::Image)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_setSVMDetector(julia_to_cpp(cobj, Any),julia_to_cpp(svmdetector, Image)))
end
...
function setSVMDetector(cobj::Any, svmdetector::UMat)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_setSVMDetector(julia_to_cpp(cobj, Any),julia_to_cpp(svmdetector, UMat)))
end
...
function load(cobj::Any, filename::String, objname::String)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_load(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String),julia_to_cpp(objname, String)))
end
...
function save(cobj::Any, filename::String, objname::String)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_save(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String),julia_to_cpp(objname, String)))
end
...
function compute(cobj::Any, img::Image, winStride::Size, padding::Size, locations::Array{Point{Int32}, 1})
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_compute(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(locations, Array{Point{Int32}, 1})))
end
...
function compute(cobj::Any, img::UMat, winStride::Size, padding::Size, locations::Array{Point{Int32}, 1})
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_compute(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(locations, Array{Point{Int32}, 1})))
end
...
function detect(cobj::Any, img::Image, hitThreshold::Float64, winStride::Size, padding::Size, searchLocations::Array{Point{Int32}, 1})
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_detect(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(hitThreshold, Float64),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(searchLocations, Array{Point{Int32}, 1})))
end
...
function detect(cobj::Any, img::UMat, hitThreshold::Float64, winStride::Size, padding::Size, searchLocations::Array{Point{Int32}, 1})
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_detect(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(hitThreshold, Float64),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(searchLocations, Array{Point{Int32}, 1})))
end
...
function detectMultiScale(cobj::Any, img::Image, hitThreshold::Float64, winStride::Size, padding::Size, scale::Float64, finalThreshold::Float64, useMeanshiftGrouping::Bool)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(hitThreshold, Float64),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(scale, Float64),julia_to_cpp(finalThreshold, Float64),julia_to_cpp(useMeanshiftGrouping, Bool)))
end
...
function detectMultiScale(cobj::Any, img::UMat, hitThreshold::Float64, winStride::Size, padding::Size, scale::Float64, finalThreshold::Float64, useMeanshiftGrouping::Bool)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_detectMultiScale(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(hitThreshold, Float64),julia_to_cpp(winStride, Size),julia_to_cpp(padding, Size),julia_to_cpp(scale, Float64),julia_to_cpp(finalThreshold, Float64),julia_to_cpp(useMeanshiftGrouping, Bool)))
end
...
function computeGradient(cobj::Any, img::Image, grad::Image, angleOfs::Image, paddingTL::Size, paddingBR::Size)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_computeGradient(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(grad, Image),julia_to_cpp(angleOfs, Image),julia_to_cpp(paddingTL, Size),julia_to_cpp(paddingBR, Size)))
end
...
function computeGradient(cobj::Any, img::UMat, grad::UMat, angleOfs::UMat, paddingTL::Size, paddingBR::Size)
	return cpp_to_julia(jlopencv_cv_cv_HOGDescriptor_cv_HOGDescriptor_computeGradient(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(grad, UMat),julia_to_cpp(angleOfs, UMat),julia_to_cpp(paddingTL, Size),julia_to_cpp(paddingBR, Size)))
end
...
function setEpsX(cobj::Any, epsX::Float64)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_setEpsX(julia_to_cpp(cobj, Any),julia_to_cpp(epsX, Float64)))
end
setEpsX(cobj::Any, epsX::Float64; ) = setEpsX(cobj, epsX)

function setEpsY(cobj::Any, epsY::Float64)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_setEpsY(julia_to_cpp(cobj, Any),julia_to_cpp(epsY, Float64)))
end
setEpsY(cobj::Any, epsY::Float64; ) = setEpsY(cobj, epsY)

function detect(cobj::Any, img::Image, points::Image)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detect(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image)))
end
detect(cobj::Any, img::Image; points::Image = Mat()) = detect(cobj, img, points)

function detect(cobj::Any, img::UMat, points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detect(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat)))
end
...
function decode(cobj::Any, img::Image, points::Image, straight_qrcode::Image)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_decode(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image),julia_to_cpp(straight_qrcode, Image)))
end
...
function decode(cobj::Any, img::UMat, points::UMat, straight_qrcode::UMat)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_decode(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat),julia_to_cpp(straight_qrcode, UMat)))
end
...
function detectAndDecode(cobj::Any, img::Image, points::Image, straight_qrcode::Image)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectAndDecode(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image),julia_to_cpp(straight_qrcode, Image)))
end
...
function detectAndDecode(cobj::Any, img::UMat, points::UMat, straight_qrcode::UMat)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectAndDecode(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat),julia_to_cpp(straight_qrcode, UMat)))
end
...
function detectMulti(cobj::Any, img::Image, points::Image)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image)))
end
...
function detectMulti(cobj::Any, img::UMat, points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat)))
end
...
function decodeMulti(cobj::Any, img::Image, points::Image, straight_qrcode::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_decodeMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image),julia_to_cpp(straight_qrcode, Array{Image, 1})))
end
...
function decodeMulti(cobj::Any, img::UMat, points::UMat, straight_qrcode::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_decodeMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat),julia_to_cpp(straight_qrcode, Array{UMat, 1})))
end
...
function detectAndDecodeMulti(cobj::Any, img::Image, points::Image, straight_qrcode::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectAndDecodeMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, Image),julia_to_cpp(points, Image),julia_to_cpp(straight_qrcode, Array{Image, 1})))
end
...
function detectAndDecodeMulti(cobj::Any, img::UMat, points::UMat, straight_qrcode::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_QRCodeDetector_cv_QRCodeDetector_detectAndDecodeMulti(julia_to_cpp(cobj, Any),julia_to_cpp(img, UMat),julia_to_cpp(points, UMat),julia_to_cpp(straight_qrcode, Array{UMat, 1})))
end
...
function open(cobj::Any, filename::String, apiPreference::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_open(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String),julia_to_cpp(apiPreference, Int32)))
end
...
function open(cobj::Any, index::Int32, apiPreference::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_open(julia_to_cpp(cobj, Any),julia_to_cpp(index, Int32),julia_to_cpp(apiPreference, Int32)))
end
open(cobj::Any, index::Int32; apiPreference::Int32 = CAP_ANY) = open(cobj, index, apiPreference)

function isOpened(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_isOpened(julia_to_cpp(cobj, Any)))
end
isOpened(cobj::Any; ) = isOpened(cobj)

function release(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_release(julia_to_cpp(cobj, Any)))
end
release(cobj::Any; ) = release(cobj)

function grab(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_grab(julia_to_cpp(cobj, Any)))
end
grab(cobj::Any; ) = grab(cobj)

function retrieve(cobj::Any, image::Image, flag::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_retrieve(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image),julia_to_cpp(flag, Int32)))
end
retrieve(cobj::Any; image::Image = Mat(), flag::Int32 = 0) = retrieve(cobj, image, flag)

function retrieve(cobj::Any, image::UMat, flag::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_retrieve(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat),julia_to_cpp(flag, Int32)))
end
retrieve(cobj::Any; image::UMat = UMat(), flag::Int32 = 0) = retrieve(cobj, image, flag)

function read(cobj::Any, image::Image)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_read(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image)))
end
read(cobj::Any; image::Image = Mat()) = read(cobj, image)

function read(cobj::Any, image::UMat)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_read(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat)))
end
read(cobj::Any; image::UMat = UMat()) = read(cobj, image)

function set(cobj::Any, propId::Int32, value::Float64)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_set(julia_to_cpp(cobj, Any),julia_to_cpp(propId, Int32),julia_to_cpp(value, Float64)))
end
set(cobj::Any, propId::Int32, value::Float64; ) = set(cobj, propId, value)

function get(cobj::Any, propId::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_get(julia_to_cpp(cobj, Any),julia_to_cpp(propId, Int32)))
end
get(cobj::Any, propId::Int32; ) = get(cobj, propId)

function getBackendName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_getBackendName(julia_to_cpp(cobj, Any)))
end
getBackendName(cobj::Any; ) = getBackendName(cobj)

function setExceptionMode(cobj::Any, enable::Bool)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_setExceptionMode(julia_to_cpp(cobj, Any),julia_to_cpp(enable, Bool)))
end
setExceptionMode(cobj::Any, enable::Bool; ) = setExceptionMode(cobj, enable)

function getExceptionMode(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoCapture_cv_VideoCapture_getExceptionMode(julia_to_cpp(cobj, Any)))
end
...
function open(cobj::Any, filename::String, fourcc::Int32, fps::Float64, frameSize::Size, isColor::Bool)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_open(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String),julia_to_cpp(fourcc, Int32),julia_to_cpp(fps, Float64),julia_to_cpp(frameSize, Size),julia_to_cpp(isColor, Bool)))
end
...
function open(cobj::Any, filename::String, apiPreference::Int32, fourcc::Int32, fps::Float64, frameSize::Size, isColor::Bool)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_open(julia_to_cpp(cobj, Any),julia_to_cpp(filename, String),julia_to_cpp(apiPreference, Int32),julia_to_cpp(fourcc, Int32),julia_to_cpp(fps, Float64),julia_to_cpp(frameSize, Size),julia_to_cpp(isColor, Bool)))
end
...
function isOpened(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_isOpened(julia_to_cpp(cobj, Any)))
end
isOpened(cobj::Any; ) = isOpened(cobj)

function release(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_release(julia_to_cpp(cobj, Any)))
end
release(cobj::Any; ) = release(cobj)

function write(cobj::Any, image::Image)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_write(julia_to_cpp(cobj, Any),julia_to_cpp(image, Image)))
end
write(cobj::Any, image::Image; ) = write(cobj, image)

function write(cobj::Any, image::UMat)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_write(julia_to_cpp(cobj, Any),julia_to_cpp(image, UMat)))
end
write(cobj::Any, image::UMat; ) = write(cobj, image)

function set(cobj::Any, propId::Int32, value::Float64)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_set(julia_to_cpp(cobj, Any),julia_to_cpp(propId, Int32),julia_to_cpp(value, Float64)))
end
set(cobj::Any, propId::Int32, value::Float64; ) = set(cobj, propId, value)

function get(cobj::Any, propId::Int32)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_get(julia_to_cpp(cobj, Any),julia_to_cpp(propId, Int32)))
end
get(cobj::Any, propId::Int32; ) = get(cobj, propId)

function getBackendName(cobj::Any)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_cv_VideoWriter_getBackendName(julia_to_cpp(cobj, Any)))
end
getBackendName(cobj::Any; ) = getBackendName(cobj)

function borderInterpolate(p::Int32, len::Int32, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_borderInterpolate(julia_to_cpp(p, Int32),julia_to_cpp(len, Int32),julia_to_cpp(borderType, Int32)))
end
...
function copyMakeBorder(src::Image, top::Int32, bottom::Int32, left::Int32, right::Int32, borderType::Int32, dst::Image, value::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_copyMakeBorder(julia_to_cpp(src, Image),julia_to_cpp(top, Int32),julia_to_cpp(bottom, Int32),julia_to_cpp(left, Int32),julia_to_cpp(right, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(dst, Image),julia_to_cpp(value, Scalar)))
end
...
function copyMakeBorder(src::UMat, top::Int32, bottom::Int32, left::Int32, right::Int32, borderType::Int32, dst::UMat, value::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_copyMakeBorder(julia_to_cpp(src, UMat),julia_to_cpp(top, Int32),julia_to_cpp(bottom, Int32),julia_to_cpp(left, Int32),julia_to_cpp(right, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(value, Scalar)))
end
...
function add(src1::Image, src2::Image, dst::Image, mask::Image, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_add(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image),julia_to_cpp(dtype, Int32)))
end
...
function add(src1::UMat, src2::UMat, dst::UMat, mask::UMat, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_add(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(dtype, Int32)))
end
...
function subtract(src1::Image, src2::Image, dst::Image, mask::Image, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_subtract(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image),julia_to_cpp(dtype, Int32)))
end
...
function subtract(src1::UMat, src2::UMat, dst::UMat, mask::UMat, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_subtract(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(dtype, Int32)))
end
...
function multiply(src1::Image, src2::Image, dst::Image, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_multiply(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function multiply(src1::UMat, src2::UMat, dst::UMat, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_multiply(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function divide(src1::Image, src2::Image, dst::Image, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_divide(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function divide(src1::UMat, src2::UMat, dst::UMat, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_divide(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function divide(scale::Float64, src2::Image, dst::Image, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_divide(julia_to_cpp(scale, Float64),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(dtype, Int32)))
end
...
function divide(scale::Float64, src2::UMat, dst::UMat, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_divide(julia_to_cpp(scale, Float64),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(dtype, Int32)))
end
...
function scaleAdd(src1::Image, alpha::Float64, src2::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_scaleAdd(julia_to_cpp(src1, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image)))
end
...
function scaleAdd(src1::UMat, alpha::Float64, src2::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_scaleAdd(julia_to_cpp(src1, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat)))
end
...
function addWeighted(src1::Image, alpha::Float64, src2::Image, beta::Float64, gamma::Float64, dst::Image, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_addWeighted(julia_to_cpp(src1, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(src2, Image),julia_to_cpp(beta, Float64),julia_to_cpp(gamma, Float64),julia_to_cpp(dst, Image),julia_to_cpp(dtype, Int32)))
end
...
function addWeighted(src1::UMat, alpha::Float64, src2::UMat, beta::Float64, gamma::Float64, dst::UMat, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_addWeighted(julia_to_cpp(src1, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(src2, UMat),julia_to_cpp(beta, Float64),julia_to_cpp(gamma, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(dtype, Int32)))
end
...
function convertScaleAbs(src::Image, dst::Image, alpha::Float64, beta::Float64)
	return cpp_to_julia(jlopencv_cv_cv_convertScaleAbs(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(beta, Float64)))
end
...
function convertScaleAbs(src::UMat, dst::UMat, alpha::Float64, beta::Float64)
	return cpp_to_julia(jlopencv_cv_cv_convertScaleAbs(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(beta, Float64)))
end
...
function convertFp16(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_convertFp16(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
convertFp16(src::Image; dst::Image = Mat()) = convertFp16(src, dst)

function convertFp16(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_convertFp16(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
convertFp16(src::UMat; dst::UMat = UMat()) = convertFp16(src, dst)

function LUT(src::Image, lut::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_LUT(julia_to_cpp(src, Image),julia_to_cpp(lut, Image),julia_to_cpp(dst, Image)))
end
LUT(src::Image, lut::Image; dst::Image = Mat()) = LUT(src, lut, dst)

function LUT(src::UMat, lut::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_LUT(julia_to_cpp(src, UMat),julia_to_cpp(lut, UMat),julia_to_cpp(dst, UMat)))
end
LUT(src::UMat, lut::UMat; dst::UMat = UMat()) = LUT(src, lut, dst)

function sumElems(src::Image)
	return cpp_to_julia(jlopencv_cv_cv_sum(julia_to_cpp(src, Image)))
end
sumElems(src::Image; ) = sumElems(src)

function sumElems(src::UMat)
	return cpp_to_julia(jlopencv_cv_cv_sum(julia_to_cpp(src, UMat)))
end
sumElems(src::UMat; ) = sumElems(src)

function countNonZero(src::Image)
	return cpp_to_julia(jlopencv_cv_cv_countNonZero(julia_to_cpp(src, Image)))
end
countNonZero(src::Image; ) = countNonZero(src)

function countNonZero(src::UMat)
	return cpp_to_julia(jlopencv_cv_cv_countNonZero(julia_to_cpp(src, UMat)))
end
countNonZero(src::UMat; ) = countNonZero(src)

function findNonZero(src::Image, idx::Image)
	return cpp_to_julia(jlopencv_cv_cv_findNonZero(julia_to_cpp(src, Image),julia_to_cpp(idx, Image)))
end
findNonZero(src::Image; idx::Image = Mat()) = findNonZero(src, idx)

function findNonZero(src::UMat, idx::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findNonZero(julia_to_cpp(src, UMat),julia_to_cpp(idx, UMat)))
end
findNonZero(src::UMat; idx::UMat = UMat()) = findNonZero(src, idx)

function mean(src::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_mean(julia_to_cpp(src, Image),julia_to_cpp(mask, Image)))
end
mean(src::Image; mask::Image = Mat()) = mean(src, mask)

function mean(src::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_mean(julia_to_cpp(src, UMat),julia_to_cpp(mask, UMat)))
end
mean(src::UMat; mask::UMat = UMat()) = mean(src, mask)

function meanStdDev(src::Image, mean::Image, stddev::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_meanStdDev(julia_to_cpp(src, Image),julia_to_cpp(mean, Image),julia_to_cpp(stddev, Image),julia_to_cpp(mask, Image)))
end
...
function meanStdDev(src::UMat, mean::UMat, stddev::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_meanStdDev(julia_to_cpp(src, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(stddev, UMat),julia_to_cpp(mask, UMat)))
end
...
function norm(src1::Image, normType::Int32, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_norm(julia_to_cpp(src1, Image),julia_to_cpp(normType, Int32),julia_to_cpp(mask, Image)))
end
...
function norm(src1::UMat, normType::Int32, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_norm(julia_to_cpp(src1, UMat),julia_to_cpp(normType, Int32),julia_to_cpp(mask, UMat)))
end
...
function norm(src1::Image, src2::Image, normType::Int32, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_norm(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(normType, Int32),julia_to_cpp(mask, Image)))
end
...
function norm(src1::UMat, src2::UMat, normType::Int32, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_norm(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(normType, Int32),julia_to_cpp(mask, UMat)))
end
...
function PSNR(src1::Image, src2::Image, R::Float64)
	return cpp_to_julia(jlopencv_cv_cv_PSNR(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(R, Float64)))
end
PSNR(src1::Image, src2::Image; R::Float64 = 255.) = PSNR(src1, src2, R)

function PSNR(src1::UMat, src2::UMat, R::Float64)
	return cpp_to_julia(jlopencv_cv_cv_PSNR(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(R, Float64)))
end
...
function batchDistance(src1::Image, src2::Image, dtype::Int32, dist::Image, nidx::Image, normType::Int32, K::Int32, mask::Image, update::Int32, crosscheck::Bool)
	return cpp_to_julia(jlopencv_cv_cv_batchDistance(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dtype, Int32),julia_to_cpp(dist, Image),julia_to_cpp(nidx, Image),julia_to_cpp(normType, Int32),julia_to_cpp(K, Int32),julia_to_cpp(mask, Image),julia_to_cpp(update, Int32),julia_to_cpp(crosscheck, Bool)))
end
...
function batchDistance(src1::UMat, src2::UMat, dtype::Int32, dist::UMat, nidx::UMat, normType::Int32, K::Int32, mask::UMat, update::Int32, crosscheck::Bool)
	return cpp_to_julia(jlopencv_cv_cv_batchDistance(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dtype, Int32),julia_to_cpp(dist, UMat),julia_to_cpp(nidx, UMat),julia_to_cpp(normType, Int32),julia_to_cpp(K, Int32),julia_to_cpp(mask, UMat),julia_to_cpp(update, Int32),julia_to_cpp(crosscheck, Bool)))
end
...
function normalize(src::Image, dst::Image, alpha::Float64, beta::Float64, norm_type::Int32, dtype::Int32, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_normalize(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(beta, Float64),julia_to_cpp(norm_type, Int32),julia_to_cpp(dtype, Int32),julia_to_cpp(mask, Image)))
end
...
function normalize(src::UMat, dst::UMat, alpha::Float64, beta::Float64, norm_type::Int32, dtype::Int32, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_normalize(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(beta, Float64),julia_to_cpp(norm_type, Int32),julia_to_cpp(dtype, Int32),julia_to_cpp(mask, UMat)))
end
...
function minMaxLoc(src::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_minMaxLoc(julia_to_cpp(src, Image),julia_to_cpp(mask, Image)))
end
minMaxLoc(src::Image; mask::Image = Mat()) = minMaxLoc(src, mask)

function minMaxLoc(src::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_minMaxLoc(julia_to_cpp(src, UMat),julia_to_cpp(mask, UMat)))
end
...
function reduce(src::Image, dim::Int32, rtype::Int32, dst::Image, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_reduce(julia_to_cpp(src, Image),julia_to_cpp(dim, Int32),julia_to_cpp(rtype, Int32),julia_to_cpp(dst, Image),julia_to_cpp(dtype, Int32)))
end
...
function reduce(src::UMat, dim::Int32, rtype::Int32, dst::UMat, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_reduce(julia_to_cpp(src, UMat),julia_to_cpp(dim, Int32),julia_to_cpp(rtype, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(dtype, Int32)))
end
...
function merge(mv::Array{Image, 1}, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_merge(julia_to_cpp(mv, Array{Image, 1}),julia_to_cpp(dst, Image)))
end
merge(mv::Array{Image, 1}; dst::Image = Mat()) = merge(mv, dst)

function merge(mv::Array{UMat, 1}, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_merge(julia_to_cpp(mv, Array{UMat, 1}),julia_to_cpp(dst, UMat)))
end
merge(mv::Array{UMat, 1}; dst::UMat = UMat()) = merge(mv, dst)

function split(m::Image, mv::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_split(julia_to_cpp(m, Image),julia_to_cpp(mv, Array{Image, 1})))
end
split(m::Image; mv::Array{Image, 1} = Array{Image, 1}()) = split(m, mv)

function split(m::UMat, mv::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_split(julia_to_cpp(m, UMat),julia_to_cpp(mv, Array{UMat, 1})))
end
...
function mixChannels(src::Array{Image, 1}, dst::Array{Image, 1}, fromTo::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_mixChannels(julia_to_cpp(src, Array{Image, 1}),julia_to_cpp(dst, Array{Image, 1}),julia_to_cpp(fromTo, Array{Int32, 1})))
end
...
function mixChannels(src::Array{UMat, 1}, dst::Array{UMat, 1}, fromTo::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_mixChannels(julia_to_cpp(src, Array{UMat, 1}),julia_to_cpp(dst, Array{UMat, 1}),julia_to_cpp(fromTo, Array{Int32, 1})))
end
...
function extractChannel(src::Image, coi::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_extractChannel(julia_to_cpp(src, Image),julia_to_cpp(coi, Int32),julia_to_cpp(dst, Image)))
end
...
function extractChannel(src::UMat, coi::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_extractChannel(julia_to_cpp(src, UMat),julia_to_cpp(coi, Int32),julia_to_cpp(dst, UMat)))
end
...
function insertChannel(src::Image, dst::Image, coi::Int32)
	return cpp_to_julia(jlopencv_cv_cv_insertChannel(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(coi, Int32)))
end
insertChannel(src::Image, dst::Image, coi::Int32; ) = insertChannel(src, dst, coi)

function insertChannel(src::UMat, dst::UMat, coi::Int32)
	return cpp_to_julia(jlopencv_cv_cv_insertChannel(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(coi, Int32)))
end
insertChannel(src::UMat, dst::UMat, coi::Int32; ) = insertChannel(src, dst, coi)

function flip(src::Image, flipCode::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_flip(julia_to_cpp(src, Image),julia_to_cpp(flipCode, Int32),julia_to_cpp(dst, Image)))
end
flip(src::Image, flipCode::Int32; dst::Image = Mat()) = flip(src, flipCode, dst)

function flip(src::UMat, flipCode::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_flip(julia_to_cpp(src, UMat),julia_to_cpp(flipCode, Int32),julia_to_cpp(dst, UMat)))
end
flip(src::UMat, flipCode::Int32; dst::UMat = UMat()) = flip(src, flipCode, dst)

function rotate(src::Image, rotateCode::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_rotate(julia_to_cpp(src, Image),julia_to_cpp(rotateCode, Int32),julia_to_cpp(dst, Image)))
end
...
function rotate(src::UMat, rotateCode::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_rotate(julia_to_cpp(src, UMat),julia_to_cpp(rotateCode, Int32),julia_to_cpp(dst, UMat)))
end
...
function repeat(src::Image, ny::Int32, nx::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_repeat(julia_to_cpp(src, Image),julia_to_cpp(ny, Int32),julia_to_cpp(nx, Int32),julia_to_cpp(dst, Image)))
end
repeat(src::Image, ny::Int32, nx::Int32; dst::Image = Mat()) = repeat(src, ny, nx, dst)

function repeat(src::UMat, ny::Int32, nx::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_repeat(julia_to_cpp(src, UMat),julia_to_cpp(ny, Int32),julia_to_cpp(nx, Int32),julia_to_cpp(dst, UMat)))
end
repeat(src::UMat, ny::Int32, nx::Int32; dst::UMat = UMat()) = repeat(src, ny, nx, dst)

function hconcat(src::Array{Image, 1}, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_hconcat(julia_to_cpp(src, Array{Image, 1}),julia_to_cpp(dst, Image)))
end
hconcat(src::Array{Image, 1}; dst::Image = Mat()) = hconcat(src, dst)

function hconcat(src::Array{UMat, 1}, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_hconcat(julia_to_cpp(src, Array{UMat, 1}),julia_to_cpp(dst, UMat)))
end
hconcat(src::Array{UMat, 1}; dst::UMat = UMat()) = hconcat(src, dst)

function vconcat(src::Array{Image, 1}, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_vconcat(julia_to_cpp(src, Array{Image, 1}),julia_to_cpp(dst, Image)))
end
vconcat(src::Array{Image, 1}; dst::Image = Mat()) = vconcat(src, dst)

function vconcat(src::Array{UMat, 1}, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_vconcat(julia_to_cpp(src, Array{UMat, 1}),julia_to_cpp(dst, UMat)))
end
vconcat(src::Array{UMat, 1}; dst::UMat = UMat()) = vconcat(src, dst)

function bitwise_and(src1::Image, src2::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_and(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function bitwise_and(src1::UMat, src2::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_and(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function bitwise_or(src1::Image, src2::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_or(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function bitwise_or(src1::UMat, src2::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_or(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function bitwise_xor(src1::Image, src2::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_xor(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function bitwise_xor(src1::UMat, src2::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_xor(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function bitwise_not(src::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_not(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function bitwise_not(src::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_bitwise_not(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function absdiff(src1::Image, src2::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_absdiff(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image)))
end
absdiff(src1::Image, src2::Image; dst::Image = Mat()) = absdiff(src1, src2, dst)

function absdiff(src1::UMat, src2::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_absdiff(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat)))
end
absdiff(src1::UMat, src2::UMat; dst::UMat = UMat()) = absdiff(src1, src2, dst)

function copyTo(src::Image, mask::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_copyTo(julia_to_cpp(src, Image),julia_to_cpp(mask, Image),julia_to_cpp(dst, Image)))
end
copyTo(src::Image, mask::Image; dst::Image = Mat()) = copyTo(src, mask, dst)

function copyTo(src::UMat, mask::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_copyTo(julia_to_cpp(src, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(dst, UMat)))
end
...
function inRange(src::Image, lowerb::Image, upperb::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_inRange(julia_to_cpp(src, Image),julia_to_cpp(lowerb, Image),julia_to_cpp(upperb, Image),julia_to_cpp(dst, Image)))
end
...
function inRange(src::UMat, lowerb::UMat, upperb::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_inRange(julia_to_cpp(src, UMat),julia_to_cpp(lowerb, UMat),julia_to_cpp(upperb, UMat),julia_to_cpp(dst, UMat)))
end
...
function compare(src1::Image, src2::Image, cmpop::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_compare(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(cmpop, Int32),julia_to_cpp(dst, Image)))
end
...
function compare(src1::UMat, src2::UMat, cmpop::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_compare(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(cmpop, Int32),julia_to_cpp(dst, UMat)))
end
...
function min(src1::Image, src2::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_min(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image)))
end
min(src1::Image, src2::Image; dst::Image = Mat()) = min(src1, src2, dst)

function min(src1::UMat, src2::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_min(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat)))
end
min(src1::UMat, src2::UMat; dst::UMat = UMat()) = min(src1, src2, dst)

function max(src1::Image, src2::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_max(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image)))
end
max(src1::Image, src2::Image; dst::Image = Mat()) = max(src1, src2, dst)

function max(src1::UMat, src2::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_max(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat)))
end
max(src1::UMat, src2::UMat; dst::UMat = UMat()) = max(src1, src2, dst)

function sqrt(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_sqrt(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
sqrt(src::Image; dst::Image = Mat()) = sqrt(src, dst)

function sqrt(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_sqrt(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
sqrt(src::UMat; dst::UMat = UMat()) = sqrt(src, dst)

function pow(src::Image, power::Float64, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_pow(julia_to_cpp(src, Image),julia_to_cpp(power, Float64),julia_to_cpp(dst, Image)))
end
pow(src::Image, power::Float64; dst::Image = Mat()) = pow(src, power, dst)

function pow(src::UMat, power::Float64, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_pow(julia_to_cpp(src, UMat),julia_to_cpp(power, Float64),julia_to_cpp(dst, UMat)))
end
pow(src::UMat, power::Float64; dst::UMat = UMat()) = pow(src, power, dst)

function exp(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_exp(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
exp(src::Image; dst::Image = Mat()) = exp(src, dst)

function exp(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_exp(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
exp(src::UMat; dst::UMat = UMat()) = exp(src, dst)

function log(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_log(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
log(src::Image; dst::Image = Mat()) = log(src, dst)

function log(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_log(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
...
function polarToCart(magnitude::Image, angle::Image, x::Image, y::Image, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_polarToCart(julia_to_cpp(magnitude, Image),julia_to_cpp(angle, Image),julia_to_cpp(x, Image),julia_to_cpp(y, Image),julia_to_cpp(angleInDegrees, Bool)))
end
...
function polarToCart(magnitude::UMat, angle::UMat, x::UMat, y::UMat, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_polarToCart(julia_to_cpp(magnitude, UMat),julia_to_cpp(angle, UMat),julia_to_cpp(x, UMat),julia_to_cpp(y, UMat),julia_to_cpp(angleInDegrees, Bool)))
end
...
function cartToPolar(x::Image, y::Image, magnitude::Image, angle::Image, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_cartToPolar(julia_to_cpp(x, Image),julia_to_cpp(y, Image),julia_to_cpp(magnitude, Image),julia_to_cpp(angle, Image),julia_to_cpp(angleInDegrees, Bool)))
end
...
function cartToPolar(x::UMat, y::UMat, magnitude::UMat, angle::UMat, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_cartToPolar(julia_to_cpp(x, UMat),julia_to_cpp(y, UMat),julia_to_cpp(magnitude, UMat),julia_to_cpp(angle, UMat),julia_to_cpp(angleInDegrees, Bool)))
end
...
function phase(x::Image, y::Image, angle::Image, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_phase(julia_to_cpp(x, Image),julia_to_cpp(y, Image),julia_to_cpp(angle, Image),julia_to_cpp(angleInDegrees, Bool)))
end
...
function phase(x::UMat, y::UMat, angle::UMat, angleInDegrees::Bool)
	return cpp_to_julia(jlopencv_cv_cv_phase(julia_to_cpp(x, UMat),julia_to_cpp(y, UMat),julia_to_cpp(angle, UMat),julia_to_cpp(angleInDegrees, Bool)))
end
...
function magnitude(x::Image, y::Image, magnitude::Image)
	return cpp_to_julia(jlopencv_cv_cv_magnitude(julia_to_cpp(x, Image),julia_to_cpp(y, Image),julia_to_cpp(magnitude, Image)))
end
magnitude(x::Image, y::Image; magnitude::Image = Mat()) = magnitude(x, y, magnitude)

function magnitude(x::UMat, y::UMat, magnitude::UMat)
	return cpp_to_julia(jlopencv_cv_cv_magnitude(julia_to_cpp(x, UMat),julia_to_cpp(y, UMat),julia_to_cpp(magnitude, UMat)))
end
...
function checkRange(a::Image, quiet::Bool, minVal::Float64, maxVal::Float64)
	return cpp_to_julia(jlopencv_cv_cv_checkRange(julia_to_cpp(a, Image),julia_to_cpp(quiet, Bool),julia_to_cpp(minVal, Float64),julia_to_cpp(maxVal, Float64)))
end
...
function checkRange(a::UMat, quiet::Bool, minVal::Float64, maxVal::Float64)
	return cpp_to_julia(jlopencv_cv_cv_checkRange(julia_to_cpp(a, UMat),julia_to_cpp(quiet, Bool),julia_to_cpp(minVal, Float64),julia_to_cpp(maxVal, Float64)))
end
...
function patchNaNs(a::Image, val::Float64)
	return cpp_to_julia(jlopencv_cv_cv_patchNaNs(julia_to_cpp(a, Image),julia_to_cpp(val, Float64)))
end
patchNaNs(a::Image; val::Float64 = 0) = patchNaNs(a, val)

function patchNaNs(a::UMat, val::Float64)
	return cpp_to_julia(jlopencv_cv_cv_patchNaNs(julia_to_cpp(a, UMat),julia_to_cpp(val, Float64)))
end
...
function gemm(src1::Image, src2::Image, alpha::Float64, src3::Image, beta::Float64, dst::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_gemm(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(src3, Image),julia_to_cpp(beta, Float64),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32)))
end
...
function gemm(src1::UMat, src2::UMat, alpha::Float64, src3::UMat, beta::Float64, dst::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_gemm(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(src3, UMat),julia_to_cpp(beta, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32)))
end
...
function mulTransposed(src::Image, aTa::Bool, dst::Image, delta::Image, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_mulTransposed(julia_to_cpp(src, Image),julia_to_cpp(aTa, Bool),julia_to_cpp(dst, Image),julia_to_cpp(delta, Image),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function mulTransposed(src::UMat, aTa::Bool, dst::UMat, delta::UMat, scale::Float64, dtype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_mulTransposed(julia_to_cpp(src, UMat),julia_to_cpp(aTa, Bool),julia_to_cpp(dst, UMat),julia_to_cpp(delta, UMat),julia_to_cpp(scale, Float64),julia_to_cpp(dtype, Int32)))
end
...
function transpose(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_transpose(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
transpose(src::Image; dst::Image = Mat()) = transpose(src, dst)

function transpose(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_transpose(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
transpose(src::UMat; dst::UMat = UMat()) = transpose(src, dst)

function transform(src::Image, m::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_transform(julia_to_cpp(src, Image),julia_to_cpp(m, Image),julia_to_cpp(dst, Image)))
end
transform(src::Image, m::Image; dst::Image = Mat()) = transform(src, m, dst)

function transform(src::UMat, m::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_transform(julia_to_cpp(src, UMat),julia_to_cpp(m, UMat),julia_to_cpp(dst, UMat)))
end
transform(src::UMat, m::UMat; dst::UMat = UMat()) = transform(src, m, dst)

function perspectiveTransform(src::Image, m::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_perspectiveTransform(julia_to_cpp(src, Image),julia_to_cpp(m, Image),julia_to_cpp(dst, Image)))
end
...
function perspectiveTransform(src::UMat, m::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_perspectiveTransform(julia_to_cpp(src, UMat),julia_to_cpp(m, UMat),julia_to_cpp(dst, UMat)))
end
...
function completeSymm(m::Image, lowerToUpper::Bool)
	return cpp_to_julia(jlopencv_cv_cv_completeSymm(julia_to_cpp(m, Image),julia_to_cpp(lowerToUpper, Bool)))
end
completeSymm(m::Image; lowerToUpper::Bool = false) = completeSymm(m, lowerToUpper)

function completeSymm(m::UMat, lowerToUpper::Bool)
	return cpp_to_julia(jlopencv_cv_cv_completeSymm(julia_to_cpp(m, UMat),julia_to_cpp(lowerToUpper, Bool)))
end
completeSymm(m::UMat; lowerToUpper::Bool = false) = completeSymm(m, lowerToUpper)

function setIdentity(mtx::Image, s::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_setIdentity(julia_to_cpp(mtx, Image),julia_to_cpp(s, Scalar)))
end
setIdentity(mtx::Image; s::Scalar = Scalar(1)) = setIdentity(mtx, s)

function setIdentity(mtx::UMat, s::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_setIdentity(julia_to_cpp(mtx, UMat),julia_to_cpp(s, Scalar)))
end
setIdentity(mtx::UMat; s::Scalar = Scalar(1)) = setIdentity(mtx, s)

function determinant(mtx::Image)
	return cpp_to_julia(jlopencv_cv_cv_determinant(julia_to_cpp(mtx, Image)))
end
determinant(mtx::Image; ) = determinant(mtx)

function determinant(mtx::UMat)
	return cpp_to_julia(jlopencv_cv_cv_determinant(julia_to_cpp(mtx, UMat)))
end
determinant(mtx::UMat; ) = determinant(mtx)

function trace(mtx::Image)
	return cpp_to_julia(jlopencv_cv_cv_trace(julia_to_cpp(mtx, Image)))
end
trace(mtx::Image; ) = trace(mtx)

function trace(mtx::UMat)
	return cpp_to_julia(jlopencv_cv_cv_trace(julia_to_cpp(mtx, UMat)))
end
trace(mtx::UMat; ) = trace(mtx)

function invert(src::Image, dst::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_invert(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32)))
end
invert(src::Image; dst::Image = Mat(), flags::Int32 = DECOMP_LU) = invert(src, dst, flags)

function invert(src::UMat, dst::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_invert(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32)))
end
...
function solve(src1::Image, src2::Image, dst::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solve(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32)))
end
...
function solve(src1::UMat, src2::UMat, dst::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solve(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32)))
end
...
function sort(src::Image, flags::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_sort(julia_to_cpp(src, Image),julia_to_cpp(flags, Int32),julia_to_cpp(dst, Image)))
end
sort(src::Image, flags::Int32; dst::Image = Mat()) = sort(src, flags, dst)

function sort(src::UMat, flags::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_sort(julia_to_cpp(src, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(dst, UMat)))
end
sort(src::UMat, flags::Int32; dst::UMat = UMat()) = sort(src, flags, dst)

function sortIdx(src::Image, flags::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_sortIdx(julia_to_cpp(src, Image),julia_to_cpp(flags, Int32),julia_to_cpp(dst, Image)))
end
sortIdx(src::Image, flags::Int32; dst::Image = Mat()) = sortIdx(src, flags, dst)

function sortIdx(src::UMat, flags::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_sortIdx(julia_to_cpp(src, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(dst, UMat)))
end
sortIdx(src::UMat, flags::Int32; dst::UMat = UMat()) = sortIdx(src, flags, dst)

function solveCubic(coeffs::Image, roots::Image)
	return cpp_to_julia(jlopencv_cv_cv_solveCubic(julia_to_cpp(coeffs, Image),julia_to_cpp(roots, Image)))
end
solveCubic(coeffs::Image; roots::Image = Mat()) = solveCubic(coeffs, roots)

function solveCubic(coeffs::UMat, roots::UMat)
	return cpp_to_julia(jlopencv_cv_cv_solveCubic(julia_to_cpp(coeffs, UMat),julia_to_cpp(roots, UMat)))
end
solveCubic(coeffs::UMat; roots::UMat = UMat()) = solveCubic(coeffs, roots)

function solvePoly(coeffs::Image, roots::Image, maxIters::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePoly(julia_to_cpp(coeffs, Image),julia_to_cpp(roots, Image),julia_to_cpp(maxIters, Int32)))
end
...
function solvePoly(coeffs::UMat, roots::UMat, maxIters::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePoly(julia_to_cpp(coeffs, UMat),julia_to_cpp(roots, UMat),julia_to_cpp(maxIters, Int32)))
end
...
function eigen(src::Image, eigenvalues::Image, eigenvectors::Image)
	return cpp_to_julia(jlopencv_cv_cv_eigen(julia_to_cpp(src, Image),julia_to_cpp(eigenvalues, Image),julia_to_cpp(eigenvectors, Image)))
end
...
function eigen(src::UMat, eigenvalues::UMat, eigenvectors::UMat)
	return cpp_to_julia(jlopencv_cv_cv_eigen(julia_to_cpp(src, UMat),julia_to_cpp(eigenvalues, UMat),julia_to_cpp(eigenvectors, UMat)))
end
...
function eigenNonSymmetric(src::Image, eigenvalues::Image, eigenvectors::Image)
	return cpp_to_julia(jlopencv_cv_cv_eigenNonSymmetric(julia_to_cpp(src, Image),julia_to_cpp(eigenvalues, Image),julia_to_cpp(eigenvectors, Image)))
end
...
function eigenNonSymmetric(src::UMat, eigenvalues::UMat, eigenvectors::UMat)
	return cpp_to_julia(jlopencv_cv_cv_eigenNonSymmetric(julia_to_cpp(src, UMat),julia_to_cpp(eigenvalues, UMat),julia_to_cpp(eigenvectors, UMat)))
end
...
function calcCovarMatrix(samples::Image, mean::Image, flags::Int32, covar::Image, ctype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_calcCovarMatrix(julia_to_cpp(samples, Image),julia_to_cpp(mean, Image),julia_to_cpp(flags, Int32),julia_to_cpp(covar, Image),julia_to_cpp(ctype, Int32)))
end
...
function calcCovarMatrix(samples::UMat, mean::UMat, flags::Int32, covar::UMat, ctype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_calcCovarMatrix(julia_to_cpp(samples, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(covar, UMat),julia_to_cpp(ctype, Int32)))
end
...
function PCACompute(data::Image, mean::Image, eigenvectors::Image, maxComponents::Int32)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(eigenvectors, Image),julia_to_cpp(maxComponents, Int32)))
end
...
function PCACompute(data::UMat, mean::UMat, eigenvectors::UMat, maxComponents::Int32)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(eigenvectors, UMat),julia_to_cpp(maxComponents, Int32)))
end
...
function PCACompute2(data::Image, mean::Image, eigenvectors::Image, eigenvalues::Image, maxComponents::Int32)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(eigenvectors, Image),julia_to_cpp(eigenvalues, Image),julia_to_cpp(maxComponents, Int32)))
end
...
function PCACompute2(data::UMat, mean::UMat, eigenvectors::UMat, eigenvalues::UMat, maxComponents::Int32)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(eigenvectors, UMat),julia_to_cpp(eigenvalues, UMat),julia_to_cpp(maxComponents, Int32)))
end
...
function PCACompute(data::Image, mean::Image, retainedVariance::Float64, eigenvectors::Image)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(retainedVariance, Float64),julia_to_cpp(eigenvectors, Image)))
end
...
function PCACompute(data::UMat, mean::UMat, retainedVariance::Float64, eigenvectors::UMat)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(retainedVariance, Float64),julia_to_cpp(eigenvectors, UMat)))
end
...
function PCACompute2(data::Image, mean::Image, retainedVariance::Float64, eigenvectors::Image, eigenvalues::Image)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(retainedVariance, Float64),julia_to_cpp(eigenvectors, Image),julia_to_cpp(eigenvalues, Image)))
end
...
function PCACompute2(data::UMat, mean::UMat, retainedVariance::Float64, eigenvectors::UMat, eigenvalues::UMat)
	return cpp_to_julia(jlopencv_cv_cv_PCACompute(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(retainedVariance, Float64),julia_to_cpp(eigenvectors, UMat),julia_to_cpp(eigenvalues, UMat)))
end
...
function PCAProject(data::Image, mean::Image, eigenvectors::Image, result::Image)
	return cpp_to_julia(jlopencv_cv_cv_PCAProject(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(eigenvectors, Image),julia_to_cpp(result, Image)))
end
...
function PCAProject(data::UMat, mean::UMat, eigenvectors::UMat, result::UMat)
	return cpp_to_julia(jlopencv_cv_cv_PCAProject(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(eigenvectors, UMat),julia_to_cpp(result, UMat)))
end
...
function PCABackProject(data::Image, mean::Image, eigenvectors::Image, result::Image)
	return cpp_to_julia(jlopencv_cv_cv_PCABackProject(julia_to_cpp(data, Image),julia_to_cpp(mean, Image),julia_to_cpp(eigenvectors, Image),julia_to_cpp(result, Image)))
end
...
function PCABackProject(data::UMat, mean::UMat, eigenvectors::UMat, result::UMat)
	return cpp_to_julia(jlopencv_cv_cv_PCABackProject(julia_to_cpp(data, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(eigenvectors, UMat),julia_to_cpp(result, UMat)))
end
...
function SVDecomp(src::Image, w::Image, u::Image, vt::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_SVDecomp(julia_to_cpp(src, Image),julia_to_cpp(w, Image),julia_to_cpp(u, Image),julia_to_cpp(vt, Image),julia_to_cpp(flags, Int32)))
end
...
function SVDecomp(src::UMat, w::UMat, u::UMat, vt::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_SVDecomp(julia_to_cpp(src, UMat),julia_to_cpp(w, UMat),julia_to_cpp(u, UMat),julia_to_cpp(vt, UMat),julia_to_cpp(flags, Int32)))
end
...
function SVBackSubst(w::Image, u::Image, vt::Image, rhs::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_SVBackSubst(julia_to_cpp(w, Image),julia_to_cpp(u, Image),julia_to_cpp(vt, Image),julia_to_cpp(rhs, Image),julia_to_cpp(dst, Image)))
end
...
function SVBackSubst(w::UMat, u::UMat, vt::UMat, rhs::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_SVBackSubst(julia_to_cpp(w, UMat),julia_to_cpp(u, UMat),julia_to_cpp(vt, UMat),julia_to_cpp(rhs, UMat),julia_to_cpp(dst, UMat)))
end
...
function Mahalanobis(v1::Image, v2::Image, icovar::Image)
	return cpp_to_julia(jlopencv_cv_cv_Mahalanobis(julia_to_cpp(v1, Image),julia_to_cpp(v2, Image),julia_to_cpp(icovar, Image)))
end
Mahalanobis(v1::Image, v2::Image, icovar::Image; ) = Mahalanobis(v1, v2, icovar)

function Mahalanobis(v1::UMat, v2::UMat, icovar::UMat)
	return cpp_to_julia(jlopencv_cv_cv_Mahalanobis(julia_to_cpp(v1, UMat),julia_to_cpp(v2, UMat),julia_to_cpp(icovar, UMat)))
end
...
function dft(src::Image, dst::Image, flags::Int32, nonzeroRows::Int32)
	return cpp_to_julia(jlopencv_cv_cv_dft(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32),julia_to_cpp(nonzeroRows, Int32)))
end
...
function dft(src::UMat, dst::UMat, flags::Int32, nonzeroRows::Int32)
	return cpp_to_julia(jlopencv_cv_cv_dft(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(nonzeroRows, Int32)))
end
...
function idft(src::Image, dst::Image, flags::Int32, nonzeroRows::Int32)
	return cpp_to_julia(jlopencv_cv_cv_idft(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32),julia_to_cpp(nonzeroRows, Int32)))
end
...
function idft(src::UMat, dst::UMat, flags::Int32, nonzeroRows::Int32)
	return cpp_to_julia(jlopencv_cv_cv_idft(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(nonzeroRows, Int32)))
end
...
function dct(src::Image, dst::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_dct(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32)))
end
dct(src::Image; dst::Image = Mat(), flags::Int32 = 0) = dct(src, dst, flags)

function dct(src::UMat, dst::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_dct(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32)))
end
dct(src::UMat; dst::UMat = UMat(), flags::Int32 = 0) = dct(src, dst, flags)

function idct(src::Image, dst::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_idct(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32)))
end
idct(src::Image; dst::Image = Mat(), flags::Int32 = 0) = idct(src, dst, flags)

function idct(src::UMat, dst::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_idct(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32)))
end
...
function mulSpectrums(a::Image, b::Image, flags::Int32, c::Image, conjB::Bool)
	return cpp_to_julia(jlopencv_cv_cv_mulSpectrums(julia_to_cpp(a, Image),julia_to_cpp(b, Image),julia_to_cpp(flags, Int32),julia_to_cpp(c, Image),julia_to_cpp(conjB, Bool)))
end
...
function mulSpectrums(a::UMat, b::UMat, flags::Int32, c::UMat, conjB::Bool)
	return cpp_to_julia(jlopencv_cv_cv_mulSpectrums(julia_to_cpp(a, UMat),julia_to_cpp(b, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(c, UMat),julia_to_cpp(conjB, Bool)))
end
...
function getOptimalDFTSize(vecsize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getOptimalDFTSize(julia_to_cpp(vecsize, Int32)))
end
getOptimalDFTSize(vecsize::Int32; ) = getOptimalDFTSize(vecsize)

function setRNGSeed(seed::Int32)
	return cpp_to_julia(jlopencv_cv_cv_setRNGSeed(julia_to_cpp(seed, Int32)))
end
setRNGSeed(seed::Int32; ) = setRNGSeed(seed)

function randu(dst::Image, low::Image, high::Image)
	return cpp_to_julia(jlopencv_cv_cv_randu(julia_to_cpp(dst, Image),julia_to_cpp(low, Image),julia_to_cpp(high, Image)))
end
randu(dst::Image, low::Image, high::Image; ) = randu(dst, low, high)

function randu(dst::UMat, low::UMat, high::UMat)
	return cpp_to_julia(jlopencv_cv_cv_randu(julia_to_cpp(dst, UMat),julia_to_cpp(low, UMat),julia_to_cpp(high, UMat)))
end
randu(dst::UMat, low::UMat, high::UMat; ) = randu(dst, low, high)

function randn(dst::Image, mean::Image, stddev::Image)
	return cpp_to_julia(jlopencv_cv_cv_randn(julia_to_cpp(dst, Image),julia_to_cpp(mean, Image),julia_to_cpp(stddev, Image)))
end
randn(dst::Image, mean::Image, stddev::Image; ) = randn(dst, mean, stddev)

function randn(dst::UMat, mean::UMat, stddev::UMat)
	return cpp_to_julia(jlopencv_cv_cv_randn(julia_to_cpp(dst, UMat),julia_to_cpp(mean, UMat),julia_to_cpp(stddev, UMat)))
end
randn(dst::UMat, mean::UMat, stddev::UMat; ) = randn(dst, mean, stddev)

function randShuffle(dst::Image, iterFactor::Float64)
	return cpp_to_julia(jlopencv_cv_cv_randShuffle(julia_to_cpp(dst, Image),julia_to_cpp(iterFactor, Float64)))
end
randShuffle(dst::Image; iterFactor::Float64 = 1.) = randShuffle(dst, iterFactor)

function randShuffle(dst::UMat, iterFactor::Float64)
	return cpp_to_julia(jlopencv_cv_cv_randShuffle(julia_to_cpp(dst, UMat),julia_to_cpp(iterFactor, Float64)))
end
...
function kmeans(data::Image, K::Int32, bestLabels::Image, criteria::TermCriteria, attempts::Int32, flags::Int32, centers::Image)
	return cpp_to_julia(jlopencv_cv_cv_kmeans(julia_to_cpp(data, Image),julia_to_cpp(K, Int32),julia_to_cpp(bestLabels, Image),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(attempts, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(centers, Image)))
end
...
function kmeans(data::UMat, K::Int32, bestLabels::UMat, criteria::TermCriteria, attempts::Int32, flags::Int32, centers::UMat)
	return cpp_to_julia(jlopencv_cv_cv_kmeans(julia_to_cpp(data, UMat),julia_to_cpp(K, Int32),julia_to_cpp(bestLabels, UMat),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(attempts, Int32),julia_to_cpp(flags, Int32),julia_to_cpp(centers, UMat)))
end
...
function KeyPoint_convert(keypoints::Array{KeyPoint, 1}, keypointIndexes::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_KeyPoint_convert(julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(keypointIndexes, Array{Int32, 1})))
end
...
function KeyPoint_convert(points2f::Array{Point{Float32}, 1}, size::Float32, response::Float32, octave::Int32, class_id::Int32)
	return cpp_to_julia(jlopencv_cv_cv_KeyPoint_convert(julia_to_cpp(points2f, Array{Point{Float32}, 1}),julia_to_cpp(size, Float32),julia_to_cpp(response, Float32),julia_to_cpp(octave, Int32),julia_to_cpp(class_id, Int32)))
end
...
function KeyPoint_overlap(kp1::KeyPoint, kp2::KeyPoint)
	return cpp_to_julia(jlopencv_cv_cv_KeyPoint_overlap(julia_to_cpp(kp1, KeyPoint),julia_to_cpp(kp2, KeyPoint)))
end
...
function createLineSegmentDetector(_refine::Int32, _scale::Float64, _sigma_scale::Float64, _quant::Float64, _ang_th::Float64, _log_eps::Float64, _density_th::Float64, _n_bins::Int32)
	return cpp_to_julia(jlopencv_cv_cv_createLineSegmentDetector(julia_to_cpp(_refine, Int32),julia_to_cpp(_scale, Float64),julia_to_cpp(_sigma_scale, Float64),julia_to_cpp(_quant, Float64),julia_to_cpp(_ang_th, Float64),julia_to_cpp(_log_eps, Float64),julia_to_cpp(_density_th, Float64),julia_to_cpp(_n_bins, Int32)))
end
...
function getGaussianKernel(ksize::Int32, sigma::Float64, ktype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getGaussianKernel(julia_to_cpp(ksize, Int32),julia_to_cpp(sigma, Float64),julia_to_cpp(ktype, Int32)))
end
...
function getDerivKernels(dx::Int32, dy::Int32, ksize::Int32, kx::Image, ky::Image, normalize::Bool, ktype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getDerivKernels(julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(kx, Image),julia_to_cpp(ky, Image),julia_to_cpp(normalize, Bool),julia_to_cpp(ktype, Int32)))
end
...
function getDerivKernels(dx::Int32, dy::Int32, ksize::Int32, kx::UMat, ky::UMat, normalize::Bool, ktype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getDerivKernels(julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(kx, UMat),julia_to_cpp(ky, UMat),julia_to_cpp(normalize, Bool),julia_to_cpp(ktype, Int32)))
end
...
function getGaborKernel(ksize::Size, sigma::Float64, theta::Float64, lambd::Float64, gamma::Float64, psi::Float64, ktype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getGaborKernel(julia_to_cpp(ksize, Size),julia_to_cpp(sigma, Float64),julia_to_cpp(theta, Float64),julia_to_cpp(lambd, Float64),julia_to_cpp(gamma, Float64),julia_to_cpp(psi, Float64),julia_to_cpp(ktype, Int32)))
end
...
function getStructuringElement(shape::Int32, ksize::Size, anchor::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_getStructuringElement(julia_to_cpp(shape, Int32),julia_to_cpp(ksize, Size),julia_to_cpp(anchor, Point{Int32})))
end
...
function medianBlur(src::Image, ksize::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_medianBlur(julia_to_cpp(src, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, Image)))
end
medianBlur(src::Image, ksize::Int32; dst::Image = Mat()) = medianBlur(src, ksize, dst)

function medianBlur(src::UMat, ksize::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_medianBlur(julia_to_cpp(src, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, UMat)))
end
...
function GaussianBlur(src::Image, ksize::Size, sigmaX::Float64, dst::Image, sigmaY::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GaussianBlur(julia_to_cpp(src, Image),julia_to_cpp(ksize, Size),julia_to_cpp(sigmaX, Float64),julia_to_cpp(dst, Image),julia_to_cpp(sigmaY, Float64),julia_to_cpp(borderType, Int32)))
end
...
function GaussianBlur(src::UMat, ksize::Size, sigmaX::Float64, dst::UMat, sigmaY::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_GaussianBlur(julia_to_cpp(src, UMat),julia_to_cpp(ksize, Size),julia_to_cpp(sigmaX, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(sigmaY, Float64),julia_to_cpp(borderType, Int32)))
end
...
function bilateralFilter(src::Image, d::Int32, sigmaColor::Float64, sigmaSpace::Float64, dst::Image, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_bilateralFilter(julia_to_cpp(src, Image),julia_to_cpp(d, Int32),julia_to_cpp(sigmaColor, Float64),julia_to_cpp(sigmaSpace, Float64),julia_to_cpp(dst, Image),julia_to_cpp(borderType, Int32)))
end
...
function bilateralFilter(src::UMat, d::Int32, sigmaColor::Float64, sigmaSpace::Float64, dst::UMat, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_bilateralFilter(julia_to_cpp(src, UMat),julia_to_cpp(d, Int32),julia_to_cpp(sigmaColor, Float64),julia_to_cpp(sigmaSpace, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(borderType, Int32)))
end
...
function boxFilter(src::Image, ddepth::Int32, ksize::Size, dst::Image, anchor::Point{Int32}, normalize::Bool, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_boxFilter(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(ksize, Size),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(normalize, Bool),julia_to_cpp(borderType, Int32)))
end
...
function boxFilter(src::UMat, ddepth::Int32, ksize::Size, dst::UMat, anchor::Point{Int32}, normalize::Bool, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_boxFilter(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(ksize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(normalize, Bool),julia_to_cpp(borderType, Int32)))
end
...
function sqrBoxFilter(src::Image, ddepth::Int32, ksize::Size, dst::Image, anchor::Point{Int32}, normalize::Bool, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_sqrBoxFilter(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(ksize, Size),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(normalize, Bool),julia_to_cpp(borderType, Int32)))
end
...
function sqrBoxFilter(src::UMat, ddepth::Int32, ksize::Size, dst::UMat, anchor::Point{Int32}, normalize::Bool, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_sqrBoxFilter(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(ksize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(normalize, Bool),julia_to_cpp(borderType, Int32)))
end
...
function blur(src::Image, ksize::Size, dst::Image, anchor::Point{Int32}, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_blur(julia_to_cpp(src, Image),julia_to_cpp(ksize, Size),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(borderType, Int32)))
end
...
function blur(src::UMat, ksize::Size, dst::UMat, anchor::Point{Int32}, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_blur(julia_to_cpp(src, UMat),julia_to_cpp(ksize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(borderType, Int32)))
end
...
function filter2D(src::Image, ddepth::Int32, kernel::Image, dst::Image, anchor::Point{Int32}, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_filter2D(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(kernel, Image),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function filter2D(src::UMat, ddepth::Int32, kernel::UMat, dst::UMat, anchor::Point{Int32}, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_filter2D(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(kernel, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function sepFilter2D(src::Image, ddepth::Int32, kernelX::Image, kernelY::Image, dst::Image, anchor::Point{Int32}, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_sepFilter2D(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(kernelX, Image),julia_to_cpp(kernelY, Image),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function sepFilter2D(src::UMat, ddepth::Int32, kernelX::UMat, kernelY::UMat, dst::UMat, anchor::Point{Int32}, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_sepFilter2D(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(kernelX, UMat),julia_to_cpp(kernelY, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Sobel(src::Image, ddepth::Int32, dx::Int32, dy::Int32, dst::Image, ksize::Int32, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Sobel(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(dst, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Sobel(src::UMat, ddepth::Int32, dx::Int32, dy::Int32, dst::UMat, ksize::Int32, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Sobel(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function spatialGradient(src::Image, dx::Image, dy::Image, ksize::Int32, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_spatialGradient(julia_to_cpp(src, Image),julia_to_cpp(dx, Image),julia_to_cpp(dy, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(borderType, Int32)))
end
...
function spatialGradient(src::UMat, dx::UMat, dy::UMat, ksize::Int32, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_spatialGradient(julia_to_cpp(src, UMat),julia_to_cpp(dx, UMat),julia_to_cpp(dy, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(borderType, Int32)))
end
...
function Scharr(src::Image, ddepth::Int32, dx::Int32, dy::Int32, dst::Image, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Scharr(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(dst, Image),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Scharr(src::UMat, ddepth::Int32, dx::Int32, dy::Int32, dst::UMat, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Scharr(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(dx, Int32),julia_to_cpp(dy, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Laplacian(src::Image, ddepth::Int32, dst::Image, ksize::Int32, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Laplacian(julia_to_cpp(src, Image),julia_to_cpp(ddepth, Int32),julia_to_cpp(dst, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Laplacian(src::UMat, ddepth::Int32, dst::UMat, ksize::Int32, scale::Float64, delta::Float64, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_Laplacian(julia_to_cpp(src, UMat),julia_to_cpp(ddepth, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(scale, Float64),julia_to_cpp(delta, Float64),julia_to_cpp(borderType, Int32)))
end
...
function Canny(image::Image, threshold1::Float64, threshold2::Float64, edges::Image, apertureSize::Int32, L2gradient::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Canny(julia_to_cpp(image, Image),julia_to_cpp(threshold1, Float64),julia_to_cpp(threshold2, Float64),julia_to_cpp(edges, Image),julia_to_cpp(apertureSize, Int32),julia_to_cpp(L2gradient, Bool)))
end
...
function Canny(image::UMat, threshold1::Float64, threshold2::Float64, edges::UMat, apertureSize::Int32, L2gradient::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Canny(julia_to_cpp(image, UMat),julia_to_cpp(threshold1, Float64),julia_to_cpp(threshold2, Float64),julia_to_cpp(edges, UMat),julia_to_cpp(apertureSize, Int32),julia_to_cpp(L2gradient, Bool)))
end
...
function Canny(dx::Image, dy::Image, threshold1::Float64, threshold2::Float64, edges::Image, L2gradient::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Canny(julia_to_cpp(dx, Image),julia_to_cpp(dy, Image),julia_to_cpp(threshold1, Float64),julia_to_cpp(threshold2, Float64),julia_to_cpp(edges, Image),julia_to_cpp(L2gradient, Bool)))
end
...
function Canny(dx::UMat, dy::UMat, threshold1::Float64, threshold2::Float64, edges::UMat, L2gradient::Bool)
	return cpp_to_julia(jlopencv_cv_cv_Canny(julia_to_cpp(dx, UMat),julia_to_cpp(dy, UMat),julia_to_cpp(threshold1, Float64),julia_to_cpp(threshold2, Float64),julia_to_cpp(edges, UMat),julia_to_cpp(L2gradient, Bool)))
end
...
function cornerMinEigenVal(src::Image, blockSize::Int32, dst::Image, ksize::Int32, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerMinEigenVal(julia_to_cpp(src, Image),julia_to_cpp(blockSize, Int32),julia_to_cpp(dst, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(borderType, Int32)))
end
...
function cornerMinEigenVal(src::UMat, blockSize::Int32, dst::UMat, ksize::Int32, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerMinEigenVal(julia_to_cpp(src, UMat),julia_to_cpp(blockSize, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(borderType, Int32)))
end
...
function cornerHarris(src::Image, blockSize::Int32, ksize::Int32, k::Float64, dst::Image, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerHarris(julia_to_cpp(src, Image),julia_to_cpp(blockSize, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(k, Float64),julia_to_cpp(dst, Image),julia_to_cpp(borderType, Int32)))
end
...
function cornerHarris(src::UMat, blockSize::Int32, ksize::Int32, k::Float64, dst::UMat, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerHarris(julia_to_cpp(src, UMat),julia_to_cpp(blockSize, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(k, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(borderType, Int32)))
end
...
function cornerEigenValsAndVecs(src::Image, blockSize::Int32, ksize::Int32, dst::Image, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerEigenValsAndVecs(julia_to_cpp(src, Image),julia_to_cpp(blockSize, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, Image),julia_to_cpp(borderType, Int32)))
end
...
function cornerEigenValsAndVecs(src::UMat, blockSize::Int32, ksize::Int32, dst::UMat, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cornerEigenValsAndVecs(julia_to_cpp(src, UMat),julia_to_cpp(blockSize, Int32),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(borderType, Int32)))
end
...
function preCornerDetect(src::Image, ksize::Int32, dst::Image, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_preCornerDetect(julia_to_cpp(src, Image),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, Image),julia_to_cpp(borderType, Int32)))
end
...
function preCornerDetect(src::UMat, ksize::Int32, dst::UMat, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_preCornerDetect(julia_to_cpp(src, UMat),julia_to_cpp(ksize, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(borderType, Int32)))
end
...
function cornerSubPix(image::Image, corners::Image, winSize::Size, zeroZone::Size, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_cornerSubPix(julia_to_cpp(image, Image),julia_to_cpp(corners, Image),julia_to_cpp(winSize, Size),julia_to_cpp(zeroZone, Size),julia_to_cpp(criteria, TermCriteria)))
end
...
function cornerSubPix(image::UMat, corners::UMat, winSize::Size, zeroZone::Size, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_cornerSubPix(julia_to_cpp(image, UMat),julia_to_cpp(corners, UMat),julia_to_cpp(winSize, Size),julia_to_cpp(zeroZone, Size),julia_to_cpp(criteria, TermCriteria)))
end
...
function goodFeaturesToTrack(image::Image, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, corners::Image, mask::Image, blockSize::Int32, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_goodFeaturesToTrack(julia_to_cpp(image, Image),julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(corners, Image),julia_to_cpp(mask, Image),julia_to_cpp(blockSize, Int32),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function goodFeaturesToTrack(image::UMat, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, corners::UMat, mask::UMat, blockSize::Int32, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_goodFeaturesToTrack(julia_to_cpp(image, UMat),julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(corners, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(blockSize, Int32),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function goodFeaturesToTrack(image::Image, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, mask::Image, blockSize::Int32, gradientSize::Int32, corners::Image, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_goodFeaturesToTrack(julia_to_cpp(image, Image),julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(mask, Image),julia_to_cpp(blockSize, Int32),julia_to_cpp(gradientSize, Int32),julia_to_cpp(corners, Image),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function goodFeaturesToTrack(image::UMat, maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, mask::UMat, blockSize::Int32, gradientSize::Int32, corners::UMat, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_goodFeaturesToTrack(julia_to_cpp(image, UMat),julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(mask, UMat),julia_to_cpp(blockSize, Int32),julia_to_cpp(gradientSize, Int32),julia_to_cpp(corners, UMat),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function HoughLines(image::Image, rho::Float64, theta::Float64, threshold::Int32, lines::Image, srn::Float64, stn::Float64, min_theta::Float64, max_theta::Float64)
	return cpp_to_julia(jlopencv_cv_cv_HoughLines(julia_to_cpp(image, Image),julia_to_cpp(rho, Float64),julia_to_cpp(theta, Float64),julia_to_cpp(threshold, Int32),julia_to_cpp(lines, Image),julia_to_cpp(srn, Float64),julia_to_cpp(stn, Float64),julia_to_cpp(min_theta, Float64),julia_to_cpp(max_theta, Float64)))
end
...
function HoughLines(image::UMat, rho::Float64, theta::Float64, threshold::Int32, lines::UMat, srn::Float64, stn::Float64, min_theta::Float64, max_theta::Float64)
	return cpp_to_julia(jlopencv_cv_cv_HoughLines(julia_to_cpp(image, UMat),julia_to_cpp(rho, Float64),julia_to_cpp(theta, Float64),julia_to_cpp(threshold, Int32),julia_to_cpp(lines, UMat),julia_to_cpp(srn, Float64),julia_to_cpp(stn, Float64),julia_to_cpp(min_theta, Float64),julia_to_cpp(max_theta, Float64)))
end
...
function HoughLinesP(image::Image, rho::Float64, theta::Float64, threshold::Int32, lines::Image, minLineLength::Float64, maxLineGap::Float64)
	return cpp_to_julia(jlopencv_cv_cv_HoughLinesP(julia_to_cpp(image, Image),julia_to_cpp(rho, Float64),julia_to_cpp(theta, Float64),julia_to_cpp(threshold, Int32),julia_to_cpp(lines, Image),julia_to_cpp(minLineLength, Float64),julia_to_cpp(maxLineGap, Float64)))
end
...
function HoughLinesP(image::UMat, rho::Float64, theta::Float64, threshold::Int32, lines::UMat, minLineLength::Float64, maxLineGap::Float64)
	return cpp_to_julia(jlopencv_cv_cv_HoughLinesP(julia_to_cpp(image, UMat),julia_to_cpp(rho, Float64),julia_to_cpp(theta, Float64),julia_to_cpp(threshold, Int32),julia_to_cpp(lines, UMat),julia_to_cpp(minLineLength, Float64),julia_to_cpp(maxLineGap, Float64)))
end
...
function HoughLinesPointSet(_point::Image, lines_max::Int32, threshold::Int32, min_rho::Float64, max_rho::Float64, rho_step::Float64, min_theta::Float64, max_theta::Float64, theta_step::Float64, _lines::Image)
	return cpp_to_julia(jlopencv_cv_cv_HoughLinesPointSet(julia_to_cpp(_point, Image),julia_to_cpp(lines_max, Int32),julia_to_cpp(threshold, Int32),julia_to_cpp(min_rho, Float64),julia_to_cpp(max_rho, Float64),julia_to_cpp(rho_step, Float64),julia_to_cpp(min_theta, Float64),julia_to_cpp(max_theta, Float64),julia_to_cpp(theta_step, Float64),julia_to_cpp(_lines, Image)))
end
...
function HoughLinesPointSet(_point::UMat, lines_max::Int32, threshold::Int32, min_rho::Float64, max_rho::Float64, rho_step::Float64, min_theta::Float64, max_theta::Float64, theta_step::Float64, _lines::UMat)
	return cpp_to_julia(jlopencv_cv_cv_HoughLinesPointSet(julia_to_cpp(_point, UMat),julia_to_cpp(lines_max, Int32),julia_to_cpp(threshold, Int32),julia_to_cpp(min_rho, Float64),julia_to_cpp(max_rho, Float64),julia_to_cpp(rho_step, Float64),julia_to_cpp(min_theta, Float64),julia_to_cpp(max_theta, Float64),julia_to_cpp(theta_step, Float64),julia_to_cpp(_lines, UMat)))
end
...
function HoughCircles(image::Image, method::Int32, dp::Float64, minDist::Float64, circles::Image, param1::Float64, param2::Float64, minRadius::Int32, maxRadius::Int32)
	return cpp_to_julia(jlopencv_cv_cv_HoughCircles(julia_to_cpp(image, Image),julia_to_cpp(method, Int32),julia_to_cpp(dp, Float64),julia_to_cpp(minDist, Float64),julia_to_cpp(circles, Image),julia_to_cpp(param1, Float64),julia_to_cpp(param2, Float64),julia_to_cpp(minRadius, Int32),julia_to_cpp(maxRadius, Int32)))
end
...
function HoughCircles(image::UMat, method::Int32, dp::Float64, minDist::Float64, circles::UMat, param1::Float64, param2::Float64, minRadius::Int32, maxRadius::Int32)
	return cpp_to_julia(jlopencv_cv_cv_HoughCircles(julia_to_cpp(image, UMat),julia_to_cpp(method, Int32),julia_to_cpp(dp, Float64),julia_to_cpp(minDist, Float64),julia_to_cpp(circles, UMat),julia_to_cpp(param1, Float64),julia_to_cpp(param2, Float64),julia_to_cpp(minRadius, Int32),julia_to_cpp(maxRadius, Int32)))
end
...
function erode(src::Image, kernel::Image, dst::Image, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_erode(julia_to_cpp(src, Image),julia_to_cpp(kernel, Image),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function erode(src::UMat, kernel::UMat, dst::UMat, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_erode(julia_to_cpp(src, UMat),julia_to_cpp(kernel, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function dilate(src::Image, kernel::Image, dst::Image, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_dilate(julia_to_cpp(src, Image),julia_to_cpp(kernel, Image),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function dilate(src::UMat, kernel::UMat, dst::UMat, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_dilate(julia_to_cpp(src, UMat),julia_to_cpp(kernel, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function morphologyEx(src::Image, op::Int32, kernel::Image, dst::Image, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_morphologyEx(julia_to_cpp(src, Image),julia_to_cpp(op, Int32),julia_to_cpp(kernel, Image),julia_to_cpp(dst, Image),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function morphologyEx(src::UMat, op::Int32, kernel::UMat, dst::UMat, anchor::Point{Int32}, iterations::Int32, borderType::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_morphologyEx(julia_to_cpp(src, UMat),julia_to_cpp(op, Int32),julia_to_cpp(kernel, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(anchor, Point{Int32}),julia_to_cpp(iterations, Int32),julia_to_cpp(borderType, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function resize(src::Image, dsize::Size, dst::Image, fx::Float64, fy::Float64, interpolation::Int32)
	return cpp_to_julia(jlopencv_cv_cv_resize(julia_to_cpp(src, Image),julia_to_cpp(dsize, Size),julia_to_cpp(dst, Image),julia_to_cpp(fx, Float64),julia_to_cpp(fy, Float64),julia_to_cpp(interpolation, Int32)))
end
...
function resize(src::UMat, dsize::Size, dst::UMat, fx::Float64, fy::Float64, interpolation::Int32)
	return cpp_to_julia(jlopencv_cv_cv_resize(julia_to_cpp(src, UMat),julia_to_cpp(dsize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(fx, Float64),julia_to_cpp(fy, Float64),julia_to_cpp(interpolation, Int32)))
end
...
function warpAffine(src::Image, M::Image, dsize::Size, dst::Image, flags::Int32, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_warpAffine(julia_to_cpp(src, Image),julia_to_cpp(M, Image),julia_to_cpp(dsize, Size),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function warpAffine(src::UMat, M::UMat, dsize::Size, dst::UMat, flags::Int32, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_warpAffine(julia_to_cpp(src, UMat),julia_to_cpp(M, UMat),julia_to_cpp(dsize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function warpPerspective(src::Image, M::Image, dsize::Size, dst::Image, flags::Int32, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_warpPerspective(julia_to_cpp(src, Image),julia_to_cpp(M, Image),julia_to_cpp(dsize, Size),julia_to_cpp(dst, Image),julia_to_cpp(flags, Int32),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function warpPerspective(src::UMat, M::UMat, dsize::Size, dst::UMat, flags::Int32, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_warpPerspective(julia_to_cpp(src, UMat),julia_to_cpp(M, UMat),julia_to_cpp(dsize, Size),julia_to_cpp(dst, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function remap(src::Image, map1::Image, map2::Image, interpolation::Int32, dst::Image, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_remap(julia_to_cpp(src, Image),julia_to_cpp(map1, Image),julia_to_cpp(map2, Image),julia_to_cpp(interpolation, Int32),julia_to_cpp(dst, Image),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function remap(src::UMat, map1::UMat, map2::UMat, interpolation::Int32, dst::UMat, borderMode::Int32, borderValue::Scalar)
	return cpp_to_julia(jlopencv_cv_cv_remap(julia_to_cpp(src, UMat),julia_to_cpp(map1, UMat),julia_to_cpp(map2, UMat),julia_to_cpp(interpolation, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(borderMode, Int32),julia_to_cpp(borderValue, Scalar)))
end
...
function convertMaps(map1::Image, map2::Image, dstmap1type::Int32, dstmap1::Image, dstmap2::Image, nninterpolation::Bool)
	return cpp_to_julia(jlopencv_cv_cv_convertMaps(julia_to_cpp(map1, Image),julia_to_cpp(map2, Image),julia_to_cpp(dstmap1type, Int32),julia_to_cpp(dstmap1, Image),julia_to_cpp(dstmap2, Image),julia_to_cpp(nninterpolation, Bool)))
end
...
function convertMaps(map1::UMat, map2::UMat, dstmap1type::Int32, dstmap1::UMat, dstmap2::UMat, nninterpolation::Bool)
	return cpp_to_julia(jlopencv_cv_cv_convertMaps(julia_to_cpp(map1, UMat),julia_to_cpp(map2, UMat),julia_to_cpp(dstmap1type, Int32),julia_to_cpp(dstmap1, UMat),julia_to_cpp(dstmap2, UMat),julia_to_cpp(nninterpolation, Bool)))
end
...
function getRotationMatrix2D(center::Point{Float32}, angle::Float64, scale::Float64)
	return cpp_to_julia(jlopencv_cv_cv_getRotationMatrix2D(julia_to_cpp(center, Point{Float32}),julia_to_cpp(angle, Float64),julia_to_cpp(scale, Float64)))
end
...
function invertAffineTransform(M::Image, iM::Image)
	return cpp_to_julia(jlopencv_cv_cv_invertAffineTransform(julia_to_cpp(M, Image),julia_to_cpp(iM, Image)))
end
invertAffineTransform(M::Image; iM::Image = Mat()) = invertAffineTransform(M, iM)

function invertAffineTransform(M::UMat, iM::UMat)
	return cpp_to_julia(jlopencv_cv_cv_invertAffineTransform(julia_to_cpp(M, UMat),julia_to_cpp(iM, UMat)))
end
...
function getPerspectiveTransform(src::Image, dst::Image, solveMethod::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getPerspectiveTransform(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(solveMethod, Int32)))
end
...
function getPerspectiveTransform(src::UMat, dst::UMat, solveMethod::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getPerspectiveTransform(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(solveMethod, Int32)))
end
...
function getAffineTransform(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_getAffineTransform(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
getAffineTransform(src::Image, dst::Image; ) = getAffineTransform(src, dst)

function getAffineTransform(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_getAffineTransform(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
...
function getRectSubPix(image::Image, patchSize::Size, center::Point{Float32}, patch::Image, patchType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getRectSubPix(julia_to_cpp(image, Image),julia_to_cpp(patchSize, Size),julia_to_cpp(center, Point{Float32}),julia_to_cpp(patch, Image),julia_to_cpp(patchType, Int32)))
end
...
function getRectSubPix(image::UMat, patchSize::Size, center::Point{Float32}, patch::UMat, patchType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getRectSubPix(julia_to_cpp(image, UMat),julia_to_cpp(patchSize, Size),julia_to_cpp(center, Point{Float32}),julia_to_cpp(patch, UMat),julia_to_cpp(patchType, Int32)))
end
...
function logPolar(src::Image, center::Point{Float32}, M::Float64, flags::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_logPolar(julia_to_cpp(src, Image),julia_to_cpp(center, Point{Float32}),julia_to_cpp(M, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, Image)))
end
...
function logPolar(src::UMat, center::Point{Float32}, M::Float64, flags::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_logPolar(julia_to_cpp(src, UMat),julia_to_cpp(center, Point{Float32}),julia_to_cpp(M, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, UMat)))
end
...
function linearPolar(src::Image, center::Point{Float32}, maxRadius::Float64, flags::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_linearPolar(julia_to_cpp(src, Image),julia_to_cpp(center, Point{Float32}),julia_to_cpp(maxRadius, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, Image)))
end
...
function linearPolar(src::UMat, center::Point{Float32}, maxRadius::Float64, flags::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_linearPolar(julia_to_cpp(src, UMat),julia_to_cpp(center, Point{Float32}),julia_to_cpp(maxRadius, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, UMat)))
end
...
function warpPolar(src::Image, dsize::Size, center::Point{Float32}, maxRadius::Float64, flags::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_warpPolar(julia_to_cpp(src, Image),julia_to_cpp(dsize, Size),julia_to_cpp(center, Point{Float32}),julia_to_cpp(maxRadius, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, Image)))
end
...
function warpPolar(src::UMat, dsize::Size, center::Point{Float32}, maxRadius::Float64, flags::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_warpPolar(julia_to_cpp(src, UMat),julia_to_cpp(dsize, Size),julia_to_cpp(center, Point{Float32}),julia_to_cpp(maxRadius, Float64),julia_to_cpp(flags, Int32),julia_to_cpp(dst, UMat)))
end
...
function integral(src::Image, sum::Image, sdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, Image),julia_to_cpp(sum, Image),julia_to_cpp(sdepth, Int32)))
end
integral(src::Image; sum::Image = Mat(), sdepth::Int32 = -1) = integral(src, sum, sdepth)

function integral(src::UMat, sum::UMat, sdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, UMat),julia_to_cpp(sum, UMat),julia_to_cpp(sdepth, Int32)))
end
...
function integral2(src::Image, sum::Image, sqsum::Image, sdepth::Int32, sqdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, Image),julia_to_cpp(sum, Image),julia_to_cpp(sqsum, Image),julia_to_cpp(sdepth, Int32),julia_to_cpp(sqdepth, Int32)))
end
...
function integral2(src::UMat, sum::UMat, sqsum::UMat, sdepth::Int32, sqdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, UMat),julia_to_cpp(sum, UMat),julia_to_cpp(sqsum, UMat),julia_to_cpp(sdepth, Int32),julia_to_cpp(sqdepth, Int32)))
end
...
function integral3(src::Image, sum::Image, sqsum::Image, tilted::Image, sdepth::Int32, sqdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, Image),julia_to_cpp(sum, Image),julia_to_cpp(sqsum, Image),julia_to_cpp(tilted, Image),julia_to_cpp(sdepth, Int32),julia_to_cpp(sqdepth, Int32)))
end
...
function integral3(src::UMat, sum::UMat, sqsum::UMat, tilted::UMat, sdepth::Int32, sqdepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_integral(julia_to_cpp(src, UMat),julia_to_cpp(sum, UMat),julia_to_cpp(sqsum, UMat),julia_to_cpp(tilted, UMat),julia_to_cpp(sdepth, Int32),julia_to_cpp(sqdepth, Int32)))
end
...
function accumulate(src::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_accumulate(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
accumulate(src::Image, dst::Image; mask::Image = Mat()) = accumulate(src, dst, mask)

function accumulate(src::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_accumulate(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function accumulateSquare(src::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_accumulateSquare(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function accumulateSquare(src::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_accumulateSquare(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function accumulateProduct(src1::Image, src2::Image, dst::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_accumulateProduct(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(dst, Image),julia_to_cpp(mask, Image)))
end
...
function accumulateProduct(src1::UMat, src2::UMat, dst::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_accumulateProduct(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(mask, UMat)))
end
...
function accumulateWeighted(src::Image, dst::Image, alpha::Float64, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_accumulateWeighted(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(mask, Image)))
end
...
function accumulateWeighted(src::UMat, dst::UMat, alpha::Float64, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_accumulateWeighted(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(mask, UMat)))
end
...
function phaseCorrelate(src1::Image, src2::Image, window::Image)
	return cpp_to_julia(jlopencv_cv_cv_phaseCorrelate(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(window, Image)))
end
...
function phaseCorrelate(src1::UMat, src2::UMat, window::UMat)
	return cpp_to_julia(jlopencv_cv_cv_phaseCorrelate(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(window, UMat)))
end
...
function createHanningWindow(winSize::Size, type::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_createHanningWindow(julia_to_cpp(winSize, Size),julia_to_cpp(type, Int32),julia_to_cpp(dst, Image)))
end
...
function createHanningWindow(winSize::Size, type::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_createHanningWindow(julia_to_cpp(winSize, Size),julia_to_cpp(type, Int32),julia_to_cpp(dst, UMat)))
end
...
function threshold(src::Image, thresh::Float64, maxval::Float64, type::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_threshold(julia_to_cpp(src, Image),julia_to_cpp(thresh, Float64),julia_to_cpp(maxval, Float64),julia_to_cpp(type, Int32),julia_to_cpp(dst, Image)))
end
...
function threshold(src::UMat, thresh::Float64, maxval::Float64, type::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_threshold(julia_to_cpp(src, UMat),julia_to_cpp(thresh, Float64),julia_to_cpp(maxval, Float64),julia_to_cpp(type, Int32),julia_to_cpp(dst, UMat)))
end
...
function adaptiveThreshold(src::Image, maxValue::Float64, adaptiveMethod::Int32, thresholdType::Int32, blockSize::Int32, C::Float64, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_adaptiveThreshold(julia_to_cpp(src, Image),julia_to_cpp(maxValue, Float64),julia_to_cpp(adaptiveMethod, Int32),julia_to_cpp(thresholdType, Int32),julia_to_cpp(blockSize, Int32),julia_to_cpp(C, Float64),julia_to_cpp(dst, Image)))
end
...
function adaptiveThreshold(src::UMat, maxValue::Float64, adaptiveMethod::Int32, thresholdType::Int32, blockSize::Int32, C::Float64, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_adaptiveThreshold(julia_to_cpp(src, UMat),julia_to_cpp(maxValue, Float64),julia_to_cpp(adaptiveMethod, Int32),julia_to_cpp(thresholdType, Int32),julia_to_cpp(blockSize, Int32),julia_to_cpp(C, Float64),julia_to_cpp(dst, UMat)))
end
...
function pyrDown(src::Image, dst::Image, dstsize::Size, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_pyrDown(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(dstsize, Size),julia_to_cpp(borderType, Int32)))
end
...
function pyrDown(src::UMat, dst::UMat, dstsize::Size, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_pyrDown(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(dstsize, Size),julia_to_cpp(borderType, Int32)))
end
...
function pyrUp(src::Image, dst::Image, dstsize::Size, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_pyrUp(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(dstsize, Size),julia_to_cpp(borderType, Int32)))
end
...
function pyrUp(src::UMat, dst::UMat, dstsize::Size, borderType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_pyrUp(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(dstsize, Size),julia_to_cpp(borderType, Int32)))
end
...
function calcHist(images::Array{Image, 1}, channels::Array{Int32, 1}, mask::Image, histSize::Array{Int32, 1}, ranges::Array{Float32, 1}, hist::Image, accumulate::Bool)
	return cpp_to_julia(jlopencv_cv_cv_calcHist(julia_to_cpp(images, Array{Image, 1}),julia_to_cpp(channels, Array{Int32, 1}),julia_to_cpp(mask, Image),julia_to_cpp(histSize, Array{Int32, 1}),julia_to_cpp(ranges, Array{Float32, 1}),julia_to_cpp(hist, Image),julia_to_cpp(accumulate, Bool)))
end
...
function calcHist(images::Array{UMat, 1}, channels::Array{Int32, 1}, mask::UMat, histSize::Array{Int32, 1}, ranges::Array{Float32, 1}, hist::UMat, accumulate::Bool)
	return cpp_to_julia(jlopencv_cv_cv_calcHist(julia_to_cpp(images, Array{UMat, 1}),julia_to_cpp(channels, Array{Int32, 1}),julia_to_cpp(mask, UMat),julia_to_cpp(histSize, Array{Int32, 1}),julia_to_cpp(ranges, Array{Float32, 1}),julia_to_cpp(hist, UMat),julia_to_cpp(accumulate, Bool)))
end
...
function calcBackProject(images::Array{Image, 1}, channels::Array{Int32, 1}, hist::Image, ranges::Array{Float32, 1}, scale::Float64, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_calcBackProject(julia_to_cpp(images, Array{Image, 1}),julia_to_cpp(channels, Array{Int32, 1}),julia_to_cpp(hist, Image),julia_to_cpp(ranges, Array{Float32, 1}),julia_to_cpp(scale, Float64),julia_to_cpp(dst, Image)))
end
...
function calcBackProject(images::Array{UMat, 1}, channels::Array{Int32, 1}, hist::UMat, ranges::Array{Float32, 1}, scale::Float64, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_calcBackProject(julia_to_cpp(images, Array{UMat, 1}),julia_to_cpp(channels, Array{Int32, 1}),julia_to_cpp(hist, UMat),julia_to_cpp(ranges, Array{Float32, 1}),julia_to_cpp(scale, Float64),julia_to_cpp(dst, UMat)))
end
...
function compareHist(H1::Image, H2::Image, method::Int32)
	return cpp_to_julia(jlopencv_cv_cv_compareHist(julia_to_cpp(H1, Image),julia_to_cpp(H2, Image),julia_to_cpp(method, Int32)))
end
compareHist(H1::Image, H2::Image, method::Int32; ) = compareHist(H1, H2, method)

function compareHist(H1::UMat, H2::UMat, method::Int32)
	return cpp_to_julia(jlopencv_cv_cv_compareHist(julia_to_cpp(H1, UMat),julia_to_cpp(H2, UMat),julia_to_cpp(method, Int32)))
end
compareHist(H1::UMat, H2::UMat, method::Int32; ) = compareHist(H1, H2, method)

function equalizeHist(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_equalizeHist(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
equalizeHist(src::Image; dst::Image = Mat()) = equalizeHist(src, dst)

function equalizeHist(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_equalizeHist(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
equalizeHist(src::UMat; dst::UMat = UMat()) = equalizeHist(src, dst)

function createCLAHE(clipLimit::Float64, tileGridSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_createCLAHE(julia_to_cpp(clipLimit, Float64),julia_to_cpp(tileGridSize, Size)))
end
...
function EMD(signature1::Image, signature2::Image, distType::Int32, cost::Image, lowerBound::Ptr{Float32}, flow::Image)
	return cpp_to_julia(jlopencv_cv_cv_wrapperEMD(julia_to_cpp(signature1, Image),julia_to_cpp(signature2, Image),julia_to_cpp(distType, Int32),julia_to_cpp(cost, Image),julia_to_cpp(lowerBound, Ptr{Float32}),julia_to_cpp(flow, Image)))
end
...
function EMD(signature1::UMat, signature2::UMat, distType::Int32, cost::UMat, lowerBound::Ptr{Float32}, flow::UMat)
	return cpp_to_julia(jlopencv_cv_cv_wrapperEMD(julia_to_cpp(signature1, UMat),julia_to_cpp(signature2, UMat),julia_to_cpp(distType, Int32),julia_to_cpp(cost, UMat),julia_to_cpp(lowerBound, Ptr{Float32}),julia_to_cpp(flow, UMat)))
end
...
function watershed(image::Image, markers::Image)
	return cpp_to_julia(jlopencv_cv_cv_watershed(julia_to_cpp(image, Image),julia_to_cpp(markers, Image)))
end
watershed(image::Image, markers::Image; ) = watershed(image, markers)

function watershed(image::UMat, markers::UMat)
	return cpp_to_julia(jlopencv_cv_cv_watershed(julia_to_cpp(image, UMat),julia_to_cpp(markers, UMat)))
end
...
function pyrMeanShiftFiltering(src::Image, sp::Float64, sr::Float64, dst::Image, maxLevel::Int32, termcrit::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_pyrMeanShiftFiltering(julia_to_cpp(src, Image),julia_to_cpp(sp, Float64),julia_to_cpp(sr, Float64),julia_to_cpp(dst, Image),julia_to_cpp(maxLevel, Int32),julia_to_cpp(termcrit, TermCriteria)))
end
...
function pyrMeanShiftFiltering(src::UMat, sp::Float64, sr::Float64, dst::UMat, maxLevel::Int32, termcrit::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_pyrMeanShiftFiltering(julia_to_cpp(src, UMat),julia_to_cpp(sp, Float64),julia_to_cpp(sr, Float64),julia_to_cpp(dst, UMat),julia_to_cpp(maxLevel, Int32),julia_to_cpp(termcrit, TermCriteria)))
end
...
function grabCut(img::Image, mask::Image, rect::Rect, bgdModel::Image, fgdModel::Image, iterCount::Int32, mode::Int32)
	return cpp_to_julia(jlopencv_cv_cv_grabCut(julia_to_cpp(img, Image),julia_to_cpp(mask, Image),julia_to_cpp(rect, Rect),julia_to_cpp(bgdModel, Image),julia_to_cpp(fgdModel, Image),julia_to_cpp(iterCount, Int32),julia_to_cpp(mode, Int32)))
end
...
function grabCut(img::UMat, mask::UMat, rect::Rect, bgdModel::UMat, fgdModel::UMat, iterCount::Int32, mode::Int32)
	return cpp_to_julia(jlopencv_cv_cv_grabCut(julia_to_cpp(img, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(rect, Rect),julia_to_cpp(bgdModel, UMat),julia_to_cpp(fgdModel, UMat),julia_to_cpp(iterCount, Int32),julia_to_cpp(mode, Int32)))
end
...
function distanceTransformWithLabels(src::Image, distanceType::Int32, maskSize::Int32, dst::Image, labels::Image, labelType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_distanceTransform(julia_to_cpp(src, Image),julia_to_cpp(distanceType, Int32),julia_to_cpp(maskSize, Int32),julia_to_cpp(dst, Image),julia_to_cpp(labels, Image),julia_to_cpp(labelType, Int32)))
end
...
function distanceTransformWithLabels(src::UMat, distanceType::Int32, maskSize::Int32, dst::UMat, labels::UMat, labelType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_distanceTransform(julia_to_cpp(src, UMat),julia_to_cpp(distanceType, Int32),julia_to_cpp(maskSize, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(labels, UMat),julia_to_cpp(labelType, Int32)))
end
...
function distanceTransform(src::Image, distanceType::Int32, maskSize::Int32, dst::Image, dstType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_distanceTransform(julia_to_cpp(src, Image),julia_to_cpp(distanceType, Int32),julia_to_cpp(maskSize, Int32),julia_to_cpp(dst, Image),julia_to_cpp(dstType, Int32)))
end
...
function distanceTransform(src::UMat, distanceType::Int32, maskSize::Int32, dst::UMat, dstType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_distanceTransform(julia_to_cpp(src, UMat),julia_to_cpp(distanceType, Int32),julia_to_cpp(maskSize, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(dstType, Int32)))
end
...
function floodFill(image::Image, mask::Image, seedPoint::Point{Int32}, newVal::Scalar, loDiff::Scalar, upDiff::Scalar, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_floodFill(julia_to_cpp(image, Image),julia_to_cpp(mask, Image),julia_to_cpp(seedPoint, Point{Int32}),julia_to_cpp(newVal, Scalar),julia_to_cpp(loDiff, Scalar),julia_to_cpp(upDiff, Scalar),julia_to_cpp(flags, Int32)))
end
...
function floodFill(image::UMat, mask::UMat, seedPoint::Point{Int32}, newVal::Scalar, loDiff::Scalar, upDiff::Scalar, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_floodFill(julia_to_cpp(image, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(seedPoint, Point{Int32}),julia_to_cpp(newVal, Scalar),julia_to_cpp(loDiff, Scalar),julia_to_cpp(upDiff, Scalar),julia_to_cpp(flags, Int32)))
end
...
function cvtColor(src::Image, code::Int32, dst::Image, dstCn::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cvtColor(julia_to_cpp(src, Image),julia_to_cpp(code, Int32),julia_to_cpp(dst, Image),julia_to_cpp(dstCn, Int32)))
end
...
function cvtColor(src::UMat, code::Int32, dst::UMat, dstCn::Int32)
	return cpp_to_julia(jlopencv_cv_cv_cvtColor(julia_to_cpp(src, UMat),julia_to_cpp(code, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(dstCn, Int32)))
end
...
function cvtColorTwoPlane(src1::Image, src2::Image, code::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_cvtColorTwoPlane(julia_to_cpp(src1, Image),julia_to_cpp(src2, Image),julia_to_cpp(code, Int32),julia_to_cpp(dst, Image)))
end
...
function cvtColorTwoPlane(src1::UMat, src2::UMat, code::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_cvtColorTwoPlane(julia_to_cpp(src1, UMat),julia_to_cpp(src2, UMat),julia_to_cpp(code, Int32),julia_to_cpp(dst, UMat)))
end
...
function demosaicing(src::Image, code::Int32, dst::Image, dstCn::Int32)
	return cpp_to_julia(jlopencv_cv_cv_demosaicing(julia_to_cpp(src, Image),julia_to_cpp(code, Int32),julia_to_cpp(dst, Image),julia_to_cpp(dstCn, Int32)))
end
...
function demosaicing(src::UMat, code::Int32, dst::UMat, dstCn::Int32)
	return cpp_to_julia(jlopencv_cv_cv_demosaicing(julia_to_cpp(src, UMat),julia_to_cpp(code, Int32),julia_to_cpp(dst, UMat),julia_to_cpp(dstCn, Int32)))
end
...
function moments(array::Image, binaryImage::Bool)
	return cpp_to_julia(jlopencv_cv_cv_moments(julia_to_cpp(array, Image),julia_to_cpp(binaryImage, Bool)))
end
moments(array::Image; binaryImage::Bool = false) = moments(array, binaryImage)

function moments(array::UMat, binaryImage::Bool)
	return cpp_to_julia(jlopencv_cv_cv_moments(julia_to_cpp(array, UMat),julia_to_cpp(binaryImage, Bool)))
end
moments(array::UMat; binaryImage::Bool = false) = moments(array, binaryImage)

function HuMoments(m::Moments, hu::Image)
	return cpp_to_julia(jlopencv_cv_cv_HuMoments(julia_to_cpp(m, Moments),julia_to_cpp(hu, Image)))
end
HuMoments(m::Moments; hu::Image = Mat()) = HuMoments(m, hu)

function HuMoments(m::Moments, hu::UMat)
	return cpp_to_julia(jlopencv_cv_cv_HuMoments(julia_to_cpp(m, Moments),julia_to_cpp(hu, UMat)))
end
...
function matchTemplate(image::Image, templ::Image, method::Int32, result::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_matchTemplate(julia_to_cpp(image, Image),julia_to_cpp(templ, Image),julia_to_cpp(method, Int32),julia_to_cpp(result, Image),julia_to_cpp(mask, Image)))
end
...
function matchTemplate(image::UMat, templ::UMat, method::Int32, result::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_matchTemplate(julia_to_cpp(image, UMat),julia_to_cpp(templ, UMat),julia_to_cpp(method, Int32),julia_to_cpp(result, UMat),julia_to_cpp(mask, UMat)))
end
...
function connectedComponentsWithAlgorithm(image::Image, connectivity::Int32, ltype::Int32, ccltype::Int32, labels::Image)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponents(julia_to_cpp(image, Image),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32),julia_to_cpp(ccltype, Int32),julia_to_cpp(labels, Image)))
end
...
function connectedComponentsWithAlgorithm(image::UMat, connectivity::Int32, ltype::Int32, ccltype::Int32, labels::UMat)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponents(julia_to_cpp(image, UMat),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32),julia_to_cpp(ccltype, Int32),julia_to_cpp(labels, UMat)))
end
...
function connectedComponents(image::Image, labels::Image, connectivity::Int32, ltype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponents(julia_to_cpp(image, Image),julia_to_cpp(labels, Image),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32)))
end
...
function connectedComponents(image::UMat, labels::UMat, connectivity::Int32, ltype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponents(julia_to_cpp(image, UMat),julia_to_cpp(labels, UMat),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32)))
end
...
function connectedComponentsWithStatsWithAlgorithm(image::Image, connectivity::Int32, ltype::Int32, ccltype::Int32, labels::Image, stats::Image, centroids::Image)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponentsWithStats(julia_to_cpp(image, Image),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32),julia_to_cpp(ccltype, Int32),julia_to_cpp(labels, Image),julia_to_cpp(stats, Image),julia_to_cpp(centroids, Image)))
end
...
function connectedComponentsWithStatsWithAlgorithm(image::UMat, connectivity::Int32, ltype::Int32, ccltype::Int32, labels::UMat, stats::UMat, centroids::UMat)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponentsWithStats(julia_to_cpp(image, UMat),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32),julia_to_cpp(ccltype, Int32),julia_to_cpp(labels, UMat),julia_to_cpp(stats, UMat),julia_to_cpp(centroids, UMat)))
end
...
function connectedComponentsWithStats(image::Image, labels::Image, stats::Image, centroids::Image, connectivity::Int32, ltype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponentsWithStats(julia_to_cpp(image, Image),julia_to_cpp(labels, Image),julia_to_cpp(stats, Image),julia_to_cpp(centroids, Image),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32)))
end
...
function connectedComponentsWithStats(image::UMat, labels::UMat, stats::UMat, centroids::UMat, connectivity::Int32, ltype::Int32)
	return cpp_to_julia(jlopencv_cv_cv_connectedComponentsWithStats(julia_to_cpp(image, UMat),julia_to_cpp(labels, UMat),julia_to_cpp(stats, UMat),julia_to_cpp(centroids, UMat),julia_to_cpp(connectivity, Int32),julia_to_cpp(ltype, Int32)))
end
...
function findContours(image::Image, mode::Int32, method::Int32, contours::Array{Image, 1}, hierarchy::Image, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_findContours(julia_to_cpp(image, Image),julia_to_cpp(mode, Int32),julia_to_cpp(method, Int32),julia_to_cpp(contours, Array{Image, 1}),julia_to_cpp(hierarchy, Image),julia_to_cpp(offset, Point{Int32})))
end
...
function findContours(image::UMat, mode::Int32, method::Int32, contours::Array{UMat, 1}, hierarchy::UMat, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_findContours(julia_to_cpp(image, UMat),julia_to_cpp(mode, Int32),julia_to_cpp(method, Int32),julia_to_cpp(contours, Array{UMat, 1}),julia_to_cpp(hierarchy, UMat),julia_to_cpp(offset, Point{Int32})))
end
...
function approxPolyDP(curve::Image, epsilon::Float64, closed::Bool, approxCurve::Image)
	return cpp_to_julia(jlopencv_cv_cv_approxPolyDP(julia_to_cpp(curve, Image),julia_to_cpp(epsilon, Float64),julia_to_cpp(closed, Bool),julia_to_cpp(approxCurve, Image)))
end
...
function approxPolyDP(curve::UMat, epsilon::Float64, closed::Bool, approxCurve::UMat)
	return cpp_to_julia(jlopencv_cv_cv_approxPolyDP(julia_to_cpp(curve, UMat),julia_to_cpp(epsilon, Float64),julia_to_cpp(closed, Bool),julia_to_cpp(approxCurve, UMat)))
end
...
function arcLength(curve::Image, closed::Bool)
	return cpp_to_julia(jlopencv_cv_cv_arcLength(julia_to_cpp(curve, Image),julia_to_cpp(closed, Bool)))
end
arcLength(curve::Image, closed::Bool; ) = arcLength(curve, closed)

function arcLength(curve::UMat, closed::Bool)
	return cpp_to_julia(jlopencv_cv_cv_arcLength(julia_to_cpp(curve, UMat),julia_to_cpp(closed, Bool)))
end
arcLength(curve::UMat, closed::Bool; ) = arcLength(curve, closed)

function boundingRect(array::Image)
	return cpp_to_julia(jlopencv_cv_cv_boundingRect(julia_to_cpp(array, Image)))
end
boundingRect(array::Image; ) = boundingRect(array)

function boundingRect(array::UMat)
	return cpp_to_julia(jlopencv_cv_cv_boundingRect(julia_to_cpp(array, UMat)))
end
boundingRect(array::UMat; ) = boundingRect(array)

function contourArea(contour::Image, oriented::Bool)
	return cpp_to_julia(jlopencv_cv_cv_contourArea(julia_to_cpp(contour, Image),julia_to_cpp(oriented, Bool)))
end
...
function contourArea(contour::UMat, oriented::Bool)
	return cpp_to_julia(jlopencv_cv_cv_contourArea(julia_to_cpp(contour, UMat),julia_to_cpp(oriented, Bool)))
end
contourArea(contour::UMat; oriented::Bool = false) = contourArea(contour, oriented)

function minAreaRect(points::Image)
	return cpp_to_julia(jlopencv_cv_cv_minAreaRect(julia_to_cpp(points, Image)))
end
minAreaRect(points::Image; ) = minAreaRect(points)

function minAreaRect(points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_minAreaRect(julia_to_cpp(points, UMat)))
end
minAreaRect(points::UMat; ) = minAreaRect(points)

function boxPoints(box::RotatedRect, points::Image)
	return cpp_to_julia(jlopencv_cv_cv_boxPoints(julia_to_cpp(box, RotatedRect),julia_to_cpp(points, Image)))
end
boxPoints(box::RotatedRect; points::Image = Mat()) = boxPoints(box, points)

function boxPoints(box::RotatedRect, points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_boxPoints(julia_to_cpp(box, RotatedRect),julia_to_cpp(points, UMat)))
end
boxPoints(box::RotatedRect; points::UMat = UMat()) = boxPoints(box, points)

function minEnclosingCircle(points::Image)
	return cpp_to_julia(jlopencv_cv_cv_minEnclosingCircle(julia_to_cpp(points, Image)))
end
minEnclosingCircle(points::Image; ) = minEnclosingCircle(points)

function minEnclosingCircle(points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_minEnclosingCircle(julia_to_cpp(points, UMat)))
end
minEnclosingCircle(points::UMat; ) = minEnclosingCircle(points)

function minEnclosingTriangle(points::Image, triangle::Image)
	return cpp_to_julia(jlopencv_cv_cv_minEnclosingTriangle(julia_to_cpp(points, Image),julia_to_cpp(triangle, Image)))
end
...
function minEnclosingTriangle(points::UMat, triangle::UMat)
	return cpp_to_julia(jlopencv_cv_cv_minEnclosingTriangle(julia_to_cpp(points, UMat),julia_to_cpp(triangle, UMat)))
end
...
function matchShapes(contour1::Image, contour2::Image, method::Int32, parameter::Float64)
	return cpp_to_julia(jlopencv_cv_cv_matchShapes(julia_to_cpp(contour1, Image),julia_to_cpp(contour2, Image),julia_to_cpp(method, Int32),julia_to_cpp(parameter, Float64)))
end
...
function matchShapes(contour1::UMat, contour2::UMat, method::Int32, parameter::Float64)
	return cpp_to_julia(jlopencv_cv_cv_matchShapes(julia_to_cpp(contour1, UMat),julia_to_cpp(contour2, UMat),julia_to_cpp(method, Int32),julia_to_cpp(parameter, Float64)))
end
...
function convexHull(points::Image, hull::Image, clockwise::Bool, returnPoints::Bool)
	return cpp_to_julia(jlopencv_cv_cv_convexHull(julia_to_cpp(points, Image),julia_to_cpp(hull, Image),julia_to_cpp(clockwise, Bool),julia_to_cpp(returnPoints, Bool)))
end
...
function convexHull(points::UMat, hull::UMat, clockwise::Bool, returnPoints::Bool)
	return cpp_to_julia(jlopencv_cv_cv_convexHull(julia_to_cpp(points, UMat),julia_to_cpp(hull, UMat),julia_to_cpp(clockwise, Bool),julia_to_cpp(returnPoints, Bool)))
end
...
function convexityDefects(contour::Image, convexhull::Image, convexityDefects::Image)
	return cpp_to_julia(jlopencv_cv_cv_convexityDefects(julia_to_cpp(contour, Image),julia_to_cpp(convexhull, Image),julia_to_cpp(convexityDefects, Image)))
end
...
function convexityDefects(contour::UMat, convexhull::UMat, convexityDefects::UMat)
	return cpp_to_julia(jlopencv_cv_cv_convexityDefects(julia_to_cpp(contour, UMat),julia_to_cpp(convexhull, UMat),julia_to_cpp(convexityDefects, UMat)))
end
...
function isContourConvex(contour::Image)
	return cpp_to_julia(jlopencv_cv_cv_isContourConvex(julia_to_cpp(contour, Image)))
end
isContourConvex(contour::Image; ) = isContourConvex(contour)

function isContourConvex(contour::UMat)
	return cpp_to_julia(jlopencv_cv_cv_isContourConvex(julia_to_cpp(contour, UMat)))
end
...
function intersectConvexConvex(_p1::Image, _p2::Image, _p12::Image, handleNested::Bool)
	return cpp_to_julia(jlopencv_cv_cv_intersectConvexConvex(julia_to_cpp(_p1, Image),julia_to_cpp(_p2, Image),julia_to_cpp(_p12, Image),julia_to_cpp(handleNested, Bool)))
end
...
function intersectConvexConvex(_p1::UMat, _p2::UMat, _p12::UMat, handleNested::Bool)
	return cpp_to_julia(jlopencv_cv_cv_intersectConvexConvex(julia_to_cpp(_p1, UMat),julia_to_cpp(_p2, UMat),julia_to_cpp(_p12, UMat),julia_to_cpp(handleNested, Bool)))
end
...
function fitEllipse(points::Image)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipse(julia_to_cpp(points, Image)))
end
fitEllipse(points::Image; ) = fitEllipse(points)

function fitEllipse(points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipse(julia_to_cpp(points, UMat)))
end
fitEllipse(points::UMat; ) = fitEllipse(points)

function fitEllipseAMS(points::Image)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipseAMS(julia_to_cpp(points, Image)))
end
fitEllipseAMS(points::Image; ) = fitEllipseAMS(points)

function fitEllipseAMS(points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipseAMS(julia_to_cpp(points, UMat)))
end
fitEllipseAMS(points::UMat; ) = fitEllipseAMS(points)

function fitEllipseDirect(points::Image)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipseDirect(julia_to_cpp(points, Image)))
end
fitEllipseDirect(points::Image; ) = fitEllipseDirect(points)

function fitEllipseDirect(points::UMat)
	return cpp_to_julia(jlopencv_cv_cv_fitEllipseDirect(julia_to_cpp(points, UMat)))
end
...
function fitLine(points::Image, distType::Int32, param::Float64, reps::Float64, aeps::Float64, line::Image)
	return cpp_to_julia(jlopencv_cv_cv_fitLine(julia_to_cpp(points, Image),julia_to_cpp(distType, Int32),julia_to_cpp(param, Float64),julia_to_cpp(reps, Float64),julia_to_cpp(aeps, Float64),julia_to_cpp(line, Image)))
end
...
function fitLine(points::UMat, distType::Int32, param::Float64, reps::Float64, aeps::Float64, line::UMat)
	return cpp_to_julia(jlopencv_cv_cv_fitLine(julia_to_cpp(points, UMat),julia_to_cpp(distType, Int32),julia_to_cpp(param, Float64),julia_to_cpp(reps, Float64),julia_to_cpp(aeps, Float64),julia_to_cpp(line, UMat)))
end
...
function pointPolygonTest(contour::Image, pt::Point{Float32}, measureDist::Bool)
	return cpp_to_julia(jlopencv_cv_cv_pointPolygonTest(julia_to_cpp(contour, Image),julia_to_cpp(pt, Point{Float32}),julia_to_cpp(measureDist, Bool)))
end
...
function pointPolygonTest(contour::UMat, pt::Point{Float32}, measureDist::Bool)
	return cpp_to_julia(jlopencv_cv_cv_pointPolygonTest(julia_to_cpp(contour, UMat),julia_to_cpp(pt, Point{Float32}),julia_to_cpp(measureDist, Bool)))
end
...
function rotatedRectangleIntersection(rect1::RotatedRect, rect2::RotatedRect, intersectingRegion::Image)
	return cpp_to_julia(jlopencv_cv_cv_rotatedRectangleIntersection(julia_to_cpp(rect1, RotatedRect),julia_to_cpp(rect2, RotatedRect),julia_to_cpp(intersectingRegion, Image)))
end
...
function rotatedRectangleIntersection(rect1::RotatedRect, rect2::RotatedRect, intersectingRegion::UMat)
	return cpp_to_julia(jlopencv_cv_cv_rotatedRectangleIntersection(julia_to_cpp(rect1, RotatedRect),julia_to_cpp(rect2, RotatedRect),julia_to_cpp(intersectingRegion, UMat)))
end
...
function applyColorMap(src::Image, colormap::Int32, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_applyColorMap(julia_to_cpp(src, Image),julia_to_cpp(colormap, Int32),julia_to_cpp(dst, Image)))
end
...
function applyColorMap(src::UMat, colormap::Int32, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_applyColorMap(julia_to_cpp(src, UMat),julia_to_cpp(colormap, Int32),julia_to_cpp(dst, UMat)))
end
...
function applyColorMap(src::Image, userColor::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_applyColorMap(julia_to_cpp(src, Image),julia_to_cpp(userColor, Image),julia_to_cpp(dst, Image)))
end
...
function applyColorMap(src::UMat, userColor::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_applyColorMap(julia_to_cpp(src, UMat),julia_to_cpp(userColor, UMat),julia_to_cpp(dst, UMat)))
end
...
function line(img::Image, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_line(julia_to_cpp(img, Image),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function line(img::UMat, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_line(julia_to_cpp(img, UMat),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function arrowedLine(img::Image, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, line_type::Int32, shift::Int32, tipLength::Float64)
	return cpp_to_julia(jlopencv_cv_cv_arrowedLine(julia_to_cpp(img, Image),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(line_type, Int32),julia_to_cpp(shift, Int32),julia_to_cpp(tipLength, Float64)))
end
...
function arrowedLine(img::UMat, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, line_type::Int32, shift::Int32, tipLength::Float64)
	return cpp_to_julia(jlopencv_cv_cv_arrowedLine(julia_to_cpp(img, UMat),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(line_type, Int32),julia_to_cpp(shift, Int32),julia_to_cpp(tipLength, Float64)))
end
...
function rectangle(img::Image, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_rectangle(julia_to_cpp(img, Image),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function rectangle(img::UMat, pt1::Point{Int32}, pt2::Point{Int32}, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_rectangle(julia_to_cpp(img, UMat),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function rectangle(img::Image, rec::Rect, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_rectangle(julia_to_cpp(img, Image),julia_to_cpp(rec, Rect),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function rectangle(img::UMat, rec::Rect, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_rectangle(julia_to_cpp(img, UMat),julia_to_cpp(rec, Rect),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function circle(img::Image, center::Point{Int32}, radius::Int32, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_circle(julia_to_cpp(img, Image),julia_to_cpp(center, Point{Int32}),julia_to_cpp(radius, Int32),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function circle(img::UMat, center::Point{Int32}, radius::Int32, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_circle(julia_to_cpp(img, UMat),julia_to_cpp(center, Point{Int32}),julia_to_cpp(radius, Int32),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function ellipse(img::Image, center::Point{Int32}, axes::Size, angle::Float64, startAngle::Float64, endAngle::Float64, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ellipse(julia_to_cpp(img, Image),julia_to_cpp(center, Point{Int32}),julia_to_cpp(axes, Size),julia_to_cpp(angle, Float64),julia_to_cpp(startAngle, Float64),julia_to_cpp(endAngle, Float64),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function ellipse(img::UMat, center::Point{Int32}, axes::Size, angle::Float64, startAngle::Float64, endAngle::Float64, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ellipse(julia_to_cpp(img, UMat),julia_to_cpp(center, Point{Int32}),julia_to_cpp(axes, Size),julia_to_cpp(angle, Float64),julia_to_cpp(startAngle, Float64),julia_to_cpp(endAngle, Float64),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function ellipse(img::Image, box::RotatedRect, color::Scalar, thickness::Int32, lineType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ellipse(julia_to_cpp(img, Image),julia_to_cpp(box, RotatedRect),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32)))
end
...
function ellipse(img::UMat, box::RotatedRect, color::Scalar, thickness::Int32, lineType::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ellipse(julia_to_cpp(img, UMat),julia_to_cpp(box, RotatedRect),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32)))
end
...
function drawMarker(img::Image, position::Point{Int32}, color::Scalar, markerType::Int32, markerSize::Int32, thickness::Int32, line_type::Int32)
	return cpp_to_julia(jlopencv_cv_cv_drawMarker(julia_to_cpp(img, Image),julia_to_cpp(position, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(markerType, Int32),julia_to_cpp(markerSize, Int32),julia_to_cpp(thickness, Int32),julia_to_cpp(line_type, Int32)))
end
...
function drawMarker(img::UMat, position::Point{Int32}, color::Scalar, markerType::Int32, markerSize::Int32, thickness::Int32, line_type::Int32)
	return cpp_to_julia(jlopencv_cv_cv_drawMarker(julia_to_cpp(img, UMat),julia_to_cpp(position, Point{Int32}),julia_to_cpp(color, Scalar),julia_to_cpp(markerType, Int32),julia_to_cpp(markerSize, Int32),julia_to_cpp(thickness, Int32),julia_to_cpp(line_type, Int32)))
end
...
function fillConvexPoly(img::Image, points::Image, color::Scalar, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_fillConvexPoly(julia_to_cpp(img, Image),julia_to_cpp(points, Image),julia_to_cpp(color, Scalar),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function fillConvexPoly(img::UMat, points::UMat, color::Scalar, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_fillConvexPoly(julia_to_cpp(img, UMat),julia_to_cpp(points, UMat),julia_to_cpp(color, Scalar),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function fillPoly(img::Image, pts::Array{Image, 1}, color::Scalar, lineType::Int32, shift::Int32, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_fillPoly(julia_to_cpp(img, Image),julia_to_cpp(pts, Array{Image, 1}),julia_to_cpp(color, Scalar),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32),julia_to_cpp(offset, Point{Int32})))
end
...
function fillPoly(img::UMat, pts::Array{UMat, 1}, color::Scalar, lineType::Int32, shift::Int32, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_fillPoly(julia_to_cpp(img, UMat),julia_to_cpp(pts, Array{UMat, 1}),julia_to_cpp(color, Scalar),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32),julia_to_cpp(offset, Point{Int32})))
end
...
function polylines(img::Image, pts::Array{Image, 1}, isClosed::Bool, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_polylines(julia_to_cpp(img, Image),julia_to_cpp(pts, Array{Image, 1}),julia_to_cpp(isClosed, Bool),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function polylines(img::UMat, pts::Array{UMat, 1}, isClosed::Bool, color::Scalar, thickness::Int32, lineType::Int32, shift::Int32)
	return cpp_to_julia(jlopencv_cv_cv_polylines(julia_to_cpp(img, UMat),julia_to_cpp(pts, Array{UMat, 1}),julia_to_cpp(isClosed, Bool),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(shift, Int32)))
end
...
function drawContours(image::Image, contours::Array{Image, 1}, contourIdx::Int32, color::Scalar, thickness::Int32, lineType::Int32, hierarchy::Image, maxLevel::Int32, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_drawContours(julia_to_cpp(image, Image),julia_to_cpp(contours, Array{Image, 1}),julia_to_cpp(contourIdx, Int32),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(hierarchy, Image),julia_to_cpp(maxLevel, Int32),julia_to_cpp(offset, Point{Int32})))
end
...
function drawContours(image::UMat, contours::Array{UMat, 1}, contourIdx::Int32, color::Scalar, thickness::Int32, lineType::Int32, hierarchy::UMat, maxLevel::Int32, offset::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_drawContours(julia_to_cpp(image, UMat),julia_to_cpp(contours, Array{UMat, 1}),julia_to_cpp(contourIdx, Int32),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(hierarchy, UMat),julia_to_cpp(maxLevel, Int32),julia_to_cpp(offset, Point{Int32})))
end
...
function clipLine(imgRect::Rect, pt1::Point{Int32}, pt2::Point{Int32})
	return cpp_to_julia(jlopencv_cv_cv_clipLine(julia_to_cpp(imgRect, Rect),julia_to_cpp(pt1, Point{Int32}),julia_to_cpp(pt2, Point{Int32})))
end
...
function ellipse2Poly(center::Point{Int32}, axes::Size, angle::Int32, arcStart::Int32, arcEnd::Int32, delta::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ellipse2Poly(julia_to_cpp(center, Point{Int32}),julia_to_cpp(axes, Size),julia_to_cpp(angle, Int32),julia_to_cpp(arcStart, Int32),julia_to_cpp(arcEnd, Int32),julia_to_cpp(delta, Int32)))
end
...
function putText(img::Image, text::String, org::Point{Int32}, fontFace::Int32, fontScale::Float64, color::Scalar, thickness::Int32, lineType::Int32, bottomLeftOrigin::Bool)
	return cpp_to_julia(jlopencv_cv_cv_putText(julia_to_cpp(img, Image),julia_to_cpp(text, String),julia_to_cpp(org, Point{Int32}),julia_to_cpp(fontFace, Int32),julia_to_cpp(fontScale, Float64),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(bottomLeftOrigin, Bool)))
end
...
function putText(img::UMat, text::String, org::Point{Int32}, fontFace::Int32, fontScale::Float64, color::Scalar, thickness::Int32, lineType::Int32, bottomLeftOrigin::Bool)
	return cpp_to_julia(jlopencv_cv_cv_putText(julia_to_cpp(img, UMat),julia_to_cpp(text, String),julia_to_cpp(org, Point{Int32}),julia_to_cpp(fontFace, Int32),julia_to_cpp(fontScale, Float64),julia_to_cpp(color, Scalar),julia_to_cpp(thickness, Int32),julia_to_cpp(lineType, Int32),julia_to_cpp(bottomLeftOrigin, Bool)))
end
...
function getTextSize(text::String, fontFace::Int32, fontScale::Float64, thickness::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getTextSize(julia_to_cpp(text, String),julia_to_cpp(fontFace, Int32),julia_to_cpp(fontScale, Float64),julia_to_cpp(thickness, Int32)))
end
...
function getFontScaleFromHeight(fontFace::Int32, pixelHeight::Int32, thickness::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getFontScaleFromHeight(julia_to_cpp(fontFace, Int32),julia_to_cpp(pixelHeight, Int32),julia_to_cpp(thickness, Int32)))
end
...
function Rodrigues(src::Image, dst::Image, jacobian::Image)
	return cpp_to_julia(jlopencv_cv_cv_Rodrigues(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(jacobian, Image)))
end
...
function Rodrigues(src::UMat, dst::UMat, jacobian::UMat)
	return cpp_to_julia(jlopencv_cv_cv_Rodrigues(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(jacobian, UMat)))
end
...
function findHomography(srcPoints::Image, dstPoints::Image, method::Int32, ransacReprojThreshold::Float64, mask::Image, maxIters::Int32, confidence::Float64)
	return cpp_to_julia(jlopencv_cv_cv_findHomography(julia_to_cpp(srcPoints, Image),julia_to_cpp(dstPoints, Image),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(mask, Image),julia_to_cpp(maxIters, Int32),julia_to_cpp(confidence, Float64)))
end
...
function findHomography(srcPoints::UMat, dstPoints::UMat, method::Int32, ransacReprojThreshold::Float64, mask::UMat, maxIters::Int32, confidence::Float64)
	return cpp_to_julia(jlopencv_cv_cv_findHomography(julia_to_cpp(srcPoints, UMat),julia_to_cpp(dstPoints, UMat),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(mask, UMat),julia_to_cpp(maxIters, Int32),julia_to_cpp(confidence, Float64)))
end
...
function RQDecomp3x3(src::Image, mtxR::Image, mtxQ::Image, Qx::Image, Qy::Image, Qz::Image)
	return cpp_to_julia(jlopencv_cv_cv_RQDecomp3x3(julia_to_cpp(src, Image),julia_to_cpp(mtxR, Image),julia_to_cpp(mtxQ, Image),julia_to_cpp(Qx, Image),julia_to_cpp(Qy, Image),julia_to_cpp(Qz, Image)))
end
...
function RQDecomp3x3(src::UMat, mtxR::UMat, mtxQ::UMat, Qx::UMat, Qy::UMat, Qz::UMat)
	return cpp_to_julia(jlopencv_cv_cv_RQDecomp3x3(julia_to_cpp(src, UMat),julia_to_cpp(mtxR, UMat),julia_to_cpp(mtxQ, UMat),julia_to_cpp(Qx, UMat),julia_to_cpp(Qy, UMat),julia_to_cpp(Qz, UMat)))
end
...
function decomposeProjectionMatrix(projMatrix::Image, cameraMatrix::Image, rotMatrix::Image, transVect::Image, rotMatrixX::Image, rotMatrixY::Image, rotMatrixZ::Image, eulerAngles::Image)
	return cpp_to_julia(jlopencv_cv_cv_decomposeProjectionMatrix(julia_to_cpp(projMatrix, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(rotMatrix, Image),julia_to_cpp(transVect, Image),julia_to_cpp(rotMatrixX, Image),julia_to_cpp(rotMatrixY, Image),julia_to_cpp(rotMatrixZ, Image),julia_to_cpp(eulerAngles, Image)))
end
...
function decomposeProjectionMatrix(projMatrix::UMat, cameraMatrix::UMat, rotMatrix::UMat, transVect::UMat, rotMatrixX::UMat, rotMatrixY::UMat, rotMatrixZ::UMat, eulerAngles::UMat)
	return cpp_to_julia(jlopencv_cv_cv_decomposeProjectionMatrix(julia_to_cpp(projMatrix, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(rotMatrix, UMat),julia_to_cpp(transVect, UMat),julia_to_cpp(rotMatrixX, UMat),julia_to_cpp(rotMatrixY, UMat),julia_to_cpp(rotMatrixZ, UMat),julia_to_cpp(eulerAngles, UMat)))
end
...
function matMulDeriv(A::Image, B::Image, dABdA::Image, dABdB::Image)
	return cpp_to_julia(jlopencv_cv_cv_matMulDeriv(julia_to_cpp(A, Image),julia_to_cpp(B, Image),julia_to_cpp(dABdA, Image),julia_to_cpp(dABdB, Image)))
end
...
function matMulDeriv(A::UMat, B::UMat, dABdA::UMat, dABdB::UMat)
	return cpp_to_julia(jlopencv_cv_cv_matMulDeriv(julia_to_cpp(A, UMat),julia_to_cpp(B, UMat),julia_to_cpp(dABdA, UMat),julia_to_cpp(dABdB, UMat)))
end
...
function composeRT(rvec1::Image, tvec1::Image, rvec2::Image, tvec2::Image, rvec3::Image, tvec3::Image, dr3dr1::Image, dr3dt1::Image, dr3dr2::Image, dr3dt2::Image, dt3dr1::Image, dt3dt1::Image, dt3dr2::Image, dt3dt2::Image)
	return cpp_to_julia(jlopencv_cv_cv_composeRT(julia_to_cpp(rvec1, Image),julia_to_cpp(tvec1, Image),julia_to_cpp(rvec2, Image),julia_to_cpp(tvec2, Image),julia_to_cpp(rvec3, Image),julia_to_cpp(tvec3, Image),julia_to_cpp(dr3dr1, Image),julia_to_cpp(dr3dt1, Image),julia_to_cpp(dr3dr2, Image),julia_to_cpp(dr3dt2, Image),julia_to_cpp(dt3dr1, Image),julia_to_cpp(dt3dt1, Image),julia_to_cpp(dt3dr2, Image),julia_to_cpp(dt3dt2, Image)))
end
...
function composeRT(rvec1::UMat, tvec1::UMat, rvec2::UMat, tvec2::UMat, rvec3::UMat, tvec3::UMat, dr3dr1::UMat, dr3dt1::UMat, dr3dr2::UMat, dr3dt2::UMat, dt3dr1::UMat, dt3dt1::UMat, dt3dr2::UMat, dt3dt2::UMat)
	return cpp_to_julia(jlopencv_cv_cv_composeRT(julia_to_cpp(rvec1, UMat),julia_to_cpp(tvec1, UMat),julia_to_cpp(rvec2, UMat),julia_to_cpp(tvec2, UMat),julia_to_cpp(rvec3, UMat),julia_to_cpp(tvec3, UMat),julia_to_cpp(dr3dr1, UMat),julia_to_cpp(dr3dt1, UMat),julia_to_cpp(dr3dr2, UMat),julia_to_cpp(dr3dt2, UMat),julia_to_cpp(dt3dr1, UMat),julia_to_cpp(dt3dt1, UMat),julia_to_cpp(dt3dr2, UMat),julia_to_cpp(dt3dt2, UMat)))
end
...
function projectPoints(objectPoints::Image, rvec::Image, tvec::Image, cameraMatrix::Image, distCoeffs::Image, imagePoints::Image, jacobian::Image, aspectRatio::Float64)
	return cpp_to_julia(jlopencv_cv_cv_projectPoints(julia_to_cpp(objectPoints, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(jacobian, Image),julia_to_cpp(aspectRatio, Float64)))
end
...
function projectPoints(objectPoints::UMat, rvec::UMat, tvec::UMat, cameraMatrix::UMat, distCoeffs::UMat, imagePoints::UMat, jacobian::UMat, aspectRatio::Float64)
	return cpp_to_julia(jlopencv_cv_cv_projectPoints(julia_to_cpp(objectPoints, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(jacobian, UMat),julia_to_cpp(aspectRatio, Float64)))
end
...
function solvePnP(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, rvec::Image, tvec::Image, useExtrinsicGuess::Bool, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePnP(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(flags, Int32)))
end
...
function solvePnP(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvec::UMat, tvec::UMat, useExtrinsicGuess::Bool, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePnP(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(flags, Int32)))
end
...
function solvePnPRansac(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, rvec::Image, tvec::Image, useExtrinsicGuess::Bool, iterationsCount::Int32, reprojectionError::Float32, confidence::Float64, inliers::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRansac(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(iterationsCount, Int32),julia_to_cpp(reprojectionError, Float32),julia_to_cpp(confidence, Float64),julia_to_cpp(inliers, Image),julia_to_cpp(flags, Int32)))
end
...
function solvePnPRansac(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvec::UMat, tvec::UMat, useExtrinsicGuess::Bool, iterationsCount::Int32, reprojectionError::Float32, confidence::Float64, inliers::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRansac(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(iterationsCount, Int32),julia_to_cpp(reprojectionError, Float32),julia_to_cpp(confidence, Float64),julia_to_cpp(inliers, UMat),julia_to_cpp(flags, Int32)))
end
...
function solveP3P(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, flags::Int32, rvecs::Array{Image, 1}, tvecs::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_solveP3P(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(flags, Int32),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1})))
end
...
function solveP3P(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, flags::Int32, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_solveP3P(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1})))
end
...
function solvePnPRefineLM(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, rvec::Image, tvec::Image, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRefineLM(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(criteria, TermCriteria)))
end
...
function solvePnPRefineLM(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvec::UMat, tvec::UMat, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRefineLM(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(criteria, TermCriteria)))
end
...
function solvePnPRefineVVS(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, rvec::Image, tvec::Image, criteria::TermCriteria, VVSlambda::Float64)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRefineVVS(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(VVSlambda, Float64)))
end
...
function solvePnPRefineVVS(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvec::UMat, tvec::UMat, criteria::TermCriteria, VVSlambda::Float64)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPRefineVVS(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(VVSlambda, Float64)))
end
...
function solvePnPGeneric(objectPoints::Image, imagePoints::Image, cameraMatrix::Image, distCoeffs::Image, rvecs::Array{Image, 1}, tvecs::Array{Image, 1}, useExtrinsicGuess::Bool, flags::SolvePnPMethod, rvec::Image, tvec::Image, reprojectionError::Image)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPGeneric(julia_to_cpp(objectPoints, Image),julia_to_cpp(imagePoints, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1}),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(flags, SolvePnPMethod),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(reprojectionError, Image)))
end
...
function solvePnPGeneric(objectPoints::UMat, imagePoints::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1}, useExtrinsicGuess::Bool, flags::SolvePnPMethod, rvec::UMat, tvec::UMat, reprojectionError::UMat)
	return cpp_to_julia(jlopencv_cv_cv_solvePnPGeneric(julia_to_cpp(objectPoints, UMat),julia_to_cpp(imagePoints, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1}),julia_to_cpp(useExtrinsicGuess, Bool),julia_to_cpp(flags, SolvePnPMethod),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(reprojectionError, UMat)))
end
...
function initCameraMatrix2D(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, imageSize::Size, aspectRatio::Float64)
	return cpp_to_julia(jlopencv_cv_cv_initCameraMatrix2D(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(aspectRatio, Float64)))
end
...
function initCameraMatrix2D(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, imageSize::Size, aspectRatio::Float64)
	return cpp_to_julia(jlopencv_cv_cv_initCameraMatrix2D(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(aspectRatio, Float64)))
end
...
function findChessboardCorners(image::Image, patternSize::Size, corners::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCorners(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, Image),julia_to_cpp(flags, Int32)))
end
...
function findChessboardCorners(image::UMat, patternSize::Size, corners::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCorners(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, UMat),julia_to_cpp(flags, Int32)))
end
...
function checkChessboard(img::Image, size::Size)
	return cpp_to_julia(jlopencv_cv_cv_checkChessboard(julia_to_cpp(img, Image),julia_to_cpp(size, Size)))
end
checkChessboard(img::Image, size::Size; ) = checkChessboard(img, size)

function checkChessboard(img::UMat, size::Size)
	return cpp_to_julia(jlopencv_cv_cv_checkChessboard(julia_to_cpp(img, UMat),julia_to_cpp(size, Size)))
end
...
function findChessboardCornersSBWithMeta(image::Image, patternSize::Size, flags::Int32, corners::Image, meta::Image)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCornersSB(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(corners, Image),julia_to_cpp(meta, Image)))
end
...
function findChessboardCornersSBWithMeta(image::UMat, patternSize::Size, flags::Int32, corners::UMat, meta::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCornersSB(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(corners, UMat),julia_to_cpp(meta, UMat)))
end
...
function findChessboardCornersSB(image::Image, patternSize::Size, corners::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCornersSB(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, Image),julia_to_cpp(flags, Int32)))
end
...
function findChessboardCornersSB(image::UMat, patternSize::Size, corners::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findChessboardCornersSB(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, UMat),julia_to_cpp(flags, Int32)))
end
...
function estimateChessboardSharpness(image::Image, patternSize::Size, corners::Image, rise_distance::Float32, vertical::Bool, sharpness::Image)
	return cpp_to_julia(jlopencv_cv_cv_estimateChessboardSharpness(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, Image),julia_to_cpp(rise_distance, Float32),julia_to_cpp(vertical, Bool),julia_to_cpp(sharpness, Image)))
end
...
function estimateChessboardSharpness(image::UMat, patternSize::Size, corners::UMat, rise_distance::Float32, vertical::Bool, sharpness::UMat)
	return cpp_to_julia(jlopencv_cv_cv_estimateChessboardSharpness(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, UMat),julia_to_cpp(rise_distance, Float32),julia_to_cpp(vertical, Bool),julia_to_cpp(sharpness, UMat)))
end
...
function find4QuadCornerSubpix(img::Image, corners::Image, region_size::Size)
	return cpp_to_julia(jlopencv_cv_cv_find4QuadCornerSubpix(julia_to_cpp(img, Image),julia_to_cpp(corners, Image),julia_to_cpp(region_size, Size)))
end
...
function find4QuadCornerSubpix(img::UMat, corners::UMat, region_size::Size)
	return cpp_to_julia(jlopencv_cv_cv_find4QuadCornerSubpix(julia_to_cpp(img, UMat),julia_to_cpp(corners, UMat),julia_to_cpp(region_size, Size)))
end
...
function drawChessboardCorners(image::Image, patternSize::Size, corners::Image, patternWasFound::Bool)
	return cpp_to_julia(jlopencv_cv_cv_drawChessboardCorners(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, Image),julia_to_cpp(patternWasFound, Bool)))
end
...
function drawChessboardCorners(image::UMat, patternSize::Size, corners::UMat, patternWasFound::Bool)
	return cpp_to_julia(jlopencv_cv_cv_drawChessboardCorners(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(corners, UMat),julia_to_cpp(patternWasFound, Bool)))
end
...
function drawFrameAxes(image::Image, cameraMatrix::Image, distCoeffs::Image, rvec::Image, tvec::Image, length::Float32, thickness::Int32)
	return cpp_to_julia(jlopencv_cv_cv_drawFrameAxes(julia_to_cpp(image, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvec, Image),julia_to_cpp(tvec, Image),julia_to_cpp(length, Float32),julia_to_cpp(thickness, Int32)))
end
...
function drawFrameAxes(image::UMat, cameraMatrix::UMat, distCoeffs::UMat, rvec::UMat, tvec::UMat, length::Float32, thickness::Int32)
	return cpp_to_julia(jlopencv_cv_cv_drawFrameAxes(julia_to_cpp(image, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvec, UMat),julia_to_cpp(tvec, UMat),julia_to_cpp(length, Float32),julia_to_cpp(thickness, Int32)))
end
...
function findCirclesGrid(image::Image, patternSize::Size, flags::Int32, blobDetector::Ptr{FeatureDetector}, parameters::CirclesGridFinderParameters, centers::Image)
	return cpp_to_julia(jlopencv_cv_cv_findCirclesGrid(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(blobDetector, Ptr{FeatureDetector}),julia_to_cpp(parameters, CirclesGridFinderParameters),julia_to_cpp(centers, Image)))
end
findCirclesGrid(image::Image, patternSize::Size, flags::Int32, blobDetector::Ptr{FeatureDetector}, parameters::CirclesGridFinderParameters; centers::Image = Mat()) = findCirclesGrid(image, patternSize, flags, blobDetector, parameters, centers)
...
function findCirclesGrid(image::UMat, patternSize::Size, flags::Int32, blobDetector::Ptr{FeatureDetector}, parameters::CirclesGridFinderParameters, centers::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findCirclesGrid(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(blobDetector, Ptr{FeatureDetector}),julia_to_cpp(parameters, CirclesGridFinderParameters),julia_to_cpp(centers, UMat)))
end
...
function findCirclesGrid(image::Image, patternSize::Size, centers::Image, flags::Int32, blobDetector::Ptr{FeatureDetector})
	return cpp_to_julia(jlopencv_cv_cv_findCirclesGrid(julia_to_cpp(image, Image),julia_to_cpp(patternSize, Size),julia_to_cpp(centers, Image),julia_to_cpp(flags, Int32),julia_to_cpp(blobDetector, Ptr{FeatureDetector})))
end
findCirclesGrid(image::Image, patternSize::Size; centers::Image = Mat(), flags::Int32 = CALIB_CB_SYMMETRIC_GRID, blobDetector::Ptr{FeatureDetector} = SimpleBlobDetector::create()) = findCirclesGrid(image, patternSize, centers, flags, blobDetector)

function findCirclesGrid(image::UMat, patternSize::Size, centers::UMat, flags::Int32, blobDetector::Ptr{FeatureDetector})
	return cpp_to_julia(jlopencv_cv_cv_findCirclesGrid(julia_to_cpp(image, UMat),julia_to_cpp(patternSize, Size),julia_to_cpp(centers, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(blobDetector, Ptr{FeatureDetector})))
end
...
function calibrateCameraExtended(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, imageSize::Size, cameraMatrix::Image, distCoeffs::Image, rvecs::Array{Image, 1}, tvecs::Array{Image, 1}, stdDeviationsIntrinsics::Image, stdDeviationsExtrinsics::Image, perViewErrors::Image, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCamera(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1}),julia_to_cpp(stdDeviationsIntrinsics, Image),julia_to_cpp(stdDeviationsExtrinsics, Image),julia_to_cpp(perViewErrors, Image),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCameraExtended(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, imageSize::Size, cameraMatrix::UMat, distCoeffs::UMat, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1}, stdDeviationsIntrinsics::UMat, stdDeviationsExtrinsics::UMat, perViewErrors::UMat, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCamera(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1}),julia_to_cpp(stdDeviationsIntrinsics, UMat),julia_to_cpp(stdDeviationsExtrinsics, UMat),julia_to_cpp(perViewErrors, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCamera(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, imageSize::Size, cameraMatrix::Image, distCoeffs::Image, rvecs::Array{Image, 1}, tvecs::Array{Image, 1}, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCamera(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1}),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCamera(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, imageSize::Size, cameraMatrix::UMat, distCoeffs::UMat, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1}, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCamera(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1}),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCameraROExtended(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, imageSize::Size, iFixedPoint::Int32, cameraMatrix::Image, distCoeffs::Image, rvecs::Array{Image, 1}, tvecs::Array{Image, 1}, newObjPoints::Image, stdDeviationsIntrinsics::Image, stdDeviationsExtrinsics::Image, stdDeviationsObjPoints::Image, perViewErrors::Image, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCameraRO(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(iFixedPoint, Int32),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1}),julia_to_cpp(newObjPoints, Image),julia_to_cpp(stdDeviationsIntrinsics, Image),julia_to_cpp(stdDeviationsExtrinsics, Image),julia_to_cpp(stdDeviationsObjPoints, Image),julia_to_cpp(perViewErrors, Image),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCameraROExtended(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, imageSize::Size, iFixedPoint::Int32, cameraMatrix::UMat, distCoeffs::UMat, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1}, newObjPoints::UMat, stdDeviationsIntrinsics::UMat, stdDeviationsExtrinsics::UMat, stdDeviationsObjPoints::UMat, perViewErrors::UMat, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCameraRO(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(iFixedPoint, Int32),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1}),julia_to_cpp(newObjPoints, UMat),julia_to_cpp(stdDeviationsIntrinsics, UMat),julia_to_cpp(stdDeviationsExtrinsics, UMat),julia_to_cpp(stdDeviationsObjPoints, UMat),julia_to_cpp(perViewErrors, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCameraRO(objectPoints::Array{Image, 1}, imagePoints::Array{Image, 1}, imageSize::Size, iFixedPoint::Int32, cameraMatrix::Image, distCoeffs::Image, rvecs::Array{Image, 1}, tvecs::Array{Image, 1}, newObjPoints::Image, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCameraRO(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(iFixedPoint, Int32),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(rvecs, Array{Image, 1}),julia_to_cpp(tvecs, Array{Image, 1}),julia_to_cpp(newObjPoints, Image),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrateCameraRO(objectPoints::Array{UMat, 1}, imagePoints::Array{UMat, 1}, imageSize::Size, iFixedPoint::Int32, cameraMatrix::UMat, distCoeffs::UMat, rvecs::Array{UMat, 1}, tvecs::Array{UMat, 1}, newObjPoints::UMat, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_calibrateCameraRO(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(iFixedPoint, Int32),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(rvecs, Array{UMat, 1}),julia_to_cpp(tvecs, Array{UMat, 1}),julia_to_cpp(newObjPoints, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function calibrationMatrixValues(cameraMatrix::Image, imageSize::Size, apertureWidth::Float64, apertureHeight::Float64)
	return cpp_to_julia(jlopencv_cv_cv_calibrationMatrixValues(julia_to_cpp(cameraMatrix, Image),julia_to_cpp(imageSize, Size),julia_to_cpp(apertureWidth, Float64),julia_to_cpp(apertureHeight, Float64)))
end
...
function calibrationMatrixValues(cameraMatrix::UMat, imageSize::Size, apertureWidth::Float64, apertureHeight::Float64)
	return cpp_to_julia(jlopencv_cv_cv_calibrationMatrixValues(julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(imageSize, Size),julia_to_cpp(apertureWidth, Float64),julia_to_cpp(apertureHeight, Float64)))
end
...
function stereoCalibrateExtended(objectPoints::Array{Image, 1}, imagePoints1::Array{Image, 1}, imagePoints2::Array{Image, 1}, cameraMatrix1::Image, distCoeffs1::Image, cameraMatrix2::Image, distCoeffs2::Image, imageSize::Size, R::Image, T::Image, E::Image, F::Image, perViewErrors::Image, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_stereoCalibrate(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints1, Array{Image, 1}),julia_to_cpp(imagePoints2, Array{Image, 1}),julia_to_cpp(cameraMatrix1, Image),julia_to_cpp(distCoeffs1, Image),julia_to_cpp(cameraMatrix2, Image),julia_to_cpp(distCoeffs2, Image),julia_to_cpp(imageSize, Size),julia_to_cpp(R, Image),julia_to_cpp(T, Image),julia_to_cpp(E, Image),julia_to_cpp(F, Image),julia_to_cpp(perViewErrors, Image),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function stereoCalibrateExtended(objectPoints::Array{UMat, 1}, imagePoints1::Array{UMat, 1}, imagePoints2::Array{UMat, 1}, cameraMatrix1::UMat, distCoeffs1::UMat, cameraMatrix2::UMat, distCoeffs2::UMat, imageSize::Size, R::UMat, T::UMat, E::UMat, F::UMat, perViewErrors::UMat, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_stereoCalibrate(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints1, Array{UMat, 1}),julia_to_cpp(imagePoints2, Array{UMat, 1}),julia_to_cpp(cameraMatrix1, UMat),julia_to_cpp(distCoeffs1, UMat),julia_to_cpp(cameraMatrix2, UMat),julia_to_cpp(distCoeffs2, UMat),julia_to_cpp(imageSize, Size),julia_to_cpp(R, UMat),julia_to_cpp(T, UMat),julia_to_cpp(E, UMat),julia_to_cpp(F, UMat),julia_to_cpp(perViewErrors, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function stereoCalibrate(objectPoints::Array{Image, 1}, imagePoints1::Array{Image, 1}, imagePoints2::Array{Image, 1}, cameraMatrix1::Image, distCoeffs1::Image, cameraMatrix2::Image, distCoeffs2::Image, imageSize::Size, R::Image, T::Image, E::Image, F::Image, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_stereoCalibrate(julia_to_cpp(objectPoints, Array{Image, 1}),julia_to_cpp(imagePoints1, Array{Image, 1}),julia_to_cpp(imagePoints2, Array{Image, 1}),julia_to_cpp(cameraMatrix1, Image),julia_to_cpp(distCoeffs1, Image),julia_to_cpp(cameraMatrix2, Image),julia_to_cpp(distCoeffs2, Image),julia_to_cpp(imageSize, Size),julia_to_cpp(R, Image),julia_to_cpp(T, Image),julia_to_cpp(E, Image),julia_to_cpp(F, Image),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function stereoCalibrate(objectPoints::Array{UMat, 1}, imagePoints1::Array{UMat, 1}, imagePoints2::Array{UMat, 1}, cameraMatrix1::UMat, distCoeffs1::UMat, cameraMatrix2::UMat, distCoeffs2::UMat, imageSize::Size, R::UMat, T::UMat, E::UMat, F::UMat, flags::Int32, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_stereoCalibrate(julia_to_cpp(objectPoints, Array{UMat, 1}),julia_to_cpp(imagePoints1, Array{UMat, 1}),julia_to_cpp(imagePoints2, Array{UMat, 1}),julia_to_cpp(cameraMatrix1, UMat),julia_to_cpp(distCoeffs1, UMat),julia_to_cpp(cameraMatrix2, UMat),julia_to_cpp(distCoeffs2, UMat),julia_to_cpp(imageSize, Size),julia_to_cpp(R, UMat),julia_to_cpp(T, UMat),julia_to_cpp(E, UMat),julia_to_cpp(F, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(criteria, TermCriteria)))
end
...
function stereoRectify(cameraMatrix1::Image, distCoeffs1::Image, cameraMatrix2::Image, distCoeffs2::Image, imageSize::Size, R::Image, T::Image, R1::Image, R2::Image, P1::Image, P2::Image, Q::Image, flags::Int32, alpha::Float64, newImageSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_stereoRectify(julia_to_cpp(cameraMatrix1, Image),julia_to_cpp(distCoeffs1, Image),julia_to_cpp(cameraMatrix2, Image),julia_to_cpp(distCoeffs2, Image),julia_to_cpp(imageSize, Size),julia_to_cpp(R, Image),julia_to_cpp(T, Image),julia_to_cpp(R1, Image),julia_to_cpp(R2, Image),julia_to_cpp(P1, Image),julia_to_cpp(P2, Image),julia_to_cpp(Q, Image),julia_to_cpp(flags, Int32),julia_to_cpp(alpha, Float64),julia_to_cpp(newImageSize, Size)))
end
...
function stereoRectify(cameraMatrix1::UMat, distCoeffs1::UMat, cameraMatrix2::UMat, distCoeffs2::UMat, imageSize::Size, R::UMat, T::UMat, R1::UMat, R2::UMat, P1::UMat, P2::UMat, Q::UMat, flags::Int32, alpha::Float64, newImageSize::Size)
	return cpp_to_julia(jlopencv_cv_cv_stereoRectify(julia_to_cpp(cameraMatrix1, UMat),julia_to_cpp(distCoeffs1, UMat),julia_to_cpp(cameraMatrix2, UMat),julia_to_cpp(distCoeffs2, UMat),julia_to_cpp(imageSize, Size),julia_to_cpp(R, UMat),julia_to_cpp(T, UMat),julia_to_cpp(R1, UMat),julia_to_cpp(R2, UMat),julia_to_cpp(P1, UMat),julia_to_cpp(P2, UMat),julia_to_cpp(Q, UMat),julia_to_cpp(flags, Int32),julia_to_cpp(alpha, Float64),julia_to_cpp(newImageSize, Size)))
end
...
function stereoRectifyUncalibrated(points1::Image, points2::Image, F::Image, imgSize::Size, H1::Image, H2::Image, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_stereoRectifyUncalibrated(julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(F, Image),julia_to_cpp(imgSize, Size),julia_to_cpp(H1, Image),julia_to_cpp(H2, Image),julia_to_cpp(threshold, Float64)))
end
...
function stereoRectifyUncalibrated(points1::UMat, points2::UMat, F::UMat, imgSize::Size, H1::UMat, H2::UMat, threshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_stereoRectifyUncalibrated(julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(F, UMat),julia_to_cpp(imgSize, Size),julia_to_cpp(H1, UMat),julia_to_cpp(H2, UMat),julia_to_cpp(threshold, Float64)))
end
...
function rectify3Collinear(cameraMatrix1::Image, distCoeffs1::Image, cameraMatrix2::Image, distCoeffs2::Image, cameraMatrix3::Image, distCoeffs3::Image, imgpt1::Array{Image, 1}, imgpt3::Array{Image, 1}, imageSize::Size, R12::Image, T12::Image, R13::Image, T13::Image, alpha::Float64, newImgSize::Size, flags::Int32, R1::Image, R2::Image, R3::Image, P1::Image, P2::Image, P3::Image, Q::Image)
	return cpp_to_julia(jlopencv_cv_cv_rectify3Collinear(julia_to_cpp(cameraMatrix1, Image),julia_to_cpp(distCoeffs1, Image),julia_to_cpp(cameraMatrix2, Image),julia_to_cpp(distCoeffs2, Image),julia_to_cpp(cameraMatrix3, Image),julia_to_cpp(distCoeffs3, Image),julia_to_cpp(imgpt1, Array{Image, 1}),julia_to_cpp(imgpt3, Array{Image, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(R12, Image),julia_to_cpp(T12, Image),julia_to_cpp(R13, Image),julia_to_cpp(T13, Image),julia_to_cpp(alpha, Float64),julia_to_cpp(newImgSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(R1, Image),julia_to_cpp(R2, Image),julia_to_cpp(R3, Image),julia_to_cpp(P1, Image),julia_to_cpp(P2, Image),julia_to_cpp(P3, Image),julia_to_cpp(Q, Image)))
end
...
function rectify3Collinear(cameraMatrix1::UMat, distCoeffs1::UMat, cameraMatrix2::UMat, distCoeffs2::UMat, cameraMatrix3::UMat, distCoeffs3::UMat, imgpt1::Array{UMat, 1}, imgpt3::Array{UMat, 1}, imageSize::Size, R12::UMat, T12::UMat, R13::UMat, T13::UMat, alpha::Float64, newImgSize::Size, flags::Int32, R1::UMat, R2::UMat, R3::UMat, P1::UMat, P2::UMat, P3::UMat, Q::UMat)
	return cpp_to_julia(jlopencv_cv_cv_rectify3Collinear(julia_to_cpp(cameraMatrix1, UMat),julia_to_cpp(distCoeffs1, UMat),julia_to_cpp(cameraMatrix2, UMat),julia_to_cpp(distCoeffs2, UMat),julia_to_cpp(cameraMatrix3, UMat),julia_to_cpp(distCoeffs3, UMat),julia_to_cpp(imgpt1, Array{UMat, 1}),julia_to_cpp(imgpt3, Array{UMat, 1}),julia_to_cpp(imageSize, Size),julia_to_cpp(R12, UMat),julia_to_cpp(T12, UMat),julia_to_cpp(R13, UMat),julia_to_cpp(T13, UMat),julia_to_cpp(alpha, Float64),julia_to_cpp(newImgSize, Size),julia_to_cpp(flags, Int32),julia_to_cpp(R1, UMat),julia_to_cpp(R2, UMat),julia_to_cpp(R3, UMat),julia_to_cpp(P1, UMat),julia_to_cpp(P2, UMat),julia_to_cpp(P3, UMat),julia_to_cpp(Q, UMat)))
end
...
function getOptimalNewCameraMatrix(cameraMatrix::Image, distCoeffs::Image, imageSize::Size, alpha::Float64, newImgSize::Size, centerPrincipalPoint::Bool)
	return cpp_to_julia(jlopencv_cv_cv_getOptimalNewCameraMatrix(julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(imageSize, Size),julia_to_cpp(alpha, Float64),julia_to_cpp(newImgSize, Size),julia_to_cpp(centerPrincipalPoint, Bool)))
end
...
function getOptimalNewCameraMatrix(cameraMatrix::UMat, distCoeffs::UMat, imageSize::Size, alpha::Float64, newImgSize::Size, centerPrincipalPoint::Bool)
	return cpp_to_julia(jlopencv_cv_cv_getOptimalNewCameraMatrix(julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(imageSize, Size),julia_to_cpp(alpha, Float64),julia_to_cpp(newImgSize, Size),julia_to_cpp(centerPrincipalPoint, Bool)))
end
...
function calibrateHandEye(R_gripper2base::Array{Image, 1}, t_gripper2base::Array{Image, 1}, R_target2cam::Array{Image, 1}, t_target2cam::Array{Image, 1}, R_cam2gripper::Image, t_cam2gripper::Image, method::HandEyeCalibrationMethod)
	return cpp_to_julia(jlopencv_cv_cv_calibrateHandEye(julia_to_cpp(R_gripper2base, Array{Image, 1}),julia_to_cpp(t_gripper2base, Array{Image, 1}),julia_to_cpp(R_target2cam, Array{Image, 1}),julia_to_cpp(t_target2cam, Array{Image, 1}),julia_to_cpp(R_cam2gripper, Image),julia_to_cpp(t_cam2gripper, Image),julia_to_cpp(method, HandEyeCalibrationMethod)))
end
...
function calibrateHandEye(R_gripper2base::Array{UMat, 1}, t_gripper2base::Array{UMat, 1}, R_target2cam::Array{UMat, 1}, t_target2cam::Array{UMat, 1}, R_cam2gripper::UMat, t_cam2gripper::UMat, method::HandEyeCalibrationMethod)
	return cpp_to_julia(jlopencv_cv_cv_calibrateHandEye(julia_to_cpp(R_gripper2base, Array{UMat, 1}),julia_to_cpp(t_gripper2base, Array{UMat, 1}),julia_to_cpp(R_target2cam, Array{UMat, 1}),julia_to_cpp(t_target2cam, Array{UMat, 1}),julia_to_cpp(R_cam2gripper, UMat),julia_to_cpp(t_cam2gripper, UMat),julia_to_cpp(method, HandEyeCalibrationMethod)))
end
...
function convertPointsToHomogeneous(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_convertPointsToHomogeneous(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
...
function convertPointsToHomogeneous(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_convertPointsToHomogeneous(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
...
function convertPointsFromHomogeneous(src::Image, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_convertPointsFromHomogeneous(julia_to_cpp(src, Image),julia_to_cpp(dst, Image)))
end
...
function convertPointsFromHomogeneous(src::UMat, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_convertPointsFromHomogeneous(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat)))
end
...
function findFundamentalMat(points1::Image, points2::Image, method::Int32, ransacReprojThreshold::Float64, confidence::Float64, maxIters::Int32, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_findFundamentalMat(julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(confidence, Float64),julia_to_cpp(maxIters, Int32),julia_to_cpp(mask, Image)))
end
...
function findFundamentalMat(points1::UMat, points2::UMat, method::Int32, ransacReprojThreshold::Float64, confidence::Float64, maxIters::Int32, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findFundamentalMat(julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(confidence, Float64),julia_to_cpp(maxIters, Int32),julia_to_cpp(mask, UMat)))
end
...
function findFundamentalMat(points1::Image, points2::Image, method::Int32, ransacReprojThreshold::Float64, confidence::Float64, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_findFundamentalMat(julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(confidence, Float64),julia_to_cpp(mask, Image)))
end
...
function findFundamentalMat(points1::UMat, points2::UMat, method::Int32, ransacReprojThreshold::Float64, confidence::Float64, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findFundamentalMat(julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(confidence, Float64),julia_to_cpp(mask, UMat)))
end
...
function findEssentialMat(points1::Image, points2::Image, cameraMatrix::Image, method::Int32, prob::Float64, threshold::Float64, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_findEssentialMat(julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(method, Int32),julia_to_cpp(prob, Float64),julia_to_cpp(threshold, Float64),julia_to_cpp(mask, Image)))
end
...
function findEssentialMat(points1::UMat, points2::UMat, cameraMatrix::UMat, method::Int32, prob::Float64, threshold::Float64, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findEssentialMat(julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(method, Int32),julia_to_cpp(prob, Float64),julia_to_cpp(threshold, Float64),julia_to_cpp(mask, UMat)))
end
...
function findEssentialMat(points1::Image, points2::Image, focal::Float64, pp::Point{Float64}, method::Int32, prob::Float64, threshold::Float64, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_findEssentialMat(julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(focal, Float64),julia_to_cpp(pp, Point{Float64}),julia_to_cpp(method, Int32),julia_to_cpp(prob, Float64),julia_to_cpp(threshold, Float64),julia_to_cpp(mask, Image)))
end
...
function findEssentialMat(points1::UMat, points2::UMat, focal::Float64, pp::Point{Float64}, method::Int32, prob::Float64, threshold::Float64, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_findEssentialMat(julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(focal, Float64),julia_to_cpp(pp, Point{Float64}),julia_to_cpp(method, Int32),julia_to_cpp(prob, Float64),julia_to_cpp(threshold, Float64),julia_to_cpp(mask, UMat)))
end
...
function decomposeEssentialMat(E::Image, R1::Image, R2::Image, t::Image)
	return cpp_to_julia(jlopencv_cv_cv_decomposeEssentialMat(julia_to_cpp(E, Image),julia_to_cpp(R1, Image),julia_to_cpp(R2, Image),julia_to_cpp(t, Image)))
end
...
function decomposeEssentialMat(E::UMat, R1::UMat, R2::UMat, t::UMat)
	return cpp_to_julia(jlopencv_cv_cv_decomposeEssentialMat(julia_to_cpp(E, UMat),julia_to_cpp(R1, UMat),julia_to_cpp(R2, UMat),julia_to_cpp(t, UMat)))
end
...
function recoverPose(E::Image, points1::Image, points2::Image, cameraMatrix::Image, R::Image, t::Image, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, Image),julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(R, Image),julia_to_cpp(t, Image),julia_to_cpp(mask, Image)))
end
...
function recoverPose(E::UMat, points1::UMat, points2::UMat, cameraMatrix::UMat, R::UMat, t::UMat, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, UMat),julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(R, UMat),julia_to_cpp(t, UMat),julia_to_cpp(mask, UMat)))
end
...
function recoverPose(E::Image, points1::Image, points2::Image, R::Image, t::Image, focal::Float64, pp::Point{Float64}, mask::Image)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, Image),julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(R, Image),julia_to_cpp(t, Image),julia_to_cpp(focal, Float64),julia_to_cpp(pp, Point{Float64}),julia_to_cpp(mask, Image)))
end
...
function recoverPose(E::UMat, points1::UMat, points2::UMat, R::UMat, t::UMat, focal::Float64, pp::Point{Float64}, mask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, UMat),julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(R, UMat),julia_to_cpp(t, UMat),julia_to_cpp(focal, Float64),julia_to_cpp(pp, Point{Float64}),julia_to_cpp(mask, UMat)))
end
...
function recoverPose(E::Image, points1::Image, points2::Image, cameraMatrix::Image, distanceThresh::Float64, R::Image, t::Image, mask::Image, triangulatedPoints::Image)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, Image),julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distanceThresh, Float64),julia_to_cpp(R, Image),julia_to_cpp(t, Image),julia_to_cpp(mask, Image),julia_to_cpp(triangulatedPoints, Image)))
end
...
function recoverPose(E::UMat, points1::UMat, points2::UMat, cameraMatrix::UMat, distanceThresh::Float64, R::UMat, t::UMat, mask::UMat, triangulatedPoints::UMat)
	return cpp_to_julia(jlopencv_cv_cv_recoverPose(julia_to_cpp(E, UMat),julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distanceThresh, Float64),julia_to_cpp(R, UMat),julia_to_cpp(t, UMat),julia_to_cpp(mask, UMat),julia_to_cpp(triangulatedPoints, UMat)))
end
...
function computeCorrespondEpilines(points::Image, whichImage::Int32, F::Image, lines::Image)
	return cpp_to_julia(jlopencv_cv_cv_computeCorrespondEpilines(julia_to_cpp(points, Image),julia_to_cpp(whichImage, Int32),julia_to_cpp(F, Image),julia_to_cpp(lines, Image)))
end
...
function computeCorrespondEpilines(points::UMat, whichImage::Int32, F::UMat, lines::UMat)
	return cpp_to_julia(jlopencv_cv_cv_computeCorrespondEpilines(julia_to_cpp(points, UMat),julia_to_cpp(whichImage, Int32),julia_to_cpp(F, UMat),julia_to_cpp(lines, UMat)))
end
...
function triangulatePoints(projMatr1::Image, projMatr2::Image, projPoints1::Image, projPoints2::Image, points4D::Image)
	return cpp_to_julia(jlopencv_cv_cv_triangulatePoints(julia_to_cpp(projMatr1, Image),julia_to_cpp(projMatr2, Image),julia_to_cpp(projPoints1, Image),julia_to_cpp(projPoints2, Image),julia_to_cpp(points4D, Image)))
end
...
function triangulatePoints(projMatr1::UMat, projMatr2::UMat, projPoints1::UMat, projPoints2::UMat, points4D::UMat)
	return cpp_to_julia(jlopencv_cv_cv_triangulatePoints(julia_to_cpp(projMatr1, UMat),julia_to_cpp(projMatr2, UMat),julia_to_cpp(projPoints1, UMat),julia_to_cpp(projPoints2, UMat),julia_to_cpp(points4D, UMat)))
end
...
function correctMatches(F::Image, points1::Image, points2::Image, newPoints1::Image, newPoints2::Image)
	return cpp_to_julia(jlopencv_cv_cv_correctMatches(julia_to_cpp(F, Image),julia_to_cpp(points1, Image),julia_to_cpp(points2, Image),julia_to_cpp(newPoints1, Image),julia_to_cpp(newPoints2, Image)))
end
...
function correctMatches(F::UMat, points1::UMat, points2::UMat, newPoints1::UMat, newPoints2::UMat)
	return cpp_to_julia(jlopencv_cv_cv_correctMatches(julia_to_cpp(F, UMat),julia_to_cpp(points1, UMat),julia_to_cpp(points2, UMat),julia_to_cpp(newPoints1, UMat),julia_to_cpp(newPoints2, UMat)))
end
...
function filterSpeckles(img::Image, newVal::Float64, maxSpeckleSize::Int32, maxDiff::Float64, buf::Image)
	return cpp_to_julia(jlopencv_cv_cv_filterSpeckles(julia_to_cpp(img, Image),julia_to_cpp(newVal, Float64),julia_to_cpp(maxSpeckleSize, Int32),julia_to_cpp(maxDiff, Float64),julia_to_cpp(buf, Image)))
end
...
function filterSpeckles(img::UMat, newVal::Float64, maxSpeckleSize::Int32, maxDiff::Float64, buf::UMat)
	return cpp_to_julia(jlopencv_cv_cv_filterSpeckles(julia_to_cpp(img, UMat),julia_to_cpp(newVal, Float64),julia_to_cpp(maxSpeckleSize, Int32),julia_to_cpp(maxDiff, Float64),julia_to_cpp(buf, UMat)))
end
...
function getValidDisparityROI(roi1::Rect, roi2::Rect, minDisparity::Int32, numberOfDisparities::Int32, blockSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getValidDisparityROI(julia_to_cpp(roi1, Rect),julia_to_cpp(roi2, Rect),julia_to_cpp(minDisparity, Int32),julia_to_cpp(numberOfDisparities, Int32),julia_to_cpp(blockSize, Int32)))
end
...
function validateDisparity(disparity::Image, cost::Image, minDisparity::Int32, numberOfDisparities::Int32, disp12MaxDisp::Int32)
	return cpp_to_julia(jlopencv_cv_cv_validateDisparity(julia_to_cpp(disparity, Image),julia_to_cpp(cost, Image),julia_to_cpp(minDisparity, Int32),julia_to_cpp(numberOfDisparities, Int32),julia_to_cpp(disp12MaxDisp, Int32)))
end
...
function validateDisparity(disparity::UMat, cost::UMat, minDisparity::Int32, numberOfDisparities::Int32, disp12MaxDisp::Int32)
	return cpp_to_julia(jlopencv_cv_cv_validateDisparity(julia_to_cpp(disparity, UMat),julia_to_cpp(cost, UMat),julia_to_cpp(minDisparity, Int32),julia_to_cpp(numberOfDisparities, Int32),julia_to_cpp(disp12MaxDisp, Int32)))
end
...
function reprojectImageTo3D(disparity::Image, Q::Image, _3dImage::Image, handleMissingValues::Bool, ddepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_reprojectImageTo3D(julia_to_cpp(disparity, Image),julia_to_cpp(Q, Image),julia_to_cpp(_3dImage, Image),julia_to_cpp(handleMissingValues, Bool),julia_to_cpp(ddepth, Int32)))
end
...
function reprojectImageTo3D(disparity::UMat, Q::UMat, _3dImage::UMat, handleMissingValues::Bool, ddepth::Int32)
	return cpp_to_julia(jlopencv_cv_cv_reprojectImageTo3D(julia_to_cpp(disparity, UMat),julia_to_cpp(Q, UMat),julia_to_cpp(_3dImage, UMat),julia_to_cpp(handleMissingValues, Bool),julia_to_cpp(ddepth, Int32)))
end
...
function sampsonDistance(pt1::Image, pt2::Image, F::Image)
	return cpp_to_julia(jlopencv_cv_cv_sampsonDistance(julia_to_cpp(pt1, Image),julia_to_cpp(pt2, Image),julia_to_cpp(F, Image)))
end
sampsonDistance(pt1::Image, pt2::Image, F::Image; ) = sampsonDistance(pt1, pt2, F)

function sampsonDistance(pt1::UMat, pt2::UMat, F::UMat)
	return cpp_to_julia(jlopencv_cv_cv_sampsonDistance(julia_to_cpp(pt1, UMat),julia_to_cpp(pt2, UMat),julia_to_cpp(F, UMat)))
end
...
function estimateAffine3D(src::Image, dst::Image, out::Image, inliers::Image, ransacThreshold::Float64, confidence::Float64)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffine3D(julia_to_cpp(src, Image),julia_to_cpp(dst, Image),julia_to_cpp(out, Image),julia_to_cpp(inliers, Image),julia_to_cpp(ransacThreshold, Float64),julia_to_cpp(confidence, Float64)))
end
...
function estimateAffine3D(src::UMat, dst::UMat, out::UMat, inliers::UMat, ransacThreshold::Float64, confidence::Float64)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffine3D(julia_to_cpp(src, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(out, UMat),julia_to_cpp(inliers, UMat),julia_to_cpp(ransacThreshold, Float64),julia_to_cpp(confidence, Float64)))
end
...
function estimateAffine2D(from::Image, to::Image, inliers::Image, method::Int32, ransacReprojThreshold::Float64, maxIters::size_t, confidence::Float64, refineIters::size_t)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffine2D(julia_to_cpp(from, Image),julia_to_cpp(to, Image),julia_to_cpp(inliers, Image),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(maxIters, size_t),julia_to_cpp(confidence, Float64),julia_to_cpp(refineIters, size_t)))
end
...
function estimateAffine2D(from::UMat, to::UMat, inliers::UMat, method::Int32, ransacReprojThreshold::Float64, maxIters::size_t, confidence::Float64, refineIters::size_t)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffine2D(julia_to_cpp(from, UMat),julia_to_cpp(to, UMat),julia_to_cpp(inliers, UMat),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(maxIters, size_t),julia_to_cpp(confidence, Float64),julia_to_cpp(refineIters, size_t)))
end
...
function estimateAffinePartial2D(from::Image, to::Image, inliers::Image, method::Int32, ransacReprojThreshold::Float64, maxIters::size_t, confidence::Float64, refineIters::size_t)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffinePartial2D(julia_to_cpp(from, Image),julia_to_cpp(to, Image),julia_to_cpp(inliers, Image),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(maxIters, size_t),julia_to_cpp(confidence, Float64),julia_to_cpp(refineIters, size_t)))
end
...
function estimateAffinePartial2D(from::UMat, to::UMat, inliers::UMat, method::Int32, ransacReprojThreshold::Float64, maxIters::size_t, confidence::Float64, refineIters::size_t)
	return cpp_to_julia(jlopencv_cv_cv_estimateAffinePartial2D(julia_to_cpp(from, UMat),julia_to_cpp(to, UMat),julia_to_cpp(inliers, UMat),julia_to_cpp(method, Int32),julia_to_cpp(ransacReprojThreshold, Float64),julia_to_cpp(maxIters, size_t),julia_to_cpp(confidence, Float64),julia_to_cpp(refineIters, size_t)))
end
...
function decomposeHomographyMat(H::Image, K::Image, rotations::Array{Image, 1}, translations::Array{Image, 1}, normals::Array{Image, 1})
	return cpp_to_julia(jlopencv_cv_cv_decomposeHomographyMat(julia_to_cpp(H, Image),julia_to_cpp(K, Image),julia_to_cpp(rotations, Array{Image, 1}),julia_to_cpp(translations, Array{Image, 1}),julia_to_cpp(normals, Array{Image, 1})))
end
...
function decomposeHomographyMat(H::UMat, K::UMat, rotations::Array{UMat, 1}, translations::Array{UMat, 1}, normals::Array{UMat, 1})
	return cpp_to_julia(jlopencv_cv_cv_decomposeHomographyMat(julia_to_cpp(H, UMat),julia_to_cpp(K, UMat),julia_to_cpp(rotations, Array{UMat, 1}),julia_to_cpp(translations, Array{UMat, 1}),julia_to_cpp(normals, Array{UMat, 1})))
end
...
function filterHomographyDecompByVisibleRefpoints(rotations::Array{Image, 1}, normals::Array{Image, 1}, beforePoints::Image, afterPoints::Image, possibleSolutions::Image, pointsMask::Image)
	return cpp_to_julia(jlopencv_cv_cv_filterHomographyDecompByVisibleRefpoints(julia_to_cpp(rotations, Array{Image, 1}),julia_to_cpp(normals, Array{Image, 1}),julia_to_cpp(beforePoints, Image),julia_to_cpp(afterPoints, Image),julia_to_cpp(possibleSolutions, Image),julia_to_cpp(pointsMask, Image)))
end
...
function filterHomographyDecompByVisibleRefpoints(rotations::Array{UMat, 1}, normals::Array{UMat, 1}, beforePoints::UMat, afterPoints::UMat, possibleSolutions::UMat, pointsMask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_filterHomographyDecompByVisibleRefpoints(julia_to_cpp(rotations, Array{UMat, 1}),julia_to_cpp(normals, Array{UMat, 1}),julia_to_cpp(beforePoints, UMat),julia_to_cpp(afterPoints, UMat),julia_to_cpp(possibleSolutions, UMat),julia_to_cpp(pointsMask, UMat)))
end
...
function StereoBM_create(numDisparities::Int32, blockSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoBM_create(julia_to_cpp(numDisparities, Int32),julia_to_cpp(blockSize, Int32)))
end
...
function StereoSGBM_create(minDisparity::Int32, numDisparities::Int32, blockSize::Int32, P1::Int32, P2::Int32, disp12MaxDiff::Int32, preFilterCap::Int32, uniquenessRatio::Int32, speckleWindowSize::Int32, speckleRange::Int32, mode::Int32)
	return cpp_to_julia(jlopencv_cv_cv_StereoSGBM_create(julia_to_cpp(minDisparity, Int32),julia_to_cpp(numDisparities, Int32),julia_to_cpp(blockSize, Int32),julia_to_cpp(P1, Int32),julia_to_cpp(P2, Int32),julia_to_cpp(disp12MaxDiff, Int32),julia_to_cpp(preFilterCap, Int32),julia_to_cpp(uniquenessRatio, Int32),julia_to_cpp(speckleWindowSize, Int32),julia_to_cpp(speckleRange, Int32),julia_to_cpp(mode, Int32)))
end
...
function undistort(src::Image, cameraMatrix::Image, distCoeffs::Image, dst::Image, newCameraMatrix::Image)
	return cpp_to_julia(jlopencv_cv_cv_undistort(julia_to_cpp(src, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(dst, Image),julia_to_cpp(newCameraMatrix, Image)))
end
...
function undistort(src::UMat, cameraMatrix::UMat, distCoeffs::UMat, dst::UMat, newCameraMatrix::UMat)
	return cpp_to_julia(jlopencv_cv_cv_undistort(julia_to_cpp(src, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(newCameraMatrix, UMat)))
end
...
function initUndistortRectifyMap(cameraMatrix::Image, distCoeffs::Image, R::Image, newCameraMatrix::Image, size::Size, m1type::Int32, map1::Image, map2::Image)
	return cpp_to_julia(jlopencv_cv_cv_initUndistortRectifyMap(julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(R, Image),julia_to_cpp(newCameraMatrix, Image),julia_to_cpp(size, Size),julia_to_cpp(m1type, Int32),julia_to_cpp(map1, Image),julia_to_cpp(map2, Image)))
end
...
function initUndistortRectifyMap(cameraMatrix::UMat, distCoeffs::UMat, R::UMat, newCameraMatrix::UMat, size::Size, m1type::Int32, map1::UMat, map2::UMat)
	return cpp_to_julia(jlopencv_cv_cv_initUndistortRectifyMap(julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(R, UMat),julia_to_cpp(newCameraMatrix, UMat),julia_to_cpp(size, Size),julia_to_cpp(m1type, Int32),julia_to_cpp(map1, UMat),julia_to_cpp(map2, UMat)))
end
...
function getDefaultNewCameraMatrix(cameraMatrix::Image, imgsize::Size, centerPrincipalPoint::Bool)
	return cpp_to_julia(jlopencv_cv_cv_getDefaultNewCameraMatrix(julia_to_cpp(cameraMatrix, Image),julia_to_cpp(imgsize, Size),julia_to_cpp(centerPrincipalPoint, Bool)))
end
...
function getDefaultNewCameraMatrix(cameraMatrix::UMat, imgsize::Size, centerPrincipalPoint::Bool)
	return cpp_to_julia(jlopencv_cv_cv_getDefaultNewCameraMatrix(julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(imgsize, Size),julia_to_cpp(centerPrincipalPoint, Bool)))
end
...
function undistortPoints(src::Image, cameraMatrix::Image, distCoeffs::Image, dst::Image, R::Image, P::Image)
	return cpp_to_julia(jlopencv_cv_cv_undistortPoints(julia_to_cpp(src, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(dst, Image),julia_to_cpp(R, Image),julia_to_cpp(P, Image)))
end
...
function undistortPoints(src::UMat, cameraMatrix::UMat, distCoeffs::UMat, dst::UMat, R::UMat, P::UMat)
	return cpp_to_julia(jlopencv_cv_cv_undistortPoints(julia_to_cpp(src, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(dst, UMat),julia_to_cpp(R, UMat),julia_to_cpp(P, UMat)))
end
...
function undistortPointsIter(src::Image, cameraMatrix::Image, distCoeffs::Image, R::Image, P::Image, criteria::TermCriteria, dst::Image)
	return cpp_to_julia(jlopencv_cv_cv_undistortPoints(julia_to_cpp(src, Image),julia_to_cpp(cameraMatrix, Image),julia_to_cpp(distCoeffs, Image),julia_to_cpp(R, Image),julia_to_cpp(P, Image),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(dst, Image)))
end
...
function undistortPointsIter(src::UMat, cameraMatrix::UMat, distCoeffs::UMat, R::UMat, P::UMat, criteria::TermCriteria, dst::UMat)
	return cpp_to_julia(jlopencv_cv_cv_undistortPoints(julia_to_cpp(src, UMat),julia_to_cpp(cameraMatrix, UMat),julia_to_cpp(distCoeffs, UMat),julia_to_cpp(R, UMat),julia_to_cpp(P, UMat),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(dst, UMat)))
end
...
function BRISK_create(thresh::Int32, octaves::Int32, patternScale::Float32)
	return cpp_to_julia(jlopencv_cv_cv_BRISK_create(julia_to_cpp(thresh, Int32),julia_to_cpp(octaves, Int32),julia_to_cpp(patternScale, Float32)))
end
...
function BRISK_create(radiusList::Array{Float32, 1}, numberList::Array{Int32, 1}, dMax::Float32, dMin::Float32, indexChange::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_BRISK_create(julia_to_cpp(radiusList, Array{Float32, 1}),julia_to_cpp(numberList, Array{Int32, 1}),julia_to_cpp(dMax, Float32),julia_to_cpp(dMin, Float32),julia_to_cpp(indexChange, Array{Int32, 1})))
end
...
function BRISK_create(thresh::Int32, octaves::Int32, radiusList::Array{Float32, 1}, numberList::Array{Int32, 1}, dMax::Float32, dMin::Float32, indexChange::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_BRISK_create(julia_to_cpp(thresh, Int32),julia_to_cpp(octaves, Int32),julia_to_cpp(radiusList, Array{Float32, 1}),julia_to_cpp(numberList, Array{Int32, 1}),julia_to_cpp(dMax, Float32),julia_to_cpp(dMin, Float32),julia_to_cpp(indexChange, Array{Int32, 1})))
end
...
function ORB_create(nfeatures::Int32, scaleFactor::Float32, nlevels::Int32, edgeThreshold::Int32, firstLevel::Int32, WTA_K::Int32, scoreType::ORB_ScoreType, patchSize::Int32, fastThreshold::Int32)
	return cpp_to_julia(jlopencv_cv_cv_ORB_create(julia_to_cpp(nfeatures, Int32),julia_to_cpp(scaleFactor, Float32),julia_to_cpp(nlevels, Int32),julia_to_cpp(edgeThreshold, Int32),julia_to_cpp(firstLevel, Int32),julia_to_cpp(WTA_K, Int32),julia_to_cpp(scoreType, ORB_ScoreType),julia_to_cpp(patchSize, Int32),julia_to_cpp(fastThreshold, Int32)))
end
...
function MSER_create(_delta::Int32, _min_area::Int32, _max_area::Int32, _max_variation::Float64, _min_diversity::Float64, _max_evolution::Int32, _area_threshold::Float64, _min_margin::Float64, _edge_blur_size::Int32)
	return cpp_to_julia(jlopencv_cv_cv_MSER_create(julia_to_cpp(_delta, Int32),julia_to_cpp(_min_area, Int32),julia_to_cpp(_max_area, Int32),julia_to_cpp(_max_variation, Float64),julia_to_cpp(_min_diversity, Float64),julia_to_cpp(_max_evolution, Int32),julia_to_cpp(_area_threshold, Float64),julia_to_cpp(_min_margin, Float64),julia_to_cpp(_edge_blur_size, Int32)))
end
...
function FastFeatureDetector_create(threshold::Int32, nonmaxSuppression::Bool, type::FastFeatureDetector_DetectorType)
	return cpp_to_julia(jlopencv_cv_cv_FastFeatureDetector_create(julia_to_cpp(threshold, Int32),julia_to_cpp(nonmaxSuppression, Bool),julia_to_cpp(type, FastFeatureDetector_DetectorType)))
end
...
function AgastFeatureDetector_create(threshold::Int32, nonmaxSuppression::Bool, type::AgastFeatureDetector_DetectorType)
	return cpp_to_julia(jlopencv_cv_cv_AgastFeatureDetector_create(julia_to_cpp(threshold, Int32),julia_to_cpp(nonmaxSuppression, Bool),julia_to_cpp(type, AgastFeatureDetector_DetectorType)))
end
...
function GFTTDetector_create(maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, blockSize::Int32, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_create(julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(blockSize, Int32),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function GFTTDetector_create(maxCorners::Int32, qualityLevel::Float64, minDistance::Float64, blockSize::Int32, gradiantSize::Int32, useHarrisDetector::Bool, k::Float64)
	return cpp_to_julia(jlopencv_cv_cv_GFTTDetector_create(julia_to_cpp(maxCorners, Int32),julia_to_cpp(qualityLevel, Float64),julia_to_cpp(minDistance, Float64),julia_to_cpp(blockSize, Int32),julia_to_cpp(gradiantSize, Int32),julia_to_cpp(useHarrisDetector, Bool),julia_to_cpp(k, Float64)))
end
...
function SimpleBlobDetector_create(parameters::SimpleBlobDetector_Params)
	return cpp_to_julia(jlopencv_cv_cv_SimpleBlobDetector_create(julia_to_cpp(parameters, SimpleBlobDetector_Params)))
end
...
function KAZE_create(extended::Bool, upright::Bool, threshold::Float32, nOctaves::Int32, nOctaveLayers::Int32, diffusivity::KAZE_DiffusivityType)
	return cpp_to_julia(jlopencv_cv_cv_KAZE_create(julia_to_cpp(extended, Bool),julia_to_cpp(upright, Bool),julia_to_cpp(threshold, Float32),julia_to_cpp(nOctaves, Int32),julia_to_cpp(nOctaveLayers, Int32),julia_to_cpp(diffusivity, KAZE_DiffusivityType)))
end
...
function AKAZE_create(descriptor_type::AKAZE_DescriptorType, descriptor_size::Int32, descriptor_channels::Int32, threshold::Float32, nOctaves::Int32, nOctaveLayers::Int32, diffusivity::KAZE_DiffusivityType)
	return cpp_to_julia(jlopencv_cv_cv_AKAZE_create(julia_to_cpp(descriptor_type, AKAZE_DescriptorType),julia_to_cpp(descriptor_size, Int32),julia_to_cpp(descriptor_channels, Int32),julia_to_cpp(threshold, Float32),julia_to_cpp(nOctaves, Int32),julia_to_cpp(nOctaveLayers, Int32),julia_to_cpp(diffusivity, KAZE_DiffusivityType)))
end
...
function DescriptorMatcher_create(descriptorMatcherType::String)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_create(julia_to_cpp(descriptorMatcherType, String)))
end
...
function DescriptorMatcher_create(matcherType::DescriptorMatcher_MatcherType)
	return cpp_to_julia(jlopencv_cv_cv_DescriptorMatcher_create(julia_to_cpp(matcherType, DescriptorMatcher_MatcherType)))
end
...
function BFMatcher_create(normType::Int32, crossCheck::Bool)
	return cpp_to_julia(jlopencv_cv_cv_BFMatcher_create(julia_to_cpp(normType, Int32),julia_to_cpp(crossCheck, Bool)))
end
...
function drawKeypoints(image::Image, keypoints::Array{KeyPoint, 1}, outImage::Image, color::Scalar, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawKeypoints(julia_to_cpp(image, Image),julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(outImage, Image),julia_to_cpp(color, Scalar),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function drawKeypoints(image::UMat, keypoints::Array{KeyPoint, 1}, outImage::UMat, color::Scalar, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawKeypoints(julia_to_cpp(image, UMat),julia_to_cpp(keypoints, Array{KeyPoint, 1}),julia_to_cpp(outImage, UMat),julia_to_cpp(color, Scalar),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function drawMatches(img1::Image, keypoints1::Array{KeyPoint, 1}, img2::Image, keypoints2::Array{KeyPoint, 1}, matches1to2::Array{DMatch, 1}, outImg::Image, matchColor::Scalar, singlePointColor::Scalar, matchesMask::Array{char, 1}, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawMatches(julia_to_cpp(img1, Image),julia_to_cpp(keypoints1, Array{KeyPoint, 1}),julia_to_cpp(img2, Image),julia_to_cpp(keypoints2, Array{KeyPoint, 1}),julia_to_cpp(matches1to2, Array{DMatch, 1}),julia_to_cpp(outImg, Image),julia_to_cpp(matchColor, Scalar),julia_to_cpp(singlePointColor, Scalar),julia_to_cpp(matchesMask, Array{char, 1}),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function drawMatches(img1::UMat, keypoints1::Array{KeyPoint, 1}, img2::UMat, keypoints2::Array{KeyPoint, 1}, matches1to2::Array{DMatch, 1}, outImg::UMat, matchColor::Scalar, singlePointColor::Scalar, matchesMask::Array{char, 1}, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawMatches(julia_to_cpp(img1, UMat),julia_to_cpp(keypoints1, Array{KeyPoint, 1}),julia_to_cpp(img2, UMat),julia_to_cpp(keypoints2, Array{KeyPoint, 1}),julia_to_cpp(matches1to2, Array{DMatch, 1}),julia_to_cpp(outImg, UMat),julia_to_cpp(matchColor, Scalar),julia_to_cpp(singlePointColor, Scalar),julia_to_cpp(matchesMask, Array{char, 1}),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function drawMatchesKnn(img1::Image, keypoints1::Array{KeyPoint, 1}, img2::Image, keypoints2::Array{KeyPoint, 1}, matches1to2::Array{Array{DMatch, 1}, 1}, outImg::Image, matchColor::Scalar, singlePointColor::Scalar, matchesMask::Array{Array{char, 1}, 1}, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawMatches(julia_to_cpp(img1, Image),julia_to_cpp(keypoints1, Array{KeyPoint, 1}),julia_to_cpp(img2, Image),julia_to_cpp(keypoints2, Array{KeyPoint, 1}),julia_to_cpp(matches1to2, Array{Array{DMatch, 1}, 1}),julia_to_cpp(outImg, Image),julia_to_cpp(matchColor, Scalar),julia_to_cpp(singlePointColor, Scalar),julia_to_cpp(matchesMask, Array{Array{char, 1}, 1}),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function drawMatchesKnn(img1::UMat, keypoints1::Array{KeyPoint, 1}, img2::UMat, keypoints2::Array{KeyPoint, 1}, matches1to2::Array{Array{DMatch, 1}, 1}, outImg::UMat, matchColor::Scalar, singlePointColor::Scalar, matchesMask::Array{Array{char, 1}, 1}, flags::DrawMatchesFlags)
	return cpp_to_julia(jlopencv_cv_cv_drawMatches(julia_to_cpp(img1, UMat),julia_to_cpp(keypoints1, Array{KeyPoint, 1}),julia_to_cpp(img2, UMat),julia_to_cpp(keypoints2, Array{KeyPoint, 1}),julia_to_cpp(matches1to2, Array{Array{DMatch, 1}, 1}),julia_to_cpp(outImg, UMat),julia_to_cpp(matchColor, Scalar),julia_to_cpp(singlePointColor, Scalar),julia_to_cpp(matchesMask, Array{Array{char, 1}, 1}),julia_to_cpp(flags, DrawMatchesFlags)))
end
...
function CamShift(probImage::Image, window::Rect, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_CamShift(julia_to_cpp(probImage, Image),julia_to_cpp(window, Rect),julia_to_cpp(criteria, TermCriteria)))
end
...
function CamShift(probImage::UMat, window::Rect, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_CamShift(julia_to_cpp(probImage, UMat),julia_to_cpp(window, Rect),julia_to_cpp(criteria, TermCriteria)))
end
...
function meanShift(probImage::Image, window::Rect, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_meanShift(julia_to_cpp(probImage, Image),julia_to_cpp(window, Rect),julia_to_cpp(criteria, TermCriteria)))
end
...
function meanShift(probImage::UMat, window::Rect, criteria::TermCriteria)
	return cpp_to_julia(jlopencv_cv_cv_meanShift(julia_to_cpp(probImage, UMat),julia_to_cpp(window, Rect),julia_to_cpp(criteria, TermCriteria)))
end
...
function buildOpticalFlowPyramid(img::Image, winSize::Size, maxLevel::Int32, pyramid::Array{Image, 1}, withDerivatives::Bool, pyrBorder::Int32, derivBorder::Int32, tryReuseInputImage::Bool)
	return cpp_to_julia(jlopencv_cv_cv_buildOpticalFlowPyramid(julia_to_cpp(img, Image),julia_to_cpp(winSize, Size),julia_to_cpp(maxLevel, Int32),julia_to_cpp(pyramid, Array{Image, 1}),julia_to_cpp(withDerivatives, Bool),julia_to_cpp(pyrBorder, Int32),julia_to_cpp(derivBorder, Int32),julia_to_cpp(tryReuseInputImage, Bool)))
end
...
function buildOpticalFlowPyramid(img::UMat, winSize::Size, maxLevel::Int32, pyramid::Array{UMat, 1}, withDerivatives::Bool, pyrBorder::Int32, derivBorder::Int32, tryReuseInputImage::Bool)
	return cpp_to_julia(jlopencv_cv_cv_buildOpticalFlowPyramid(julia_to_cpp(img, UMat),julia_to_cpp(winSize, Size),julia_to_cpp(maxLevel, Int32),julia_to_cpp(pyramid, Array{UMat, 1}),julia_to_cpp(withDerivatives, Bool),julia_to_cpp(pyrBorder, Int32),julia_to_cpp(derivBorder, Int32),julia_to_cpp(tryReuseInputImage, Bool)))
end
...
function calcOpticalFlowPyrLK(prevImg::Image, nextImg::Image, prevPts::Image, nextPts::Image, status::Image, err::Image, winSize::Size, maxLevel::Int32, criteria::TermCriteria, flags::Int32, minEigThreshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_calcOpticalFlowPyrLK(julia_to_cpp(prevImg, Image),julia_to_cpp(nextImg, Image),julia_to_cpp(prevPts, Image),julia_to_cpp(nextPts, Image),julia_to_cpp(status, Image),julia_to_cpp(err, Image),julia_to_cpp(winSize, Size),julia_to_cpp(maxLevel, Int32),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(flags, Int32),julia_to_cpp(minEigThreshold, Float64)))
end
...
function calcOpticalFlowPyrLK(prevImg::UMat, nextImg::UMat, prevPts::UMat, nextPts::UMat, status::UMat, err::UMat, winSize::Size, maxLevel::Int32, criteria::TermCriteria, flags::Int32, minEigThreshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_calcOpticalFlowPyrLK(julia_to_cpp(prevImg, UMat),julia_to_cpp(nextImg, UMat),julia_to_cpp(prevPts, UMat),julia_to_cpp(nextPts, UMat),julia_to_cpp(status, UMat),julia_to_cpp(err, UMat),julia_to_cpp(winSize, Size),julia_to_cpp(maxLevel, Int32),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(flags, Int32),julia_to_cpp(minEigThreshold, Float64)))
end
...
function calcOpticalFlowFarneback(prev::Image, next::Image, flow::Image, pyr_scale::Float64, levels::Int32, winsize::Int32, iterations::Int32, poly_n::Int32, poly_sigma::Float64, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_calcOpticalFlowFarneback(julia_to_cpp(prev, Image),julia_to_cpp(next, Image),julia_to_cpp(flow, Image),julia_to_cpp(pyr_scale, Float64),julia_to_cpp(levels, Int32),julia_to_cpp(winsize, Int32),julia_to_cpp(iterations, Int32),julia_to_cpp(poly_n, Int32),julia_to_cpp(poly_sigma, Float64),julia_to_cpp(flags, Int32)))
end
...
function calcOpticalFlowFarneback(prev::UMat, next::UMat, flow::UMat, pyr_scale::Float64, levels::Int32, winsize::Int32, iterations::Int32, poly_n::Int32, poly_sigma::Float64, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_calcOpticalFlowFarneback(julia_to_cpp(prev, UMat),julia_to_cpp(next, UMat),julia_to_cpp(flow, UMat),julia_to_cpp(pyr_scale, Float64),julia_to_cpp(levels, Int32),julia_to_cpp(winsize, Int32),julia_to_cpp(iterations, Int32),julia_to_cpp(poly_n, Int32),julia_to_cpp(poly_sigma, Float64),julia_to_cpp(flags, Int32)))
end
...
function computeECC(templateImage::Image, inputImage::Image, inputMask::Image)
	return cpp_to_julia(jlopencv_cv_cv_computeECC(julia_to_cpp(templateImage, Image),julia_to_cpp(inputImage, Image),julia_to_cpp(inputMask, Image)))
end
...
function computeECC(templateImage::UMat, inputImage::UMat, inputMask::UMat)
	return cpp_to_julia(jlopencv_cv_cv_computeECC(julia_to_cpp(templateImage, UMat),julia_to_cpp(inputImage, UMat),julia_to_cpp(inputMask, UMat)))
end
...
function findTransformECC(templateImage::Image, inputImage::Image, warpMatrix::Image, motionType::Int32, criteria::TermCriteria, inputMask::Image, gaussFiltSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findTransformECC(julia_to_cpp(templateImage, Image),julia_to_cpp(inputImage, Image),julia_to_cpp(warpMatrix, Image),julia_to_cpp(motionType, Int32),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(inputMask, Image),julia_to_cpp(gaussFiltSize, Int32)))
end
...
function findTransformECC(templateImage::UMat, inputImage::UMat, warpMatrix::UMat, motionType::Int32, criteria::TermCriteria, inputMask::UMat, gaussFiltSize::Int32)
	return cpp_to_julia(jlopencv_cv_cv_findTransformECC(julia_to_cpp(templateImage, UMat),julia_to_cpp(inputImage, UMat),julia_to_cpp(warpMatrix, UMat),julia_to_cpp(motionType, Int32),julia_to_cpp(criteria, TermCriteria),julia_to_cpp(inputMask, UMat),julia_to_cpp(gaussFiltSize, Int32)))
end
...
function readOpticalFlow(path::String)
	return cpp_to_julia(jlopencv_cv_cv_readOpticalFlow(julia_to_cpp(path, String)))
end
readOpticalFlow(path::String; ) = readOpticalFlow(path)

function writeOpticalFlow(path::String, flow::Image)
	return cpp_to_julia(jlopencv_cv_cv_writeOpticalFlow(julia_to_cpp(path, String),julia_to_cpp(flow, Image)))
end
writeOpticalFlow(path::String, flow::Image; ) = writeOpticalFlow(path, flow)

function writeOpticalFlow(path::String, flow::UMat)
	return cpp_to_julia(jlopencv_cv_cv_writeOpticalFlow(julia_to_cpp(path, String),julia_to_cpp(flow, UMat)))
end
...
function FarnebackOpticalFlow_create(numLevels::Int32, pyrScale::Float64, fastPyramids::Bool, winSize::Int32, numIters::Int32, polyN::Int32, polySigma::Float64, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_FarnebackOpticalFlow_create(julia_to_cpp(numLevels, Int32),julia_to_cpp(pyrScale, Float64),julia_to_cpp(fastPyramids, Bool),julia_to_cpp(winSize, Int32),julia_to_cpp(numIters, Int32),julia_to_cpp(polyN, Int32),julia_to_cpp(polySigma, Float64),julia_to_cpp(flags, Int32)))
end
...
function DISOpticalFlow_create(preset::Int32)
	return cpp_to_julia(jlopencv_cv_cv_DISOpticalFlow_create(julia_to_cpp(preset, Int32)))
end
...
function SparsePyrLKOpticalFlow_create(winSize::Size, maxLevel::Int32, crit::TermCriteria, flags::Int32, minEigThreshold::Float64)
	return cpp_to_julia(jlopencv_cv_cv_SparsePyrLKOpticalFlow_create(julia_to_cpp(winSize, Size),julia_to_cpp(maxLevel, Int32),julia_to_cpp(crit, TermCriteria),julia_to_cpp(flags, Int32),julia_to_cpp(minEigThreshold, Float64)))
end
...
function createBackgroundSubtractorMOG2(history::Int32, varThreshold::Float64, detectShadows::Bool)
	return cpp_to_julia(jlopencv_cv_cv_createBackgroundSubtractorMOG2(julia_to_cpp(history, Int32),julia_to_cpp(varThreshold, Float64),julia_to_cpp(detectShadows, Bool)))
end
...
function createBackgroundSubtractorKNN(history::Int32, dist2Threshold::Float64, detectShadows::Bool)
	return cpp_to_julia(jlopencv_cv_cv_createBackgroundSubtractorKNN(julia_to_cpp(history, Int32),julia_to_cpp(dist2Threshold, Float64),julia_to_cpp(detectShadows, Bool)))
end
...
function groupRectangles(rectList::Array{Rect, 1}, groupThreshold::Int32, eps::Float64)
	return cpp_to_julia(jlopencv_cv_cv_groupRectangles(julia_to_cpp(rectList, Array{Rect, 1}),julia_to_cpp(groupThreshold, Int32),julia_to_cpp(eps, Float64)))
end
...
function CascadeClassifier_convert(oldcascade::String, newcascade::String)
	return cpp_to_julia(jlopencv_cv_cv_CascadeClassifier_convert(julia_to_cpp(oldcascade, String),julia_to_cpp(newcascade, String)))
end
...
function imread(filename::String, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_imread(julia_to_cpp(filename, String),julia_to_cpp(flags, Int32)))
end
...
function imreadmulti(filename::String, mats::Array{Image, 1}, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_imreadmulti(julia_to_cpp(filename, String),julia_to_cpp(mats, Array{Image, 1}),julia_to_cpp(flags, Int32)))
end
...
function imwrite(filename::String, img::Image, params::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_imwrite(julia_to_cpp(filename, String),julia_to_cpp(img, Image),julia_to_cpp(params, Array{Int32, 1})))
end
...
function imwrite(filename::String, img::UMat, params::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_imwrite(julia_to_cpp(filename, String),julia_to_cpp(img, UMat),julia_to_cpp(params, Array{Int32, 1})))
end
...
function imdecode(buf::Image, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_imdecode(julia_to_cpp(buf, Image),julia_to_cpp(flags, Int32)))
end
imdecode(buf::Image, flags::Int32; ) = imdecode(buf, flags)

function imdecode(buf::UMat, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_imdecode(julia_to_cpp(buf, UMat),julia_to_cpp(flags, Int32)))
end
imdecode(buf::UMat, flags::Int32; ) = imdecode(buf, flags)

function imencode(ext::String, img::Image, params::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_imencode(julia_to_cpp(ext, String),julia_to_cpp(img, Image),julia_to_cpp(params, Array{Int32, 1})))
end
...
function imencode(ext::String, img::UMat, params::Array{Int32, 1})
	return cpp_to_julia(jlopencv_cv_cv_imencode(julia_to_cpp(ext, String),julia_to_cpp(img, UMat),julia_to_cpp(params, Array{Int32, 1})))
end
...
function haveImageReader(filename::String)
	return cpp_to_julia(jlopencv_cv_cv_haveImageReader(julia_to_cpp(filename, String)))
end
haveImageReader(filename::String; ) = haveImageReader(filename)

function haveImageWriter(filename::String)
	return cpp_to_julia(jlopencv_cv_cv_haveImageWriter(julia_to_cpp(filename, String)))
end
haveImageWriter(filename::String; ) = haveImageWriter(filename)

function VideoWriter_fourcc(c1::char, c2::char, c3::char, c4::char)
	return cpp_to_julia(jlopencv_cv_cv_VideoWriter_fourcc(julia_to_cpp(c1, char),julia_to_cpp(c2, char),julia_to_cpp(c3, char),julia_to_cpp(c4, char)))
end
...
function namedWindow(winname::String, flags::Int32)
	return cpp_to_julia(jlopencv_cv_cv_namedWindow(julia_to_cpp(winname, String),julia_to_cpp(flags, Int32)))
end
namedWindow(winname::String; flags::Int32 = WINDOW_AUTOSIZE) = namedWindow(winname, flags)

function destroyWindow(winname::String)
	return cpp_to_julia(jlopencv_cv_cv_destroyWindow(julia_to_cpp(winname, String)))
end
...
function waitKeyEx(delay::Int32)
	return cpp_to_julia(jlopencv_cv_cv_waitKeyEx(julia_to_cpp(delay, Int32)))
end
waitKeyEx(; delay::Int32 = 0) = waitKeyEx(delay)

function waitKey(delay::Int32)
	return cpp_to_julia(jlopencv_cv_cv_waitKey(julia_to_cpp(delay, Int32)))
end
waitKey(; delay::Int32 = 0) = waitKey(delay)

function imshow(winname::String, mat::Image)
	return cpp_to_julia(jlopencv_cv_cv_imshow(julia_to_cpp(winname, String),julia_to_cpp(mat, Image)))
end
imshow(winname::String, mat::Image; ) = imshow(winname, mat)

function imshow(winname::String, mat::UMat)
	return cpp_to_julia(jlopencv_cv_cv_imshow(julia_to_cpp(winname, String),julia_to_cpp(mat, UMat)))
end
imshow(winname::String, mat::UMat; ) = imshow(winname, mat)

function resizeWindow(winname::String, width::Int32, height::Int32)
	return cpp_to_julia(jlopencv_cv_cv_resizeWindow(julia_to_cpp(winname, String),julia_to_cpp(width, Int32),julia_to_cpp(height, Int32)))
end
...
function resizeWindow(winname::String, size::Size)
	return cpp_to_julia(jlopencv_cv_cv_resizeWindow(julia_to_cpp(winname, String),julia_to_cpp(size, Size)))
end
resizeWindow(winname::String, size::Size; ) = resizeWindow(winname, size)

function moveWindow(winname::String, x::Int32, y::Int32)
	return cpp_to_julia(jlopencv_cv_cv_moveWindow(julia_to_cpp(winname, String),julia_to_cpp(x, Int32),julia_to_cpp(y, Int32)))
end
...
function setWindowProperty(winname::String, prop_id::Int32, prop_value::Float64)
	return cpp_to_julia(jlopencv_cv_cv_setWindowProperty(julia_to_cpp(winname, String),julia_to_cpp(prop_id, Int32),julia_to_cpp(prop_value, Float64)))
end
...
function setWindowTitle(winname::String, title::String)
	return cpp_to_julia(jlopencv_cv_cv_setWindowTitle(julia_to_cpp(winname, String),julia_to_cpp(title, String)))
end
...
function getWindowProperty(winname::String, prop_id::Int32)
	return cpp_to_julia(jlopencv_cv_cv_getWindowProperty(julia_to_cpp(winname, String),julia_to_cpp(prop_id, Int32)))
end
...
function getWindowImageRect(winname::String)
	return cpp_to_julia(jlopencv_cv_cv_getWindowImageRect(julia_to_cpp(winname, String)))
end
...
function selectROI(windowName::String, img::Image, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROI(julia_to_cpp(windowName, String),julia_to_cpp(img, Image),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function selectROI(windowName::String, img::UMat, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROI(julia_to_cpp(windowName, String),julia_to_cpp(img, UMat),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function selectROI(img::Image, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROI(julia_to_cpp(img, Image),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function selectROI(img::UMat, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROI(julia_to_cpp(img, UMat),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function selectROIs(windowName::String, img::Image, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROIs(julia_to_cpp(windowName, String),julia_to_cpp(img, Image),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function selectROIs(windowName::String, img::UMat, showCrosshair::Bool, fromCenter::Bool)
	return cpp_to_julia(jlopencv_cv_cv_selectROIs(julia_to_cpp(windowName, String),julia_to_cpp(img, UMat),julia_to_cpp(showCrosshair, Bool),julia_to_cpp(fromCenter, Bool)))
end
...
function getTrackbarPos(trackbarname::String, winname::String)
	return cpp_to_julia(jlopencv_cv_cv_getTrackbarPos(julia_to_cpp(trackbarname, String),julia_to_cpp(winname, String)))
end
...
function setTrackbarPos(trackbarname::String, winname::String, pos::Int32)
	return cpp_to_julia(jlopencv_cv_cv_setTrackbarPos(julia_to_cpp(trackbarname, String),julia_to_cpp(winname, String),julia_to_cpp(pos, Int32)))
end
...
function setTrackbarMax(trackbarname::String, winname::String, maxval::Int32)
	return cpp_to_julia(jlopencv_cv_cv_setTrackbarMax(julia_to_cpp(trackbarname, String),julia_to_cpp(winname, String),julia_to_cpp(maxval, Int32)))
end
...
function setTrackbarMin(trackbarname::String, winname::String, minval::Int32)
	return cpp_to_julia(jlopencv_cv_cv_setTrackbarMin(julia_to_cpp(trackbarname, String),julia_to_cpp(winname, String),julia_to_cpp(minval, Int32)))
end
...
function addText(img::Image, text::String, org::Point{Int32}, nameFont::String, pointSize::Int32, color::Scalar, weight::Int32, style::Int32, spacing::Int32)
	return cpp_to_julia(jlopencv_cv_cv_addText(julia_to_cpp(img, Image),julia_to_cpp(text, String),julia_to_cpp(org, Point{Int32}),julia_to_cpp(nameFont, String),julia_to_cpp(pointSize, Int32),julia_to_cpp(color, Scalar),julia_to_cpp(weight, Int32),julia_to_cpp(style, Int32),julia_to_cpp(spacing, Int32)))
end
...
function displayOverlay(winname::String, text::String, delayms::Int32)
	return cpp_to_julia(jlopencv_cv_cv_displayOverlay(julia_to_cpp(winname, String),julia_to_cpp(text, String),julia_to_cpp(delayms, Int32)))
end
...
function displayStatusBar(winname::String, text::String, delayms::Int32)
	return cpp_to_julia(jlopencv_cv_cv_displayStatusBar(julia_to_cpp(winname, String),julia_to_cpp(text, String),julia_to_cpp(delayms, Int32)))
end
