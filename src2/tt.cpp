...
mod.add_type<cv::flann::Index>("flann_Index");
    ...
    mod.add_bits<cv::flann::FlannIndexType>("FlannIndexType", jlcxx::julia_type("CppEnum"));   mod.add_type<cvflann::flann_distance_t>("cvflann::flann_distance_t");
