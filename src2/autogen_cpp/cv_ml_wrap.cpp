...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_StatModel_cv_ml_StatModel_calcError",  [](cv::Ptr<cv::ml::StatModel>& cobj, Ptr<TrainData>& data, bool& test, Mat& resp) {Mat resp; auto retval = cobj->calcError(data, test, resp);  return make_tuple(move(retval),move(resp));});
    mod.method("jlopencv_cv_ml_cv_ml_StatModel_cv_ml_StatModel_calcError",  [](cv::Ptr<cv::ml::StatModel>& cobj, Ptr<TrainData>& data, bool& test, UMat& resp) {UMat resp; auto retval = cobj->calcError(data, test, resp);  return make_tuple(move(retval),move(resp));});
    mod.method("jlopencv_cv_ml_cv_ml_StatModel_cv_ml_StatModel_predict",  [](cv::Ptr<cv::ml::StatModel>& cobj, Mat& samples, Mat& results, int& flags) {Mat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});
    mod.method("jlopencv_cv_ml_cv_ml_StatModel_cv_ml_StatModel_predict",  [](cv::Ptr<cv::ml::StatModel>& cobj, UMat& samples, UMat& results, int& flags) {UMat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});

;
    mod.method("jlopencv_cv_ml_cv_ml_NormalBayesClassifier_cv_ml_NormalBayesClassifier_predictProb",  [](cv::Ptr<cv::ml::NormalBayesClassifier>& cobj, Mat& inputs, Mat& outputs, Mat& outputProbs, int& flags) {Mat outputs;Mat outputProbs; auto retval = cobj->predictProb(inputs, outputs, outputProbs, flags);  return make_tuple(move(retval),move(outputs),move(outputProbs));});
    mod.method("jlopencv_cv_ml_cv_ml_NormalBayesClassifier_cv_ml_NormalBayesClassifier_predictProb",  [](cv::Ptr<cv::ml::NormalBayesClassifier>& cobj, UMat& inputs, UMat& outputs, UMat& outputProbs, int& flags) {UMat outputs;UMat outputProbs; auto retval = cobj->predictProb(inputs, outputs, outputProbs, flags);  return make_tuple(move(retval),move(outputs),move(outputProbs));});
...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_SVM_cv_ml_SVM_getDecisionFunction",  [](cv::Ptr<cv::ml::SVM>& cobj, int& i, Mat& alpha, Mat& svidx) {Mat alpha;Mat svidx; auto retval = cobj->getDecisionFunction(i, alpha, svidx);  return make_tuple(move(retval),move(alpha),move(svidx));});
    mod.method("jlopencv_cv_ml_cv_ml_SVM_cv_ml_SVM_getDecisionFunction",  [](cv::Ptr<cv::ml::SVM>& cobj, int& i, UMat& alpha, UMat& svidx) {UMat alpha;UMat svidx; auto retval = cobj->getDecisionFunction(i, alpha, svidx);  return make_tuple(move(retval),move(alpha),move(svidx));});
...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_getCovs",  [](cv::Ptr<cv::ml::EM>& cobj, vector<Mat>& covs) {vector<Mat> covs; cobj->getCovs(covs);  return covs;});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_getCovs",  [](cv::Ptr<cv::ml::EM>& cobj, vector<Mat>& covs) {vector<Mat> covs; cobj->getCovs(covs);  return covs;});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_predict",  [](cv::Ptr<cv::ml::EM>& cobj, Mat& samples, Mat& results, int& flags) {Mat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_predict",  [](cv::Ptr<cv::ml::EM>& cobj, UMat& samples, UMat& results, int& flags) {UMat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_predict2",  [](cv::Ptr<cv::ml::EM>& cobj, Mat& sample, Mat& probs) {Mat probs; auto retval = cobj->predict2(sample, probs);  return make_tuple(move(retval),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_predict2",  [](cv::Ptr<cv::ml::EM>& cobj, UMat& sample, UMat& probs) {UMat probs; auto retval = cobj->predict2(sample, probs);  return make_tuple(move(retval),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainEM",  [](cv::Ptr<cv::ml::EM>& cobj, Mat& samples, Mat& logLikelihoods, Mat& labels, Mat& probs) {Mat logLikelihoods;Mat labels;Mat probs; auto retval = cobj->trainEM(samples, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainEM",  [](cv::Ptr<cv::ml::EM>& cobj, UMat& samples, UMat& logLikelihoods, UMat& labels, UMat& probs) {UMat logLikelihoods;UMat labels;UMat probs; auto retval = cobj->trainEM(samples, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainE",  [](cv::Ptr<cv::ml::EM>& cobj, Mat& samples, Mat& means0, Mat& covs0, Mat& weights0, Mat& logLikelihoods, Mat& labels, Mat& probs) {Mat covs0;Mat weights0;Mat logLikelihoods;Mat labels;Mat probs; auto retval = cobj->trainE(samples, means0, covs0, weights0, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainE",  [](cv::Ptr<cv::ml::EM>& cobj, UMat& samples, UMat& means0, UMat& covs0, UMat& weights0, UMat& logLikelihoods, UMat& labels, UMat& probs) {UMat covs0;UMat weights0;UMat logLikelihoods;UMat labels;UMat probs; auto retval = cobj->trainE(samples, means0, covs0, weights0, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainM",  [](cv::Ptr<cv::ml::EM>& cobj, Mat& samples, Mat& probs0, Mat& logLikelihoods, Mat& labels, Mat& probs) {Mat logLikelihoods;Mat labels;Mat probs; auto retval = cobj->trainM(samples, probs0, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
    mod.method("jlopencv_cv_ml_cv_ml_EM_cv_ml_EM_trainM",  [](cv::Ptr<cv::ml::EM>& cobj, UMat& samples, UMat& probs0, UMat& logLikelihoods, UMat& labels, UMat& probs) {UMat logLikelihoods;UMat labels;UMat probs; auto retval = cobj->trainM(samples, probs0, logLikelihoods, labels, probs);  return make_tuple(move(retval),move(logLikelihoods),move(labels),move(probs));});
...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_RTrees_cv_ml_RTrees_getVotes",  [](cv::Ptr<cv::ml::RTrees>& cobj, Mat& samples, int& flags, Mat& results) {Mat results; cobj->getVotes(samples, results, flags);  return results;});
    mod.method("jlopencv_cv_ml_cv_ml_RTrees_cv_ml_RTrees_getVotes",  [](cv::Ptr<cv::ml::RTrees>& cobj, UMat& samples, int& flags, UMat& results) {UMat results; cobj->getVotes(samples, results, flags);  return results;});
...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_LogisticRegression_cv_ml_LogisticRegression_predict",  [](cv::Ptr<cv::ml::LogisticRegression>& cobj, Mat& samples, Mat& results, int& flags) {Mat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});
    mod.method("jlopencv_cv_ml_cv_ml_LogisticRegression_cv_ml_LogisticRegression_predict",  [](cv::Ptr<cv::ml::LogisticRegression>& cobj, UMat& samples, UMat& results, int& flags) {UMat results; auto retval = cobj->predict(samples, results, flags);  return make_tuple(move(retval),move(results));});
...
;
    ...
    mod.method("jlopencv_cv_ml_cv_ml_TrainData_getSubMatrix",  [](Mat& matrix, Mat& idx, int& layout) { auto retval = cv::ml::TrainData::getSubMatrix(matrix, idx, layout); return retval;});
    mod.method("jlopencv_cv_ml_cv_ml_TrainData_create",  [](Mat& samples, int& layout, Mat& responses, Mat& varIdx, Mat& sampleIdx, Mat& sampleWeights, Mat& varType) {Mat varIdx;Mat sampleIdx;Mat sampleWeights;Mat varType; auto retval = cv::ml::TrainData::create(samples, layout, responses, varIdx, sampleIdx, sampleWeights, varType); return retval;});
    mod.method("jlopencv_cv_ml_cv_ml_TrainData_create",  [](UMat& samples, int& layout, UMat& responses, UMat& varIdx, UMat& sampleIdx, UMat& sampleWeights, UMat& varType) {UMat varIdx;UMat sampleIdx;UMat sampleWeights;UMat varType; auto retval = cv::ml::TrainData::create(samples, layout, responses, varIdx, sampleIdx, sampleWeights, varType); return retval;});
