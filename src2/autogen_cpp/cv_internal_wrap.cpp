...
mod.add_type<cv::ocl::Device>("Device");
    ...
    mod.add_bits<cv::ocl::OclVectorStrategy>("OclVectorStrategy", jlcxx::julia_type("CppEnum"));mod.method("Device", []() {  return jlcxx::create<cv::ocl::Device>();});
...
using namespace cv::internal;
    mod.set_const("vectorRMatOP", vector_Mat());
    mod.set_const("ORBggHARRISRSCORE", ORB::HARRIS_SCORE);
    mod.set_const("FastFeatureDetectorggTYPERfRXc", FastFeatureDetector::TYPE_9_16);
    mod.set_const("morphologyDefaultBorderValueOP", morphologyDefaultBorderValue());
    mod.set_const("DISOpticalFlowggPRESETRFAST", DISOpticalFlow::PRESET_FAST);
    mod.set_const("SVMgggetDefaultGridPtrOSVMggDEGREEP", SVM::getDefaultGridPtr(SVM::DEGREE));
    mod.set_const("SimpleBlobDetectorggcreateOP", SimpleBlobDetector::create());
    mod.set_const("TermCriteriaOTermCriteriaggCOUNTRTermCriteriaggEPSSGZWSGXeTcP", TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 1e-6));
    mod.set_const("SearchParamsOP", SearchParams());
    mod.set_const("HOGDescriptorggLYHys", HOGDescriptor::L2Hys);
    mod.set_const("UMatOP", UMat());
    mod.set_const("ScalarggallOTXP", Scalar::all(-1));
    mod.set_const("ScalarOXP", Scalar(1));
    mod.set_const("SizeOP", Size());
    mod.set_const("SVMSGDggSOFTRMARGIN", SVMSGD::SOFT_MARGIN);
    mod.set_const("HOGDescriptorggDEFAULTRNLEVELS", HOGDescriptor::DEFAULT_NLEVELS);
    mod.set_const("fisheyeggCALIBRFIXRINTRINSIC", fisheye::CALIB_FIX_INTRINSIC);
    mod.set_const("makePtriflannggSearchParamskOP", makePtr<flann::SearchParams>());
    mod.set_const("stdggvectoriintkOP", std::vector<int>());
    mod.set_const("SizeOYXSYXP", Size(21,21));
    mod.set_const("PointYdOWSGWP", Point2d(0, 0));
    mod.set_const("SizeOeSGeP", Size(8, 8));
    mod.set_const("AKAZEggDESCRIPTORRMLDB", AKAZE::DESCRIPTOR_MLDB);
    mod.set_const("TermCriteriaOP", TermCriteria());
    mod.set_const("PointOTXSTXP", Point(-1,-1));
    mod.set_const("makePtriflannggKDTreeIndexParamskOP", makePtr<flann::KDTreeIndexParams>());
    mod.set_const("StereoSGBMggMODERSGBM", StereoSGBM::MODE_SGBM);
    mod.set_const("TermCriteriaOTermCriteriaggCOUNTGRGTermCriteriaggEPSSGXWWSGDBLREPSILONP", TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, DBL_EPSILON));
    mod.set_const("SVMgggetDefaultGridPtrOSVMggCP", SVM::getDefaultGridPtr(SVM::C));
    mod.set_const("ScalarOP", Scalar());
    mod.set_const("StringOP", String());
    mod.set_const("SVMgggetDefaultGridPtrOSVMggNUP", SVM::getDefaultGridPtr(SVM::NU));
    mod.set_const("cvggMatOP", cv::Mat());
    mod.set_const("TermCriteriaOTermCriteriaggCOUNTRTermCriteriaggEPSSGZWSGWUWXP", TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 0.01));
    mod.set_const("cvflannggFLANNRDISTRLY", cvflann::FLANN_DIST_L2);
    mod.set_const("DrawMatchesFlagsggDEFAULT", DrawMatchesFlags::DEFAULT);
    mod.set_const("PtrifloatkOP", Ptr<float>());
    mod.set_const("SVMSGDggASGD", SVMSGD::ASGD);
    mod.set_const("PointOP", Point());
    mod.set_const("TermCriteriaOTermCriteriaggEPSGRGTermCriteriaggCOUNTSGYWSGFLTREPSILONP", TermCriteria(TermCriteria::EPS + TermCriteria::COUNT, 20, FLT_EPSILON));
    mod.set_const("stdggvectoristdggvectoricharkGkOP", std::vector<std::vector<char> >());
    mod.set_const("AgastFeatureDetectorggOASTRfRXc", AgastFeatureDetector::OAST_9_16);
    mod.set_const("PointOTXSGTXP", Point(-1, -1));
    mod.set_const("SVMgggetDefaultGridPtrOSVMggCOEFP", SVM::getDefaultGridPtr(SVM::COEF));
    mod.set_const("ScalarggallOWP", Scalar::all(0));
    mod.set_const("SizeOYXSGYXP", Size(21, 21));
    mod.set_const("vectorRUMatOP", vector_UMat());
    mod.set_const("stdggvectoricharkOP", std::vector<char>());
    mod.set_const("stdggvectoriPointkOP", std::vector<Point>());
    mod.set_const("cvggUMatOP", cv::UMat());
    mod.set_const("TermCriteriaOTermCriteriaggMAXRITERRTermCriteriaggEPSSbSXP", TermCriteria(TermCriteria::MAX_ITER+TermCriteria::EPS,5,1));
    mod.set_const("TermCriteriaOGTermCriteriaggCOUNTGRGTermCriteriaggEPSSGZWSGDBLREPSILONP", TermCriteria( TermCriteria::COUNT + TermCriteria::EPS, 30, DBL_EPSILON));
    mod.set_const("MatOP", Mat());
    mod.set_const("SVMgggetDefaultGridPtrOSVMggPP", SVM::getDefaultGridPtr(SVM::P));
    mod.set_const("SimpleBlobDetectorggParamsOP", SimpleBlobDetector::Params());
    mod.set_const("KAZEggDIFFRPMRGY", KAZE::DIFF_PM_G2);
    mod.set_const("SVMgggetDefaultGridPtrOSVMggGAMMAP", SVM::getDefaultGridPtr(SVM::GAMMA));
}
