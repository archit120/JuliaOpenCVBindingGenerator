...
;
    ...
    mod.method("jlopencv_cv_Algorithm_getDefaultName",  [](Algorithm& cobj) { auto retval = cobj.cv::Algorithm::getDefaultName();  return retval;});mod.method("KeyPoint", []() {return jlcxx::create<cv::KeyPoint>();});mod.method("KeyPoint", [](float& x, float& y, float& _size, float& _angle, float& _response, int& _octave, int& _class_id) {return jlcxx::create<cv::KeyPoint>(x ,y ,_size ,_angle ,_response ,_octave ,_class_id);});
...
mod.method("jlopencv_KeyPoint_get_class_id", [](const cv::KeyPoint &cobj) {return cobj.class_id;});;
    ...
    mod.method("jlopencv_cv_KeyPoint_overlap",  [](KeyPoint& kp1, KeyPoint& kp2) { auto retval = cv::KeyPoint::overlap(kp1, kp2); return retval;});mod.method("DMatch", []() {return jlcxx::create<cv::DMatch>();});mod.method("DMatch", [](int& _queryIdx, int& _trainIdx, float& _distance) {return jlcxx::create<cv::DMatch>(_queryIdx ,_trainIdx ,_distance);});mod.method("DMatch", [](int& _queryIdx, int& _trainIdx, int& _imgIdx, float& _distance) {return jlcxx::create<cv::DMatch>(_queryIdx ,_trainIdx ,_imgIdx ,_distance);});
...
;
    ...
    mod.method("jlopencv_cv_CLAHE_collectGarbage",  [](cv::Ptr<CLAHE>& cobj) { cobj->cv::CLAHE::collectGarbage();  ;});mod.method("Subdiv2D", []() {return jlcxx::create<cv::Subdiv2D>();});mod.method("Subdiv2D", [](Rect& rect) {return jlcxx::create<cv::Subdiv2D>(rect);});
...
;
    ...
    mod.method("jlopencv_cv_LineSegmentDetector_compareSegments",  [](cv::Ptr<LineSegmentDetector>& cobj, Size& size, UMat& lines1, UMat& lines2, UMat& _image) { auto retval = cobj->cv::LineSegmentDetector::compareSegments(size, lines1, lines2, _image);  return make_tuple<int,UMat>(move(retval),move(_image));});mod.method("CirclesGridFinderParameters", []() {return jlcxx::create<cv::CirclesGridFinderParameters>();});
...
;
    ...
    mod.method("jlopencv_cv_SimpleBlobDetector_getDefaultName",  [](cv::Ptr<SimpleBlobDetector>& cobj) { auto retval = cobj->cv::SimpleBlobDetector::getDefaultName();  return retval;});mod.method("SimpleBlobDetector_Params", []() {return jlcxx::create<cv::SimpleBlobDetector::Params>();});
...
;
    ...
    mod.method("jlopencv_cv_DescriptorMatcher_create",  [](DescriptorMatcher_MatcherType& matcherType) { auto retval = cv::DescriptorMatcher::create(matcherType); return retval;});mod.method("BFMatcher", [](int& normType, bool& crossCheck) {return jlcxx::create<cv::BFMatcher>(normType ,crossCheck);});

;
    mod.method("jlopencv_cv_BFMatcher_create",  [](int& normType, bool& crossCheck) { auto retval = cv::BFMatcher::create(normType, crossCheck); return retval;});mod.method("FlannBasedMatcher", [](Ptr<flann_IndexParams>& indexParams, Ptr<flann_SearchParams>& searchParams) {return jlcxx::create<cv::FlannBasedMatcher>(indexParams ,searchParams);});
...
;
    ...
    mod.method("jlopencv_cv_BOWTrainer_cluster",  [](BOWTrainer& cobj, Mat& descriptors) { auto retval = cobj.cv::BOWTrainer::cluster(descriptors);  return retval;});mod.method("BOWKMeansTrainer", [](int& clusterCount, TermCriteria& termcrit, int& attempts, int& flags) {return jlcxx::create<cv::BOWKMeansTrainer>(clusterCount ,termcrit ,attempts ,flags);});
...
;
    ...
    mod.method("jlopencv_cv_BOWKMeansTrainer_cluster",  [](BOWKMeansTrainer& cobj, Mat& descriptors) { auto retval = cobj.cv::BOWKMeansTrainer::cluster(descriptors);  return retval;});mod.method("BOWImgDescriptorExtractor", [](Ptr<DescriptorExtractor>& dextractor, Ptr<DescriptorMatcher>& dmatcher) {return jlcxx::create<cv::BOWImgDescriptorExtractor>(dextractor ,dmatcher);});
...
;
    ...
    mod.method("jlopencv_cv_CascadeClassifier_convert",  [](string& oldcascade, string& newcascade) { auto retval = cv::CascadeClassifier::convert(oldcascade, newcascade); return retval;});mod.method("HOGDescriptor", []() {return jlcxx::create<cv::HOGDescriptor>();});mod.method("HOGDescriptor", [](Size& _winSize, Size& _blockSize, Size& _blockStride, Size& _cellSize, int& _nbins, int& _derivAperture, double& _winSigma, HOGDescriptor_HistogramNormType& _histogramNormType, double& _L2HysThreshold, bool& _gammaCorrection, int& _nlevels, bool& _signedGradient) {return jlcxx::create<cv::HOGDescriptor>(_winSize ,_blockSize ,_blockStride ,_cellSize ,_nbins ,_derivAperture ,_winSigma ,_histogramNormType ,_L2HysThreshold ,_gammaCorrection ,_nlevels ,_signedGradient);});mod.method("HOGDescriptor", [](string& filename) {return jlcxx::create<cv::HOGDescriptor>(filename);});
...
mod.method("jlopencv_HOGDescriptor_get_signedGradient", [](const cv::HOGDescriptor &cobj) {return cobj.signedGradient;});;
    ...
    mod.method("jlopencv_cv_HOGDescriptor_getDaimlerPeopleDetector",  []() { auto retval = cv::HOGDescriptor::getDaimlerPeopleDetector(); return retval;});mod.method("QRCodeDetector", []() {return jlcxx::create<cv::QRCodeDetector>();});
...
;
    ...
    mod.method("jlopencv_cv_findChessboardCornersSBWithMeta",  [](Mat& image, Size& patternSize, int& flags, Mat& corners, Mat& meta) { auto retval = cv::findChessboardCornersSB(image, patternSize, corners, flags, meta); return make_tuple<bool,Mat,Mat>(move(retval),move(corners),move(meta));});
    mod.method("jlopencv_cv_findChessboardCornersSBWithMeta",  [](UMat& image, Size& patternSize, int& flags, UMat& corners, UMat& meta) { auto retval = cv::findChessboardCornersSB(image, patternSize, corners, flags, meta); return make_tuple<bool,UMat,UMat>(move(retval),move(corners),move(meta));});
    ...
    mod.method("jlopencv_cv_estimateChessboardSharpness",  [](Mat& image, Size& patternSize, Mat& corners, float& rise_distance, bool& vertical, Mat& sharpness) { auto retval = cv::estimateChessboardSharpness(image, patternSize, corners, rise_distance, vertical, sharpness); return make_tuple<Scalar,Mat>(move(retval),move(sharpness));});
    mod.method("jlopencv_cv_estimateChessboardSharpness",  [](UMat& image, Size& patternSize, UMat& corners, float& rise_distance, bool& vertical, UMat& sharpness) { auto retval = cv::estimateChessboardSharpness(image, patternSize, corners, rise_distance, vertical, sharpness); return make_tuple<Scalar,UMat>(move(retval),move(sharpness));});
    ...
    mod.method("jlopencv_cv_findFundamentalMat",  [](Mat& points1, Mat& points2, int& method, double& ransacReprojThreshold, double& confidence, int& maxIters, Mat& mask) { auto retval = cv::findFundamentalMat(points1, points2, method, ransacReprojThreshold, confidence, maxIters, mask); return make_tuple<Mat,Mat>(move(retval),move(mask));});
    mod.method("jlopencv_cv_findFundamentalMat",  [](UMat& points1, UMat& points2, int& method, double& ransacReprojThreshold, double& confidence, int& maxIters, UMat& mask) { auto retval = cv::findFundamentalMat(points1, points2, method, ransacReprojThreshold, confidence, maxIters, mask); return make_tuple<Mat,UMat>(move(retval),move(mask));});
